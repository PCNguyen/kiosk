...
@interface GetScheduledPostResponse : NSObject <TBase, NSCoding> {
  Response * __response;
  ScheduledPost * __post;
...
#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=response, setter=setResponse:) Response * response;
@property (nonatomic, retain, getter=post, setter=setPost:) ScheduledPost * post;
#endif
...
- (GetScheduledPostResponse *) getScheduledPost: (NSString *) scheduledPostId;  // throws TException
