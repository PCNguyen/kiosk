...
- (id) initWithReviewResponseComment: (NSString *) reviewResponseComment reviewResponseCreateDt: (int64_t) reviewResponseCreateDt reviewResponseName: (NSString *) reviewResponseName createdDtPrettyLong: (NSString *) createdDtPrettyLong
{
  ...
  __createdDtPrettyLong = [createdDtPrettyLong retain_stub];
  __createdDtPrettyLong_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"createdDtPrettyLong"])
  {
    __createdDtPrettyLong = [[decoder decodeObjectForKey: @"createdDtPrettyLong"] retain_stub];
    __createdDtPrettyLong_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__createdDtPrettyLong_isset)
  {
    [encoder encodeObject: __createdDtPrettyLong forKey: @"createdDtPrettyLong"];
  }
}
...
- (void) dealloc
{
  ...
  [__createdDtPrettyLong release_stub];
  [super dealloc_stub];
}
...
- (NSString *) createdDtPrettyLong {
  return [[__createdDtPrettyLong retain_stub] autorelease_stub];
}

- (void) setCreatedDtPrettyLong: (NSString *) createdDtPrettyLong {
  [createdDtPrettyLong retain_stub];
  [__createdDtPrettyLong release_stub];
  __createdDtPrettyLong = createdDtPrettyLong;
  __createdDtPrettyLong_isset = YES;
}

- (BOOL) createdDtPrettyLongIsSet {
  return __createdDtPrettyLong_isset;
}

- (void) unsetCreatedDtPrettyLong {
  [__createdDtPrettyLong release_stub];
  __createdDtPrettyLong = nil;
  __createdDtPrettyLong_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 4:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setCreatedDtPrettyLong: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__createdDtPrettyLong_isset) {
    if (__createdDtPrettyLong != nil) {
      [outProtocol writeFieldBeginWithName: @"createdDtPrettyLong" type: TType_STRING fieldID: 4];
      [outProtocol writeString: __createdDtPrettyLong];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  ...
  [ms appendString: @",createdDtPrettyLong:"];
  [ms appendFormat: @"\"%@\"", __createdDtPrettyLong];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
- (id) initWithId: (NSString *) id locationName: (NSString *) locationName reviewerId: (NSString *) reviewerId reviewerName: (NSString *) reviewerName reviewerPhotoUrl: (NSString *) reviewerPhotoUrl reviewerProfileUrl: (NSString *) reviewerProfileUrl reviewerEmail: (NSString *) reviewerEmail reviewerPhone: (NSString *) reviewerPhone rating: (double) rating normalizedRating: (double) normalizedRating date: (NSString *) date ratedTimestamp: (int64_t) ratedTimestamp addedTimestamp: (int64_t) addedTimestamp updatedTimestamp: (int64_t) updatedTimestamp comment: (NSString *) comment tags: (NSMutableArray *) tags sourceId: (SourceCode) sourceId sourceName: (NSString *) sourceName sourceSmallIconPath: (NSString *) sourceSmallIconPath sourceLargeIconPath: (NSString *) sourceLargeIconPath sourceOverallRS: (RatingScale *) sourceOverallRS sourceSubRatingRS: (NSMutableDictionary *) sourceSubRatingRS sourceGroup: (SourceGroup) sourceGroup isSourceRequestReviewable: (BOOL) isSourceRequestReviewable sourceURL: (NSString *) sourceURL originSourceId: (SourceCode) originSourceId originSourceName: (SourceCode) originSourceName originSourceURL: (NSString *) originSourceURL properties: (NSMutableArray *) properties commentTitle: (NSString *) commentTitle publishDate: (int64_t) publishDate published: (BOOL) published requested: (BOOL) requested numReplies: (int32_t) numReplies lastReplyDate: (int64_t) lastReplyDate nps: (int32_t) nps rresponses: (NSMutableArray *) rresponses hasResponded: (BOOL) hasResponded isStarRatingEnabled: (BOOL) isStarRatingEnabled allowedActions: (NSMutableArray *) allowedActions sentiment: (int) sentiment createdDtPrettyShort: (NSString *) createdDtPrettyShort subRatings: (NSMutableArray *) subRatings shortFormattedDate: (NSString *) shortFormattedDate notes: (NSMutableArray *) notes
{
  ...
  __createdDtPrettyShort = [createdDtPrettyShort retain_stub];
  __createdDtPrettyShort_isset = YES;
  __subRatings = [subRatings retain_stub];
  __subRatings_isset = YES;
  __shortFormattedDate = [shortFormattedDate retain_stub];
  __shortFormattedDate_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"createdDtPrettyShort"])
  {
    __createdDtPrettyShort = [[decoder decodeObjectForKey: @"createdDtPrettyShort"] retain_stub];
    __createdDtPrettyShort_isset = YES;
  }
  if ([decoder containsValueForKey: @"subRatings"])
  {
    __subRatings = [[decoder decodeObjectForKey: @"subRatings"] retain_stub];
    __subRatings_isset = YES;
  }
  if ([decoder containsValueForKey: @"shortFormattedDate"])
  {
    __shortFormattedDate = [[decoder decodeObjectForKey: @"shortFormattedDate"] retain_stub];
    __shortFormattedDate_isset = YES;
  }
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__createdDtPrettyShort_isset)
  {
    [encoder encodeObject: __createdDtPrettyShort forKey: @"createdDtPrettyShort"];
  }
  if (__subRatings_isset)
  {
    [encoder encodeObject: __subRatings forKey: @"subRatings"];
  }
  if (__shortFormattedDate_isset)
  {
    [encoder encodeObject: __shortFormattedDate forKey: @"shortFormattedDate"];
  }
  if (__notes_isset)
  {
...
- (void) dealloc
{
  ...
  [__createdDtPrettyShort release_stub];
  [__subRatings release_stub];
  [__shortFormattedDate release_stub];
...
- (NSString *) createdDtPrettyShort {
  return [[__createdDtPrettyShort retain_stub] autorelease_stub];
}

- (void) setCreatedDtPrettyShort: (NSString *) createdDtPrettyShort {
  [createdDtPrettyShort retain_stub];
  [__createdDtPrettyShort release_stub];
  __createdDtPrettyShort = createdDtPrettyShort;
  __createdDtPrettyShort_isset = YES;
}

- (BOOL) createdDtPrettyShortIsSet {
  return __createdDtPrettyShort_isset;
}

- (void) unsetCreatedDtPrettyShort {
  [__createdDtPrettyShort release_stub];
  __createdDtPrettyShort = nil;
  __createdDtPrettyShort_isset = NO;
}

- (NSMutableArray *) subRatings {
  return [[__subRatings retain_stub] autorelease_stub];
}

- (void) setSubRatings: (NSMutableArray *) subRatings {
  [subRatings retain_stub];
  [__subRatings release_stub];
  __subRatings = subRatings;
  __subRatings_isset = YES;
}

- (BOOL) subRatingsIsSet {
  return __subRatings_isset;
}

- (void) unsetSubRatings {
  [__subRatings release_stub];
  __subRatings = nil;
  __subRatings_isset = NO;
}

- (NSString *) shortFormattedDate {
  return [[__shortFormattedDate retain_stub] autorelease_stub];
}

- (void) setShortFormattedDate: (NSString *) shortFormattedDate {
  [shortFormattedDate retain_stub];
  [__shortFormattedDate release_stub];
  __shortFormattedDate = shortFormattedDate;
  __shortFormattedDate_isset = YES;
}

- (BOOL) shortFormattedDateIsSet {
  return __shortFormattedDate_isset;
}

- (void) unsetShortFormattedDate {
  [__shortFormattedDate release_stub];
  __shortFormattedDate = nil;
  __shortFormattedDate_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 43:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setCreatedDtPrettyShort: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      ...
      case 45:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setShortFormattedDate: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__tags_isset) {
    if (__tags != nil) {
      [outProtocol writeFieldBeginWithName: @"tags" type: TType_LIST fieldID: 16];
      {
        ...
        int idx29;
        for (idx29 = 0; idx29 < [__tags count]; idx29++)
        {
          [[__tags objectAtIndex: idx29] write: outProtocol];
        }
  ...
  if (__sourceSubRatingRS_isset) {
    if (__sourceSubRatingRS != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceSubRatingRS" type: TType_MAP fieldID: 22];
      {
        ...
        NSEnumerator * _iter30 = [__sourceSubRatingRS keyEnumerator];
        id key31;
        while ((key31 = [_iter30 nextObject]))
        {
          [outProtocol writeI32: [key31 intValue]];
          [[__sourceSubRatingRS objectForKey: key31] write: outProtocol];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__properties_isset) {
    if (__properties != nil) {
      [outProtocol writeFieldBeginWithName: @"properties" type: TType_LIST fieldID: 29];
      {
        ...
        int idx33;
        for (idx33 = 0; idx33 < [__properties count]; idx33++)
        {
          [[__properties objectAtIndex: idx33] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__rresponses_isset) {
    if (__rresponses != nil) {
      [outProtocol writeFieldBeginWithName: @"rresponses" type: TType_LIST fieldID: 37];
      {
        ...
        int idx35;
        for (idx35 = 0; idx35 < [__rresponses count]; idx35++)
        {
          [[__rresponses objectAtIndex: idx35] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 41];
      {
        ...
        int idx37;
        for (idx37 = 0; idx37 < [__allowedActions count]; idx37++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: idx37]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__createdDtPrettyShort_isset) {
    if (__createdDtPrettyShort != nil) {
      [outProtocol writeFieldBeginWithName: @"createdDtPrettyShort" type: TType_STRING fieldID: 43];
      [outProtocol writeString: __createdDtPrettyShort];
      [outProtocol writeFieldEnd];
    }
  }
  if (__subRatings_isset) {
    if (__subRatings != nil) {
      [outProtocol writeFieldBeginWithName: @"subRatings" type: TType_LIST fieldID: 44];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__subRatings count]];
        int idx39;
        for (idx39 = 0; idx39 < [__subRatings count]; idx39++)
        {
          [[__subRatings objectAtIndex: idx39] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__shortFormattedDate_isset) {
    if (__shortFormattedDate != nil) {
      [outProtocol writeFieldBeginWithName: @"shortFormattedDate" type: TType_STRING fieldID: 45];
      [outProtocol writeString: __shortFormattedDate];
      [outProtocol writeFieldEnd];
    }
  }
  if (__notes_isset) {
    if (__notes != nil) {
      [outProtocol writeFieldBeginWithName: @"notes" type: TType_LIST fieldID: 46];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__notes count]];
        int idx41;
        for (idx41 = 0; idx41 < [__notes count]; idx41++)
        {
          [outProtocol writeString: [__notes objectAtIndex: idx41]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @",createdDtPrettyShort:"];
  [ms appendFormat: @"\"%@\"", __createdDtPrettyShort];
  [ms appendString: @",subRatings:"];
  [ms appendFormat: @"%@", __subRatings];
  [ms appendString: @",shortFormattedDate:"];
  [ms appendFormat: @"\"%@\"", __shortFormattedDate];
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            SummaryValue *_elem44 = [[SummaryValue alloc] init];
            [_elem44 read: inProtocol];
            [fieldValue addObject: _elem44];
            [_elem44 release_stub];
          }
          [inProtocol readListEnd];
  ...
  if (__values_isset) {
    if (__values != nil) {
      [outProtocol writeFieldBeginWithName: @"values" type: TType_LIST fieldID: 2];
      {
        ...
        int idx46;
        for (idx46 = 0; idx46 < [__values count]; idx46++)
        {
          [[__values objectAtIndex: idx46] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            Location *_elem49 = [[Location alloc] init];
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            Source *_elem52 = [[Source alloc] init];
  ...
  if (__authLocations_isset) {
    if (__authLocations != nil) {
      [outProtocol writeFieldBeginWithName: @"authLocations" type: TType_LIST fieldID: 1];
      {
        ...
        int idx54;
        for (idx54 = 0; idx54 < [__authLocations count]; idx54++)
        {
          [[__authLocations objectAtIndex: idx54] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allSources_isset) {
    if (__allSources != nil) {
      [outProtocol writeFieldBeginWithName: @"allSources" type: TType_LIST fieldID: 2];
      {
        ...
        int idx56;
        for (idx56 = 0; idx56 < [__allSources count]; idx56++)
        {
          [[__allSources objectAtIndex: idx56] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      ...
      case 9:
        if (fieldType == TType_MAP) {
          ...
          {
            NSString * _key59 = [inProtocol readString];
            int32_t _val60 = [inProtocol readI32];
            [fieldValue setObject: [NSNumber numberWithLong: _val60] forKey: _key59];
          }
          [inProtocol readMapEnd];
          [self setProperties: fieldValue];
          [fieldValue release_stub];
      ...
      case 14:
        if (fieldType == TType_LIST) {
          int _size61;
          [inProtocol readListBeginReturningElementType: NULL size: &_size61];
          NSMutableArray * fieldValue = [[NSMutableArray alloc] initWithCapacity: _size61];
          int _i62;
          for (_i62 = 0; _i62 < _size61; ++_i62)
          {
            NSString * _elem63 = [inProtocol readString];
            [fieldValue addObject: _elem63];
          }
          [inProtocol readListEnd];
          [self setAllowedActions: fieldValue];
          [fieldValue release_stub];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"Reply"];
  if (__id_isset) {
    if (__id != nil) {
      [outProtocol writeFieldBeginWithName: @"id" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __id];
  ...
  if (__parentID_isset) {
    if (__parentID != nil) {
      [outProtocol writeFieldBeginWithName: @"parentID" type: TType_STRING fieldID: 2];
  ...
  if (__externalID_isset) {
    if (__externalID != nil) {
      [outProtocol writeFieldBeginWithName: @"externalID" type: TType_STRING fieldID: 3];
  ...
  if (__source_isset) {
    if (__source != nil) {
      [outProtocol writeFieldBeginWithName: @"source" type: TType_STRING fieldID: 5];
  ...
  if (__user_isset) {
    if (__user != nil) {
      [outProtocol writeFieldBeginWithName: @"user" type: TType_STRUCT fieldID: 7];
  ...
  if (__text_isset) {
    if (__text != nil) {
      [outProtocol writeFieldBeginWithName: @"text" type: TType_STRING fieldID: 8];
  ...
  if (__properties_isset) {
    if (__properties != nil) {
      [outProtocol writeFieldBeginWithName: @"properties" type: TType_MAP fieldID: 9];
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_I32 size: [__properties count]];
        NSEnumerator * _iter64 = [__properties keyEnumerator];
        id key65;
        while ((key65 = [_iter64 nextObject]))
        {
          [outProtocol writeString: key65];
          [outProtocol writeI32: [[__properties objectForKey: key65] longValue]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__upvoted_isset) {
    [outProtocol writeFieldBeginWithName: @"upvoted" type: TType_BOOL fieldID: 12];
    [outProtocol writeBool: __upvoted];
    [outProtocol writeFieldEnd];
  }
  if (__deletable_isset) {
    [outProtocol writeFieldBeginWithName: @"deletable" type: TType_BOOL fieldID: 13];
    [outProtocol writeBool: __deletable];
    [outProtocol writeFieldEnd];
  }
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 14];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__allowedActions count]];
        int idx67;
        for (idx67 = 0; idx67 < [__allowedActions count]; idx67++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: idx67]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__createdDtPrettyShort_isset) {
    if (__createdDtPrettyShort != nil) {
      [outProtocol writeFieldBeginWithName: @"createdDtPrettyShort" type: TType_STRING fieldID: 15];
      [outProtocol writeString: __createdDtPrettyShort];
      [outProtocol writeFieldEnd];
    }
  }
  if (__createdDtPrettyLong_isset) {
    if (__createdDtPrettyLong != nil) {
      [outProtocol writeFieldBeginWithName: @"createdDtPrettyLong" type: TType_STRING fieldID: 16];
      [outProtocol writeString: __createdDtPrettyLong];
      [outProtocol writeFieldEnd];
    }
  }
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"Reply("];
  [ms appendString: @"id:"];
  [ms appendFormat: @"\"%@\"", __id];
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 8:
        if (fieldType == TType_MAP) {
          int _size68;
          [inProtocol readMapBeginReturningKeyType: NULL valueType: NULL size: &_size68];
          NSMutableDictionary * fieldValue = [[NSMutableDictionary alloc] initWithCapacity: _size68];
          int _i69;
          for (_i69 = 0; _i69 < _size68; ++_i69)
          {
            NSString * _key70 = [inProtocol readString];
            NSString * _val71 = [inProtocol readString];
            [fieldValue setObject: _val71 forKey: _key70];
          }
          [inProtocol readMapEnd];
          [self setProperties: fieldValue];
          [fieldValue release_stub];
  ...
  if (__properties_isset) {
    if (__properties != nil) {
      [outProtocol writeFieldBeginWithName: @"properties" type: TType_MAP fieldID: 8];
      {
        ...
        NSEnumerator * _iter72 = [__properties keyEnumerator];
        id key73;
        while ((key73 = [_iter72 nextObject]))
        {
          [outProtocol writeString: key73];
          [outProtocol writeString: [__properties objectForKey: key73]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
...
- (id) initWithPhotoUrl: (NSString *) photoUrl expandedUrl: (NSString *) expandedUrl displayUrl: (NSString *) displayUrl name: (NSString *) name caption: (NSString *) caption linkDescription: (NSString *) linkDescription offset: (int32_t) offset length: (int32_t) length
{
  ...
  __caption_isset = YES;
  __linkDescription = [linkDescription retain_stub];
  __linkDescription_isset = YES;
  __offset = offset;
  __offset_isset = YES;
  __length = length;
  __length_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"linkDescription"])
  {
    __linkDescription = [[decoder decodeObjectForKey: @"linkDescription"] retain_stub];
    __linkDescription_isset = YES;
  }
  if ([decoder containsValueForKey: @"offset"])
  {
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__linkDescription_isset)
  {
    [encoder encodeObject: __linkDescription forKey: @"linkDescription"];
  }
  if (__offset_isset)
  {
    [encoder encodeInt32: __offset forKey: @"offset"];
...
- (void) dealloc
{
  ...
  [__linkDescription release_stub];
  [super dealloc_stub];
}
...
- (NSString *) linkDescription {
  return [[__linkDescription retain_stub] autorelease_stub];
}

- (void) setLinkDescription: (NSString *) linkDescription {
  [linkDescription retain_stub];
  [__linkDescription release_stub];
  __linkDescription = linkDescription;
  __linkDescription_isset = YES;
}

- (BOOL) linkDescriptionIsSet {
  return __linkDescription_isset;
}

- (void) unsetLinkDescription {
  [__linkDescription release_stub];
  __linkDescription = nil;
  __linkDescription_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 6:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setLinkDescription: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__linkDescription_isset) {
    if (__linkDescription != nil) {
      [outProtocol writeFieldBeginWithName: @"linkDescription" type: TType_STRING fieldID: 6];
      [outProtocol writeString: __linkDescription];
      [outProtocol writeFieldEnd];
    }
  }
  if (__offset_isset) {
...
- (NSString *) description {
  ...
  [ms appendString: @",linkDescription:"];
  [ms appendFormat: @"\"%@\"", __linkDescription];
  [ms appendString: @",offset:"];
  [ms appendFormat: @"%i", __offset];
  [ms appendString: @",length:"];
  [ms appendFormat: @"%i", __length];
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"replies"])
  {
    __replies = [[decoder decodeObjectForKey: @"replies"] retain_stub];
    __replies_isset = YES;
  }
  if ([decoder containsValueForKey: @"allowedActions"])
  {
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__replies_isset)
  {
    [encoder encodeObject: __replies forKey: @"replies"];
  }
  if (__allowedActions_isset)
  {
    [encoder encodeObject: __allowedActions forKey: @"allowedActions"];
...
- (NSMutableArray *) replies {
  return [[__replies retain_stub] autorelease_stub];
}
    ...
    switch (fieldID)
    {
      ...
      case 7:
        if (fieldType == TType_LIST) {
          ...
          {
            MonitorLink *_elem76 = [[MonitorLink alloc] init];
      ...
      case 9:
        if (fieldType == TType_LIST) {
          ...
          {
            SocialTag *_elem82 = [[SocialTag alloc] init];
      ...
      case 10:
        if (fieldType == TType_LIST) {
          ...
          {
            Hashtag *_elem85 = [[Hashtag alloc] init];
            [_elem85 read: inProtocol];
            [fieldValue addObject: _elem85];
            [_elem85 release_stub];
          }
          [inProtocol readListEnd];
      ...
      case 11:
        if (fieldType == TType_MAP) {
          ...
          {
            NSString * _key88 = [inProtocol readString];
            int32_t _val89 = [inProtocol readI32];
            [fieldValue setObject: [NSNumber numberWithLong: _val89] forKey: _key88];
          }
          [inProtocol readMapEnd];
          [self setProperties: fieldValue];
          [fieldValue release_stub];
      ...
      case 25:
        if (fieldType == TType_LIST) {
          int _size93;
          [inProtocol readListBeginReturningElementType: NULL size: &_size93];
          NSMutableArray * fieldValue = [[NSMutableArray alloc] initWithCapacity: _size93];
          int _i94;
          for (_i94 = 0; _i94 < _size93; ++_i94)
          {
            NSString * _elem95 = [inProtocol readString];
            [fieldValue addObject: _elem95];
          }
          [inProtocol readListEnd];
          [self setAllowedActions: fieldValue];
          [fieldValue release_stub];
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__sourceId_isset) {
    if (__sourceId != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceId" type: TType_STRING fieldID: 3];
      [outProtocol writeString: __sourceId];
      [outProtocol writeFieldEnd];
    }
  }
  ...
  if (__links_isset) {
    if (__links != nil) {
      [outProtocol writeFieldBeginWithName: @"links" type: TType_LIST fieldID: 7];
      {
        ...
        int idx97;
        for (idx97 = 0; idx97 < [__links count]; idx97++)
        {
          [[__links objectAtIndex: idx97] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__medias_isset) {
    if (__medias != nil) {
      [outProtocol writeFieldBeginWithName: @"medias" type: TType_LIST fieldID: 8];
      {
        ...
        int idx99;
        for (idx99 = 0; idx99 < [__medias count]; idx99++)
        {
          [[__medias objectAtIndex: idx99] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__tags_isset) {
    if (__tags != nil) {
      [outProtocol writeFieldBeginWithName: @"tags" type: TType_LIST fieldID: 9];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__tags count]];
        int idx101;
        for (idx101 = 0; idx101 < [__tags count]; idx101++)
        {
          [[__tags objectAtIndex: idx101] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__hashtags_isset) {
    if (__hashtags != nil) {
      [outProtocol writeFieldBeginWithName: @"hashtags" type: TType_LIST fieldID: 10];
      {
        ...
        int idx103;
        for (idx103 = 0; idx103 < [__hashtags count]; idx103++)
        {
          [[__hashtags objectAtIndex: idx103] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__properties_isset) {
    if (__properties != nil) {
      ...
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_I32 size: [__properties count]];
        NSEnumerator * _iter104 = [__properties keyEnumerator];
        id key105;
        while ((key105 = [_iter104 nextObject]))
        {
          [outProtocol writeString: key105];
          [outProtocol writeI32: [[__properties objectForKey: key105] longValue]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sourceName_isset) {
    if (__sourceName != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceName" type: TType_STRING fieldID: 21];
      [outProtocol writeString: __sourceName];
      [outProtocol writeFieldEnd];
    }
  }
  if (__sourceSmallIconPath_isset) {
    if (__sourceSmallIconPath != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceSmallIconPath" type: TType_STRING fieldID: 22];
      [outProtocol writeString: __sourceSmallIconPath];
      [outProtocol writeFieldEnd];
    }
  }
  if (__sourceLargeIconPath_isset) {
    if (__sourceLargeIconPath != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceLargeIconPath" type: TType_STRING fieldID: 23];
      [outProtocol writeString: __sourceLargeIconPath];
      [outProtocol writeFieldEnd];
    }
  }
  if (__replies_isset) {
    if (__replies != nil) {
      [outProtocol writeFieldBeginWithName: @"replies" type: TType_LIST fieldID: 24];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__replies count]];
        int idx107;
        for (idx107 = 0; idx107 < [__replies count]; idx107++)
        {
          [[__replies objectAtIndex: idx107] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 25];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__allowedActions count]];
        int idx109;
        for (idx109 = 0; idx109 < [__allowedActions count]; idx109++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: idx109]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__createdDtPrettyShort_isset) {
    if (__createdDtPrettyShort != nil) {
      [outProtocol writeFieldBeginWithName: @"createdDtPrettyShort" type: TType_STRING fieldID: 26];
      [outProtocol writeString: __createdDtPrettyShort];
      [outProtocol writeFieldEnd];
    }
  }
  if (__createdDtPrettyLong_isset) {
    if (__createdDtPrettyLong != nil) {
      [outProtocol writeFieldBeginWithName: @"createdDtPrettyLong" type: TType_STRING fieldID: 27];
      [outProtocol writeString: __createdDtPrettyLong];
      [outProtocol writeFieldEnd];
    }
  }
...
- (NSString *) description {
  ...
  [ms appendString: @",sourceLargeIconPath:"];
  [ms appendFormat: @"\"%@\"", __sourceLargeIconPath];
  [ms appendString: @",replies:"];
  [ms appendFormat: @"%@", __replies];
  [ms appendString: @",allowedActions:"];
  [ms appendFormat: @"%@", __allowedActions];
  [ms appendString: @",createdDtPrettyShort:"];
  [ms appendFormat: @"\"%@\"", __createdDtPrettyShort];
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __mimeType = [decoder decodeIntForKey: @"mimeType"];
    __mimeType_isset = YES;
  }
  if ([decoder containsValueForKey: @"imageMetaData"])
  {
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__mimeType_isset)
  {
    [encoder encodeInt: __mimeType forKey: @"mimeType"];
  }
  if (__imageMetaData_isset)
  {
...
- (NSMutableDictionary *) imageMetaData {
  return [[__imageMetaData retain_stub] autorelease_stub];
}

- (void) setImageMetaData: (NSMutableDictionary *) imageMetaData {
  [imageMetaData retain_stub];
  [__imageMetaData release_stub];
  __imageMetaData = imageMetaData;
  __imageMetaData_isset = YES;
}

- (BOOL) imageMetaDataIsSet {
  return __imageMetaData_isset;
}
    ...
    switch (fieldID)
    {
      ...
      case 5:
        if (fieldType == TType_MAP) {
          ...
          [inProtocol readMapEnd];
          [self setImageMetaData: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"MediaData"];
  if (__data_isset) {
    if (__data != nil) {
  ...
  if (__bodyHash_isset) {
    if (__bodyHash != nil) {
      [outProtocol writeFieldBeginWithName: @"bodyHash" type: TType_STRING fieldID: 3];
      [outProtocol writeString: __bodyHash];
      [outProtocol writeFieldEnd];
    }
  }
  if (__mimeType_isset) {
    [outProtocol writeFieldBeginWithName: @"mimeType" type: TType_I32 fieldID: 4];
    [outProtocol writeI32: __mimeType];
    [outProtocol writeFieldEnd];
  }
  if (__imageMetaData_isset) {
    if (__imageMetaData != nil) {
      [outProtocol writeFieldBeginWithName: @"imageMetaData" type: TType_MAP fieldID: 5];
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_STRING size: [__imageMetaData count]];
        NSEnumerator * _iter114 = [__imageMetaData keyEnumerator];
        id key115;
        while ((key115 = [_iter114 nextObject]))
        {
          [outProtocol writeString: key115];
          [outProtocol writeString: [__imageMetaData objectForKey: key115]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"MediaData("];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"PublishLink"];
  if (__url_isset) {
    if (__url != nil) {
  ...
  if (__caption_isset) {
    if (__caption != nil) {
      [outProtocol writeFieldBeginWithName: @"caption" type: TType_STRING fieldID: 3];
      [outProtocol writeString: __caption];
      [outProtocol writeFieldEnd];
    }
  }
  if (__linkDescription_isset) {
    if (__linkDescription != nil) {
      [outProtocol writeFieldBeginWithName: @"linkDescription" type: TType_STRING fieldID: 4];
      [outProtocol writeString: __linkDescription];
      [outProtocol writeFieldEnd];
    }
  }
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"PublishLink("];
  [ms appendString: @"url:"];
  [ms appendFormat: @"\"%@\"", __url];
  [ms appendString: @",name:"];
  [ms appendFormat: @"\"%@\"", __name];
...
- (id) initWithId: (NSString *) id tenantID: (int64_t) tenantID userID: (int32_t) userID sources: (NSMutableDictionary *) sources locationCount: (int32_t) locationCount locations: (NSMutableDictionary *) locations scheduleDate: (int64_t) scheduleDate text: (NSString *) text link: (PublishLink *) link mediaPath: (NSString *) mediaPath postState: (int) postState allowedActions: (NSMutableArray *) allowedActions taskTitle: (NSString *) taskTitle taskIconUrl: (NSString *) taskIconUrl scheduleDateStr: (NSString *) scheduleDateStr scheduleDateStrLong: (NSString *) scheduleDateStrLong createDateStr: (NSString *) createDateStr createDateStrLong: (NSString *) createDateStrLong
{
  ...
  __userID = userID;
  __userID_isset = YES;
  __sources = [sources retain_stub];
  __sources_isset = YES;
  __locationCount = locationCount;
  __locationCount_isset = YES;
  ...
  __link_isset = YES;
  __mediaPath = [mediaPath retain_stub];
  __mediaPath_isset = YES;
  __postState = postState;
  __postState_isset = YES;
  __allowedActions = [allowedActions retain_stub];
  __allowedActions_isset = YES;
  __taskTitle = [taskTitle retain_stub];
  __taskTitle_isset = YES;
  __taskIconUrl = [taskIconUrl retain_stub];
  __taskIconUrl_isset = YES;
  __scheduleDateStr = [scheduleDateStr retain_stub];
  __scheduleDateStr_isset = YES;
  __scheduleDateStrLong = [scheduleDateStrLong retain_stub];
  __scheduleDateStrLong_isset = YES;
  __createDateStr = [createDateStr retain_stub];
  __createDateStr_isset = YES;
  __createDateStrLong = [createDateStrLong retain_stub];
  __createDateStrLong_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"sources"])
  {
    __sources = [[decoder decodeObjectForKey: @"sources"] retain_stub];
    __sources_isset = YES;
  }
  if ([decoder containsValueForKey: @"locationCount"])
  {
    __locationCount = [decoder decodeInt32ForKey: @"locationCount"];
    __locationCount_isset = YES;
  }
  ...
  {
    __scheduleDate = [decoder decodeInt64ForKey: @"scheduleDate"];
    __scheduleDate_isset = YES;
  }
  if ([decoder containsValueForKey: @"text"])
  {
  ...
  if ([decoder containsValueForKey: @"mediaPath"])
  {
    __mediaPath = [[decoder decodeObjectForKey: @"mediaPath"] retain_stub];
    __mediaPath_isset = YES;
  }
  if ([decoder containsValueForKey: @"postState"])
  {
    __postState = [decoder decodeIntForKey: @"postState"];
    __postState_isset = YES;
  }
  if ([decoder containsValueForKey: @"allowedActions"])
  {
  ...
  if ([decoder containsValueForKey: @"taskTitle"])
  {
    __taskTitle = [[decoder decodeObjectForKey: @"taskTitle"] retain_stub];
    __taskTitle_isset = YES;
  }
  if ([decoder containsValueForKey: @"taskIconUrl"])
  {
    __taskIconUrl = [[decoder decodeObjectForKey: @"taskIconUrl"] retain_stub];
    __taskIconUrl_isset = YES;
  }
  if ([decoder containsValueForKey: @"scheduleDateStr"])
  {
    __scheduleDateStr = [[decoder decodeObjectForKey: @"scheduleDateStr"] retain_stub];
    __scheduleDateStr_isset = YES;
  }
  if ([decoder containsValueForKey: @"scheduleDateStrLong"])
  {
    __scheduleDateStrLong = [[decoder decodeObjectForKey: @"scheduleDateStrLong"] retain_stub];
    __scheduleDateStrLong_isset = YES;
  }
  if ([decoder containsValueForKey: @"createDateStr"])
  {
    __createDateStr = [[decoder decodeObjectForKey: @"createDateStr"] retain_stub];
    __createDateStr_isset = YES;
  }
  if ([decoder containsValueForKey: @"createDateStrLong"])
  {
    __createDateStrLong = [[decoder decodeObjectForKey: @"createDateStrLong"] retain_stub];
    __createDateStrLong_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__sources_isset)
  {
    [encoder encodeObject: __sources forKey: @"sources"];
  }
  if (__locationCount_isset)
  {
    [encoder encodeInt32: __locationCount forKey: @"locationCount"];
  }
  ...
  {
    [encoder encodeInt64: __scheduleDate forKey: @"scheduleDate"];
  }
  if (__text_isset)
  {
    [encoder encodeObject: __text forKey: @"text"];
  ...
  if (__mediaPath_isset)
  {
    [encoder encodeObject: __mediaPath forKey: @"mediaPath"];
  }
  if (__postState_isset)
  {
    [encoder encodeInt: __postState forKey: @"postState"];
  }
  if (__allowedActions_isset)
  {
    [encoder encodeObject: __allowedActions forKey: @"allowedActions"];
  }
  if (__taskTitle_isset)
  {
    [encoder encodeObject: __taskTitle forKey: @"taskTitle"];
  }
  if (__taskIconUrl_isset)
  {
    [encoder encodeObject: __taskIconUrl forKey: @"taskIconUrl"];
  }
  if (__scheduleDateStr_isset)
  {
    [encoder encodeObject: __scheduleDateStr forKey: @"scheduleDateStr"];
  }
  if (__scheduleDateStrLong_isset)
  {
    [encoder encodeObject: __scheduleDateStrLong forKey: @"scheduleDateStrLong"];
  }
  if (__createDateStr_isset)
  {
    [encoder encodeObject: __createDateStr forKey: @"createDateStr"];
  }
  if (__createDateStrLong_isset)
  {
    [encoder encodeObject: __createDateStrLong forKey: @"createDateStrLong"];
  }
}
...
{
  [__id release_stub];
  [__sources release_stub];
  [__locations release_stub];
  [__text release_stub];
  [__link release_stub];
  [__mediaPath release_stub];
  [__allowedActions release_stub];
  [__taskTitle release_stub];
  [__taskIconUrl release_stub];
  [__scheduleDateStr release_stub];
  [__scheduleDateStrLong release_stub];
  [__createDateStr release_stub];
  [__createDateStrLong release_stub];
  [super dealloc_stub];
}
...
- (NSMutableDictionary *) sources {
  return [[__sources retain_stub] autorelease_stub];
}
...
- (BOOL) locationCountIsSet {
  return __locationCount_isset;
}

- (void) unsetLocationCount {
  __locationCount_isset = NO;
}
...
- (NSString *) mediaPath {
  return [[__mediaPath retain_stub] autorelease_stub];
}

- (void) setMediaPath: (NSString *) mediaPath {
  [mediaPath retain_stub];
  [__mediaPath release_stub];
  __mediaPath = mediaPath;
  __mediaPath_isset = YES;
}

- (BOOL) mediaPathIsSet {
  return __mediaPath_isset;
}

- (void) unsetMediaPath {
  [__mediaPath release_stub];
  __mediaPath = nil;
  __mediaPath_isset = NO;
}
...
- (BOOL) postStateIsSet {
  return __postState_isset;
}

- (void) unsetPostState {
  __postState_isset = NO;
}
...
- (NSString *) taskTitle {
  return [[__taskTitle retain_stub] autorelease_stub];
}

- (void) setTaskTitle: (NSString *) taskTitle {
  [taskTitle retain_stub];
  [__taskTitle release_stub];
  __taskTitle = taskTitle;
  __taskTitle_isset = YES;
}

- (BOOL) taskTitleIsSet {
  return __taskTitle_isset;
}

- (void) unsetTaskTitle {
  [__taskTitle release_stub];
  __taskTitle = nil;
  __taskTitle_isset = NO;
}

- (NSString *) taskIconUrl {
  return [[__taskIconUrl retain_stub] autorelease_stub];
}

- (void) setTaskIconUrl: (NSString *) taskIconUrl {
  [taskIconUrl retain_stub];
  [__taskIconUrl release_stub];
  __taskIconUrl = taskIconUrl;
  __taskIconUrl_isset = YES;
}

- (BOOL) taskIconUrlIsSet {
  return __taskIconUrl_isset;
}

- (void) unsetTaskIconUrl {
  [__taskIconUrl release_stub];
  __taskIconUrl = nil;
  __taskIconUrl_isset = NO;
}

- (NSString *) scheduleDateStr {
  return [[__scheduleDateStr retain_stub] autorelease_stub];
}

- (void) setScheduleDateStr: (NSString *) scheduleDateStr {
  [scheduleDateStr retain_stub];
  [__scheduleDateStr release_stub];
  __scheduleDateStr = scheduleDateStr;
  __scheduleDateStr_isset = YES;
}

- (BOOL) scheduleDateStrIsSet {
  return __scheduleDateStr_isset;
}

- (void) unsetScheduleDateStr {
  [__scheduleDateStr release_stub];
  __scheduleDateStr = nil;
  __scheduleDateStr_isset = NO;
}

- (NSString *) scheduleDateStrLong {
  return [[__scheduleDateStrLong retain_stub] autorelease_stub];
}

- (void) setScheduleDateStrLong: (NSString *) scheduleDateStrLong {
  [scheduleDateStrLong retain_stub];
  [__scheduleDateStrLong release_stub];
  __scheduleDateStrLong = scheduleDateStrLong;
  __scheduleDateStrLong_isset = YES;
}

- (BOOL) scheduleDateStrLongIsSet {
  return __scheduleDateStrLong_isset;
}

- (void) unsetScheduleDateStrLong {
  [__scheduleDateStrLong release_stub];
  __scheduleDateStrLong = nil;
  __scheduleDateStrLong_isset = NO;
}

- (NSString *) createDateStr {
  return [[__createDateStr retain_stub] autorelease_stub];
}

- (void) setCreateDateStr: (NSString *) createDateStr {
  [createDateStr retain_stub];
  [__createDateStr release_stub];
  __createDateStr = createDateStr;
  __createDateStr_isset = YES;
}

- (BOOL) createDateStrIsSet {
  return __createDateStr_isset;
}

- (void) unsetCreateDateStr {
  [__createDateStr release_stub];
  __createDateStr = nil;
  __createDateStr_isset = NO;
}

- (NSString *) createDateStrLong {
  return [[__createDateStrLong retain_stub] autorelease_stub];
}

- (void) setCreateDateStrLong: (NSString *) createDateStrLong {
  [createDateStrLong retain_stub];
  [__createDateStrLong release_stub];
  __createDateStrLong = createDateStrLong;
  __createDateStrLong_isset = YES;
}

- (BOOL) createDateStrLongIsSet {
  return __createDateStrLong_isset;
}

- (void) unsetCreateDateStrLong {
  [__createDateStrLong release_stub];
  __createDateStrLong = nil;
  __createDateStrLong_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 4:
        if (fieldType == TType_MAP) {
          int _size116;
          [inProtocol readMapBeginReturningKeyType: NULL valueType: NULL size: &_size116];
          NSMutableDictionary * fieldValue = [[NSMutableDictionary alloc] initWithCapacity: _size116];
          int _i117;
          for (_i117 = 0; _i117 < _size116; ++_i117)
          {
            NSString * _key118 = [inProtocol readString];
            NSString * _val119 = [inProtocol readString];
            [fieldValue setObject: _val119 forKey: _key118];
          }
          [inProtocol readMapEnd];
          [self setSources: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
      ...
      case 5:
        if (fieldType == TType_I32) {
          int32_t fieldValue = [inProtocol readI32];
          [self setLocationCount: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      ...
      case 9:
        if (fieldType == TType_STRUCT) {
          PublishLink *fieldValue = [[PublishLink alloc] init];
          [fieldValue read: inProtocol];
      ...
      case 14:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setTaskIconUrl: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 15:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setScheduleDateStr: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 16:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setScheduleDateStrLong: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 17:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setCreateDateStr: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 18:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setCreateDateStrLong: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"ScheduledPost"];
  if (__id_isset) {
    if (__id != nil) {
      [outProtocol writeFieldBeginWithName: @"id" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __id];
  ...
  if (__tenantID_isset) {
    [outProtocol writeFieldBeginWithName: @"tenantID" type: TType_I64 fieldID: 2];
  ...
  if (__sources_isset) {
    if (__sources != nil) {
      [outProtocol writeFieldBeginWithName: @"sources" type: TType_MAP fieldID: 4];
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_STRING size: [__sources count]];
        NSEnumerator * _iter127 = [__sources keyEnumerator];
        id key128;
        while ((key128 = [_iter127 nextObject]))
        {
          [outProtocol writeString: key128];
          [outProtocol writeString: [__sources objectForKey: key128]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__locationCount_isset) {
    [outProtocol writeFieldBeginWithName: @"locationCount" type: TType_I32 fieldID: 5];
    [outProtocol writeI32: __locationCount];
    [outProtocol writeFieldEnd];
  }
  if (__locations_isset) {
    if (__locations != nil) {
      [outProtocol writeFieldBeginWithName: @"locations" type: TType_MAP fieldID: 6];
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_STRING size: [__locations count]];
        NSEnumerator * _iter129 = [__locations keyEnumerator];
        id key130;
        while ((key130 = [_iter129 nextObject]))
        {
          [outProtocol writeString: key130];
          [outProtocol writeString: [__locations objectForKey: key130]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__scheduleDate_isset) {
    [outProtocol writeFieldBeginWithName: @"scheduleDate" type: TType_I64 fieldID: 7];
    [outProtocol writeI64: __scheduleDate];
    [outProtocol writeFieldEnd];
  }
  if (__text_isset) {
    if (__text != nil) {
  ...
  if (__link_isset) {
    if (__link != nil) {
      [outProtocol writeFieldBeginWithName: @"link" type: TType_STRUCT fieldID: 9];
      [__link write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  if (__mediaPath_isset) {
    if (__mediaPath != nil) {
      [outProtocol writeFieldBeginWithName: @"mediaPath" type: TType_STRING fieldID: 10];
      [outProtocol writeString: __mediaPath];
      [outProtocol writeFieldEnd];
    }
  }
  if (__postState_isset) {
    [outProtocol writeFieldBeginWithName: @"postState" type: TType_I32 fieldID: 11];
    [outProtocol writeI32: __postState];
    [outProtocol writeFieldEnd];
  }
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 12];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__allowedActions count]];
        int idx132;
        for (idx132 = 0; idx132 < [__allowedActions count]; idx132++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: idx132]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__taskTitle_isset) {
    if (__taskTitle != nil) {
      [outProtocol writeFieldBeginWithName: @"taskTitle" type: TType_STRING fieldID: 13];
      [outProtocol writeString: __taskTitle];
      [outProtocol writeFieldEnd];
    }
  }
  if (__taskIconUrl_isset) {
    if (__taskIconUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"taskIconUrl" type: TType_STRING fieldID: 14];
      [outProtocol writeString: __taskIconUrl];
      [outProtocol writeFieldEnd];
    }
  }
  if (__scheduleDateStr_isset) {
    if (__scheduleDateStr != nil) {
      [outProtocol writeFieldBeginWithName: @"scheduleDateStr" type: TType_STRING fieldID: 15];
      [outProtocol writeString: __scheduleDateStr];
      [outProtocol writeFieldEnd];
    }
  }
  if (__scheduleDateStrLong_isset) {
    if (__scheduleDateStrLong != nil) {
      [outProtocol writeFieldBeginWithName: @"scheduleDateStrLong" type: TType_STRING fieldID: 16];
      [outProtocol writeString: __scheduleDateStrLong];
      [outProtocol writeFieldEnd];
    }
  }
  if (__createDateStr_isset) {
    if (__createDateStr != nil) {
      [outProtocol writeFieldBeginWithName: @"createDateStr" type: TType_STRING fieldID: 17];
      [outProtocol writeString: __createDateStr];
      [outProtocol writeFieldEnd];
    }
  }
  if (__createDateStrLong_isset) {
    if (__createDateStrLong != nil) {
      [outProtocol writeFieldBeginWithName: @"createDateStrLong" type: TType_STRING fieldID: 18];
      [outProtocol writeString: __createDateStrLong];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"ScheduledPost("];
  [ms appendString: @"id:"];
  [ms appendFormat: @"\"%@\"", __id];
  ...
  [ms appendString: @",sources:"];
  [ms appendFormat: @"%@", __sources];
  [ms appendString: @",locationCount:"];
  [ms appendFormat: @"%i", __locationCount];
  [ms appendString: @",locations:"];
  [ms appendFormat: @"%@", __locations];
  [ms appendString: @",scheduleDate:"];
  [ms appendFormat: @"%qi", __scheduleDate];
  [ms appendString: @",text:"];
  [ms appendFormat: @"\"%@\"", __text];
  [ms appendString: @",link:"];
  [ms appendFormat: @"%@", __link];
  [ms appendString: @",mediaPath:"];
  [ms appendFormat: @"\"%@\"", __mediaPath];
  [ms appendString: @",postState:"];
  [ms appendFormat: @"%i", __postState];
  [ms appendString: @",allowedActions:"];
  [ms appendFormat: @"%@", __allowedActions];
  [ms appendString: @",taskTitle:"];
  [ms appendFormat: @"\"%@\"", __taskTitle];
  [ms appendString: @",taskIconUrl:"];
  [ms appendFormat: @"\"%@\"", __taskIconUrl];
  [ms appendString: @",scheduleDateStr:"];
  [ms appendFormat: @"\"%@\"", __scheduleDateStr];
  [ms appendString: @",scheduleDateStrLong:"];
  [ms appendFormat: @"\"%@\"", __scheduleDateStrLong];
  [ms appendString: @",createDateStr:"];
  [ms appendFormat: @"\"%@\"", __createDateStr];
  [ms appendString: @",createDateStrLong:"];
  [ms appendFormat: @"\"%@\"", __createDateStrLong];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@implementation SocialPostRequest
...
- (id) initWithSocialSources: (NSMutableArray *) socialSources text: (NSString *) text images: (NSMutableArray *) images locations: (NSMutableArray *) locations postDate: (int64_t) postDate
{
  ...
  __text = [text retain_stub];
  __text_isset = YES;
  __images = [images retain_stub];
  __images_isset = YES;
  __locations = [locations retain_stub];
  __locations_isset = YES;
  __postDate = postDate;
  __postDate_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __images = [[decoder decodeObjectForKey: @"images"] retain_stub];
    __images_isset = YES;
  }
  if ([decoder containsValueForKey: @"locations"])
  {
  ...
  if ([decoder containsValueForKey: @"postDate"])
  {
    __postDate = [decoder decodeInt64ForKey: @"postDate"];
    __postDate_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__images_isset)
  {
    [encoder encodeObject: __images forKey: @"images"];
  }
  if (__locations_isset)
  {
    [encoder encodeObject: __locations forKey: @"locations"];
  ...
  if (__postDate_isset)
  {
    [encoder encodeInt64: __postDate forKey: @"postDate"];
  }
}
...
- (NSMutableArray *) images {
  return [[__images retain_stub] autorelease_stub];
}
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            NSString * _elem135 = [inProtocol readString];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"SocialPostRequest"];
  if (__socialSources_isset) {
    if (__socialSources != nil) {
      [outProtocol writeFieldBeginWithName: @"socialSources" type: TType_LIST fieldID: 1];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__socialSources count]];
        int idx143;
        for (idx143 = 0; idx143 < [__socialSources count]; idx143++)
        {
          [outProtocol writeString: [__socialSources objectAtIndex: idx143]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__images_isset) {
    if (__images != nil) {
      [outProtocol writeFieldBeginWithName: @"images" type: TType_LIST fieldID: 3];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__images count]];
        int idx145;
        for (idx145 = 0; idx145 < [__images count]; idx145++)
        {
          [[__images objectAtIndex: idx145] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__locations_isset) {
    if (__locations != nil) {
      ...
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__locations count]];
        int idx147;
        for (idx147 = 0; idx147 < [__locations count]; idx147++)
        {
          [outProtocol writeString: [__locations objectAtIndex: idx147]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__postDate_isset) {
    [outProtocol writeFieldBeginWithName: @"postDate" type: TType_I64 fieldID: 5];
    [outProtocol writeI64: __postDate];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"SocialPostRequest("];
  [ms appendString: @"socialSources:"];
  [ms appendFormat: @"%@", __socialSources];
  [ms appendString: @",text:"];
  [ms appendFormat: @"\"%@\"", __text];
  [ms appendString: @",images:"];
  [ms appendFormat: @"%@", __images];
  [ms appendString: @",locations:"];
  [ms appendFormat: @"%@", __locations];
  [ms appendString: @",postDate:"];
  [ms appendFormat: @"%qi", __postDate];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@implementation SocialPostResponse
...
- (id) initWithResponse: (Response *) response socialPost: (MonitorPost *) socialPost
{
  ...
  __socialPost = [socialPost retain_stub];
  __socialPost_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"socialPost"])
  {
    __socialPost = [[decoder decodeObjectForKey: @"socialPost"] retain_stub];
    __socialPost_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__socialPost_isset)
  {
    [encoder encodeObject: __socialPost forKey: @"socialPost"];
  }
}
...
- (MonitorPost *) socialPost {
  return [[__socialPost retain_stub] autorelease_stub];
}

- (void) setSocialPost: (MonitorPost *) socialPost {
  [socialPost retain_stub];
  [__socialPost release_stub];
  __socialPost = socialPost;
  __socialPost_isset = YES;
}

- (BOOL) socialPostIsSet {
  return __socialPost_isset;
}

- (void) unsetSocialPost {
  [__socialPost release_stub];
  __socialPost = nil;
  __socialPost_isset = NO;
}
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_STRUCT) {
          MonitorPost *fieldValue = [[MonitorPost alloc] init];
          [fieldValue read: inProtocol];
          [self setSocialPost: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"SocialPostResponse"];
  if (__response_isset) {
    if (__response != nil) {
  ...
  if (__socialPost_isset) {
    if (__socialPost != nil) {
      [outProtocol writeFieldBeginWithName: @"socialPost" type: TType_STRUCT fieldID: 2];
      [__socialPost write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"SocialPostResponse("];
  [ms appendString: @"response:"];
  [ms appendFormat: @"%@", __response];
  [ms appendString: @",socialPost:"];
  [ms appendFormat: @"%@", __socialPost];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
    ...
    switch (fieldID)
    {
      ...
      case 3:
        if (fieldType == TType_LIST) {
          ...
          {
            Review *_elem150 = [[Review alloc] init];
            [_elem150 read: inProtocol];
            [fieldValue addObject: _elem150];
            [_elem150 release_stub];
          }
          [inProtocol readListEnd];
  ...
  if (__items_isset) {
    if (__items != nil) {
      [outProtocol writeFieldBeginWithName: @"items" type: TType_LIST fieldID: 3];
      {
        ...
        int idx152;
        for (idx152 = 0; idx152 < [__items count]; idx152++)
        {
          [[__items objectAtIndex: idx152] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
@implementation GetRatingResponse
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_STRUCT) {
          Review *fieldValue = [[Review alloc] init];
          [fieldValue read: inProtocol];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetRatingResponse"];
  if (__response_isset) {
    if (__response != nil) {
      [outProtocol writeFieldBeginWithName: @"response" type: TType_STRUCT fieldID: 1];
      [__response write: outProtocol];
  ...
  if (__review_isset) {
    if (__review != nil) {
      [outProtocol writeFieldBeginWithName: @"review" type: TType_STRUCT fieldID: 2];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetRatingResponse("];
  [ms appendString: @"response:"];
  [ms appendFormat: @"%@", __response];
...
@implementation SaveSettingsResponse
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            UserPreference *_elem155 = [[UserPreference alloc] init];
            [_elem155 read: inProtocol];
            [fieldValue addObject: _elem155];
            [_elem155 release_stub];
          }
          [inProtocol readListEnd];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"SaveSettingsResponse"];
  if (__response_isset) {
    if (__response != nil) {
      [outProtocol writeFieldBeginWithName: @"response" type: TType_STRUCT fieldID: 1];
      [__response write: outProtocol];
  ...
  if (__userSettings_isset) {
    if (__userSettings != nil) {
      [outProtocol writeFieldBeginWithName: @"userSettings" type: TType_LIST fieldID: 2];
      {
        ...
        int idx157;
        for (idx157 = 0; idx157 < [__userSettings count]; idx157++)
        {
          [[__userSettings objectAtIndex: idx157] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"SaveSettingsResponse("];
  [ms appendString: @"response:"];
  [ms appendFormat: @"%@", __response];
...
- (id) initWithResponse: (Response *) response ratingID: (NSString *) ratingID socialReply: (Reply *) socialReply reviewResponse: (ReviewResponse *) reviewResponse
{
  ...
  __socialReply = [socialReply retain_stub];
  __socialReply_isset = YES;
  __reviewResponse = [reviewResponse retain_stub];
  __reviewResponse_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"socialReply"])
  {
    __socialReply = [[decoder decodeObjectForKey: @"socialReply"] retain_stub];
    __socialReply_isset = YES;
  }
  if ([decoder containsValueForKey: @"reviewResponse"])
  {
    __reviewResponse = [[decoder decodeObjectForKey: @"reviewResponse"] retain_stub];
    __reviewResponse_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__socialReply_isset)
  {
    [encoder encodeObject: __socialReply forKey: @"socialReply"];
  }
  if (__reviewResponse_isset)
  {
    [encoder encodeObject: __reviewResponse forKey: @"reviewResponse"];
  }
}
...
- (void) dealloc
{
  ...
  [__socialReply release_stub];
  [__reviewResponse release_stub];
  [super dealloc_stub];
}
...
- (Reply *) socialReply {
  return [[__socialReply retain_stub] autorelease_stub];
}

- (void) setSocialReply: (Reply *) socialReply {
  [socialReply retain_stub];
  [__socialReply release_stub];
  __socialReply = socialReply;
  __socialReply_isset = YES;
}

- (BOOL) socialReplyIsSet {
  return __socialReply_isset;
}

- (void) unsetSocialReply {
  [__socialReply release_stub];
  __socialReply = nil;
  __socialReply_isset = NO;
}

- (ReviewResponse *) reviewResponse {
  return [[__reviewResponse retain_stub] autorelease_stub];
}

- (void) setReviewResponse: (ReviewResponse *) reviewResponse {
  [reviewResponse retain_stub];
  [__reviewResponse release_stub];
  __reviewResponse = reviewResponse;
  __reviewResponse_isset = YES;
}

- (BOOL) reviewResponseIsSet {
  return __reviewResponse_isset;
}

- (void) unsetReviewResponse {
  [__reviewResponse release_stub];
  __reviewResponse = nil;
  __reviewResponse_isset = NO;
}
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 3:
        if (fieldType == TType_STRUCT) {
          Reply *fieldValue = [[Reply alloc] init];
          [fieldValue read: inProtocol];
          [self setSocialReply: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
      ...
      case 4:
        if (fieldType == TType_STRUCT) {
          ReviewResponse *fieldValue = [[ReviewResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setReviewResponse: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__socialReply_isset) {
    if (__socialReply != nil) {
      [outProtocol writeFieldBeginWithName: @"socialReply" type: TType_STRUCT fieldID: 3];
      [__socialReply write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  if (__reviewResponse_isset) {
    if (__reviewResponse != nil) {
      [outProtocol writeFieldBeginWithName: @"reviewResponse" type: TType_STRUCT fieldID: 4];
      [__reviewResponse write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  ...
  [ms appendString: @",socialReply:"];
  [ms appendFormat: @"%@", __socialReply];
  [ms appendString: @",reviewResponse:"];
  [ms appendFormat: @"%@", __reviewResponse];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            SummaryCell *_elem160 = [[SummaryCell alloc] init];
  ...
  if (__aggregates_isset) {
    if (__aggregates != nil) {
      [outProtocol writeFieldBeginWithName: @"aggregates" type: TType_LIST fieldID: 2];
      {
        ...
        int idx162;
        for (idx162 = 0; idx162 < [__aggregates count]; idx162++)
        {
          [[__aggregates objectAtIndex: idx162] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            MonitorPost *_elem165 = [[MonitorPost alloc] init];
  ...
  if (__socialPosts_isset) {
    if (__socialPosts != nil) {
      [outProtocol writeFieldBeginWithName: @"socialPosts" type: TType_LIST fieldID: 2];
      {
        ...
        int idx167;
        for (idx167 = 0; idx167 < [__socialPosts count]; idx167++)
        {
          [[__socialPosts objectAtIndex: idx167] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
@implementation SocialPostRepliesResponse
...
- (id) initWithResponse: (Response *) response postReplies: (NSMutableArray *) postReplies
{
  ...
  __response = [response retain_stub];
  __response_isset = YES;
  __postReplies = [postReplies retain_stub];
  __postReplies_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"postReplies"])
  {
    __postReplies = [[decoder decodeObjectForKey: @"postReplies"] retain_stub];
    __postReplies_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__postReplies_isset)
  {
    [encoder encodeObject: __postReplies forKey: @"postReplies"];
  }
}
...
- (NSMutableArray *) postReplies {
  return [[__postReplies retain_stub] autorelease_stub];
}

- (void) setPostReplies: (NSMutableArray *) postReplies {
  [postReplies retain_stub];
  [__postReplies release_stub];
  __postReplies = postReplies;
  __postReplies_isset = YES;
}

- (BOOL) postRepliesIsSet {
  return __postReplies_isset;
}

- (void) unsetPostReplies {
  [__postReplies release_stub];
  __postReplies = nil;
  __postReplies_isset = NO;
}
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            Reply *_elem170 = [[Reply alloc] init];
            [_elem170 read: inProtocol];
            [fieldValue addObject: _elem170];
            [_elem170 release_stub];
          }
          [inProtocol readListEnd];
          [self setPostReplies: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"SocialPostRepliesResponse"];
  if (__response_isset) {
    if (__response != nil) {
      [outProtocol writeFieldBeginWithName: @"response" type: TType_STRUCT fieldID: 1];
      [__response write: outProtocol];
  ...
  if (__postReplies_isset) {
    if (__postReplies != nil) {
      [outProtocol writeFieldBeginWithName: @"postReplies" type: TType_LIST fieldID: 2];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__postReplies count]];
        int idx172;
        for (idx172 = 0; idx172 < [__postReplies count]; idx172++)
        {
          [[__postReplies objectAtIndex: idx172] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"SocialPostRepliesResponse("];
  [ms appendString: @"response:"];
  [ms appendFormat: @"%@", __response];
  [ms appendString: @",postReplies:"];
  [ms appendFormat: @"%@", __postReplies];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@implementation TODOFeedResponse
...
- (id) initWithResponse: (Response *) response todoItems: (NSMutableArray *) todoItems totalCount: (int32_t) totalCount start: (int32_t) start
{
  ...
  __response = [response retain_stub];
  __response_isset = YES;
  __todoItems = [todoItems retain_stub];
  __todoItems_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"todoItems"])
  {
    __todoItems = [[decoder decodeObjectForKey: @"todoItems"] retain_stub];
    __todoItems_isset = YES;
  }
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__todoItems_isset)
  {
    [encoder encodeObject: __todoItems forKey: @"todoItems"];
  }
...
- (NSMutableArray *) todoItems {
  return [[__todoItems retain_stub] autorelease_stub];
}

- (void) setTodoItems: (NSMutableArray *) todoItems {
  [todoItems retain_stub];
  [__todoItems release_stub];
  __todoItems = todoItems;
  __todoItems_isset = YES;
}

- (BOOL) todoItemsIsSet {
  return __todoItems_isset;
}

- (void) unsetTodoItems {
  [__todoItems release_stub];
  __todoItems = nil;
  __todoItems_isset = NO;
}
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            ScheduledPost *_elem175 = [[ScheduledPost alloc] init];
            [_elem175 read: inProtocol];
            [fieldValue addObject: _elem175];
            [_elem175 release_stub];
          }
          [inProtocol readListEnd];
          [self setTodoItems: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"TODOFeedResponse"];
  if (__response_isset) {
    if (__response != nil) {
      [outProtocol writeFieldBeginWithName: @"response" type: TType_STRUCT fieldID: 1];
      [__response write: outProtocol];
  ...
  if (__todoItems_isset) {
    if (__todoItems != nil) {
      [outProtocol writeFieldBeginWithName: @"todoItems" type: TType_LIST fieldID: 2];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__todoItems count]];
        int idx177;
        for (idx177 = 0; idx177 < [__todoItems count]; idx177++)
        {
          [[__todoItems objectAtIndex: idx177] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__totalCount_isset) {
    [outProtocol writeFieldBeginWithName: @"totalCount" type: TType_I32 fieldID: 3];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"TODOFeedResponse("];
  [ms appendString: @"response:"];
  [ms appendFormat: @"%@", __response];
  [ms appendString: @",todoItems:"];
  [ms appendFormat: @"%@", __todoItems];
...
@implementation UpdateTODOPostRequest
...
- (id) initWithAction: (int) action schedulePostId: (NSString *) schedulePostId locations: (NSMutableArray *) locations searchCriteria: (SearchFilter *) searchCriteria start: (int32_t) start pageCount: (int32_t) pageCount
{
  ...
  __action = action;
  __action_isset = YES;
  __schedulePostId = [schedulePostId retain_stub];
  __schedulePostId_isset = YES;
  __locations = [locations retain_stub];
  __locations_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"schedulePostId"])
  {
    __schedulePostId = [[decoder decodeObjectForKey: @"schedulePostId"] retain_stub];
    __schedulePostId_isset = YES;
  }
  if ([decoder containsValueForKey: @"locations"])
  {
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__schedulePostId_isset)
  {
    [encoder encodeObject: __schedulePostId forKey: @"schedulePostId"];
  }
  if (__locations_isset)
  {
    [encoder encodeObject: __locations forKey: @"locations"];
...
- (NSString *) schedulePostId {
  return [[__schedulePostId retain_stub] autorelease_stub];
}

- (void) setSchedulePostId: (NSString *) schedulePostId {
  [schedulePostId retain_stub];
  [__schedulePostId release_stub];
  __schedulePostId = schedulePostId;
  __schedulePostId_isset = YES;
}

- (BOOL) schedulePostIdIsSet {
  return __schedulePostId_isset;
}

- (void) unsetSchedulePostId {
  [__schedulePostId release_stub];
  __schedulePostId = nil;
  __schedulePostId_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setSchedulePostId: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 3:
        if (fieldType == TType_LIST) {
          ...
          {
            NSString * _elem180 = [inProtocol readString];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"UpdateTODOPostRequest"];
  if (__action_isset) {
    [outProtocol writeFieldBeginWithName: @"action" type: TType_I32 fieldID: 1];
    [outProtocol writeI32: __action];
    [outProtocol writeFieldEnd];
  }
  if (__schedulePostId_isset) {
    if (__schedulePostId != nil) {
      [outProtocol writeFieldBeginWithName: @"schedulePostId" type: TType_STRING fieldID: 2];
      [outProtocol writeString: __schedulePostId];
      [outProtocol writeFieldEnd];
    }
  }
  if (__locations_isset) {
    if (__locations != nil) {
      [outProtocol writeFieldBeginWithName: @"locations" type: TType_LIST fieldID: 3];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__locations count]];
        int idx182;
        for (idx182 = 0; idx182 < [__locations count]; idx182++)
        {
          [outProtocol writeString: [__locations objectAtIndex: idx182]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__start_isset) {
    [outProtocol writeFieldBeginWithName: @"start" type: TType_I32 fieldID: 5];
    [outProtocol writeI32: __start];
    [outProtocol writeFieldEnd];
  }
  if (__pageCount_isset) {
    [outProtocol writeFieldBeginWithName: @"pageCount" type: TType_I32 fieldID: 6];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"UpdateTODOPostRequest("];
  [ms appendString: @"action:"];
  [ms appendFormat: @"%i", __action];
  [ms appendString: @",schedulePostId:"];
  [ms appendFormat: @"\"%@\"", __schedulePostId];
  [ms appendString: @",locations:"];
  [ms appendFormat: @"%@", __locations];
...
@implementation GetScheduledPostResponse
...
- (id) initWithResponse: (Response *) response post: (ScheduledPost *) post
{
  self = [super init];
  __response = [response retain_stub];
  __response_isset = YES;
...
- (void) setPost: (ScheduledPost *) post {
  [post retain_stub];
  [__post release_stub];
  __post = post;
  __post_isset = YES;
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_STRUCT) {
          ScheduledPost *fieldValue = [[ScheduledPost alloc] init];
          [fieldValue read: inProtocol];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetScheduledPostResponse"];
  if (__response_isset) {
    if (__response != nil) {
      [outProtocol writeFieldBeginWithName: @"response" type: TType_STRUCT fieldID: 1];
      [__response write: outProtocol];
  ...
  if (__post_isset) {
    if (__post != nil) {
      [outProtocol writeFieldBeginWithName: @"post" type: TType_STRUCT fieldID: 2];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetScheduledPostResponse("];
  [ms appendString: @"response:"];
  [ms appendFormat: @"%@", __response];
...
@implementation PostLocationResponse
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 6:
        if (fieldType == TType_MAP) {
          int _size183;
          [inProtocol readMapBeginReturningKeyType: NULL valueType: NULL size: &_size183];
          NSMutableDictionary * fieldValue = [[NSMutableDictionary alloc] initWithCapacity: _size183];
          int _i184;
          for (_i184 = 0; _i184 < _size183; ++_i184)
          {
            NSString * _key185 = [inProtocol readString];
            NSString * _val186 = [inProtocol readString];
            [fieldValue setObject: _val186 forKey: _key185];
          }
          [inProtocol readMapEnd];
          [self setLocations: fieldValue];
          [fieldValue release_stub];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"PostLocationResponse"];
  if (__response_isset) {
    if (__response != nil) {
      [outProtocol writeFieldBeginWithName: @"response" type: TType_STRUCT fieldID: 1];
      [__response write: outProtocol];
  ...
  if (__locations_isset) {
    if (__locations != nil) {
      ...
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_STRING size: [__locations count]];
        NSEnumerator * _iter187 = [__locations keyEnumerator];
        id key188;
        while ((key188 = [_iter187 nextObject]))
        {
          [outProtocol writeString: key188];
          [outProtocol writeString: [__locations objectForKey: key188]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"PostLocationResponse("];
  [ms appendString: @"response:"];
  [ms appendFormat: @"%@", __response];
  [ms appendString: @",locations:"];
  [ms appendFormat: @"%@", __locations];
  ...
  if (__locationListings_isset) {
    if (__locationListings != nil) {
      [outProtocol writeFieldBeginWithName: @"locationListings" type: TType_LIST fieldID: 2];
      {
        ...
        int idx196;
        for (idx196 = 0; idx196 < [__locationListings count]; idx196++)
        {
          [[__locationListings objectAtIndex: idx196] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sourceListings_isset) {
    if (__sourceListings != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceListings" type: TType_LIST fieldID: 3];
      {
        ...
        int idx198;
        for (idx198 = 0; idx198 < [__sourceListings count]; idx198++)
        {
          [[__sourceListings objectAtIndex: idx198] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__activityPeriod_isset) {
    if (__activityPeriod != nil) {
      [outProtocol writeFieldBeginWithName: @"activityPeriod" type: TType_LIST fieldID: 2];
      {
        ...
        int idx203;
        for (idx203 = 0; idx203 < [__activityPeriod count]; idx203++)
        {
          [[__activityPeriod objectAtIndex: idx203] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
static int32_t ERROR_RATING_SVC = 1011;
static int32_t ERROR_GETRATING_SVC = 1013;
static int32_t ERROR_PUBLISH_SVC = 1014;
static int32_t ERROR_SAVE_DISTRIBUTION_SVC = 1015;
static int32_t ERROR_DELETE_SVC = 1016;
static int32_t ERROR_SAVE_REQREV_SVC = 1017;
static int32_t ERROR_REVIEW_RESPONSE_SVC = 1018;
static int32_t ERROR_SOCIAL_REPLY_SVC = 1019;
static int32_t ERROR_SOCIAL_POST_SVC = 1020;
...
static int32_t ERROR_AUTH_PUBLISH_RATING = 1104;
static int32_t ERROR_VALIDATION_PUBLISH = 1105;
static int32_t ERROR_VALIDATION_UNPUBLISH = 1106;
static int32_t ERROR_VALIDATION_NOTKIOSK = 1107;
static int32_t ERROR_AUTH_DELETE_RATING = 1108;
static int32_t ERROR_VALIDATION_RFMESSAGE = 1109;
static int32_t ERROR_VALIDATION_EMAIL = 1110;
static int32_t ERROR_VALIDATION_SOCIAL_REPLY_ID = 1111;
static int32_t ERROR_AUTH_REPLY_RATING = 1112;
static int32_t ERROR_AUTH_FLAG_POST = 1113;
static int32_t ERROR_VALIDATION_POSTTEXT = 1114;
static int32_t ERROR_AUTH_POST_SOCIAL = 1115;
static int32_t ERROR_VALIDATION_SOCIAL_NO_LOCATION = 1116;
static int32_t ERROR_VALIDATION_SOCIAL_NO_SOURCE = 1117;
static int32_t ERROR_VALIDATION_SOCIAL_TIME = 1118;
static int32_t ERROR_VALIDATION_REQUEST = 1119;
static int32_t ERROR_VALIDATION_SOCIAL_TRANSMISSION = 1120;
...
static NSString * SUMMARY_NOREVIEWS_THIRDPARTY_TOTALCOUNT = @"summary.numreviews.tptotalcount";
static NSString * SUMMARY_OVERALL_SCORE_MINUS_90_DAYS = @"summary.overallscore90days.score";
static NSString * SUMMARY_KIOSK_TRACKING = @"summary.kiosk.last5weeks";
static NSString * SUMMARY_THIRD_PARTY_SOURCE_TRACKING = @"summary.tpsource.last5weeks";
...
static NSString * SUMMARY_ALL_SOURCE_TRACKING = @"summary.allsource.last6months";
static NSString * SUMMARY_INDUSTRY_DATA = @"summary.industry.data";
...
static NSString * SUMMARY_OVERALL_SCORE_FIRSTIMPRESSIONS = @"summary.overallscore.firstimpressions";
...
static NSString * SUMMARY_OVERALL_SCORE_FIRSTIMPRESSIONS_FILLCOLOR = @"summary.overallscore.firstimpressions.fillcolor";
...
static NSString * SUMMARY_SOURCE_THIRD_PARTY = @"summary.source.thirdparty";
static NSString * SUMMARY_WEEK_TRACKING_DATE = @"summary.week.startdate";
static NSString * SUMMARY_MONTH_TRACKING_DATE = @"summary.month.startdate";
static NSString * SUMMARY_SENTIMENT_POSITIVE = @"summary.sentiment.positive";
static NSString * SUMMARY_SENTIMENT_NEUTRAL = @"summary.sentiment.neutral";
static NSString * SUMMARY_SENTIMENT_NEGATIVE = @"summary.sentiment.negative";
static NSString * SUMMARY_GRAPH_FILLCOLOR = @"summary.graph.fillcolor";
static NSString * SUMMARY_INDUSTRY_AVERAGE = @"summary.industry.average";
static NSString * SUMMARY_INDUSTRY_AVERAGE_FILLCOLOR = @"summary.industry.average.fillcolor";
static NSString * SUMMARY_INDUSTRY_TOP_5_PERCENT = @"summary.industry.top5percent";
static NSString * SUMMARY_INDUSTRY_TOP_5_PERCENT_FILLCOLOR = @"summary.industry.top5percent.fillcolor";
static NSString * FACEBOOK_PROVIDER_NAME = @"Reputation.com - Facebook";
static NSString * FACEBOOK_COMMENT_COUNT = @"facebookCommentCount";
static NSString * FACEBOOK_LIKE_COUNT = @"likeCount";
static NSString * FACEBOOK_SHARE_COUNT = @"shareCount";
static NSString * FACEBOOK_TAG_URL = @"http://www.facebook.com/";
static NSString * FACEBOOK_HASHTAG_URL = @"http://www.facebook.com/hashtag/";
static NSString * TWITTER_PROVIDER_NAME = @"Reputation.com - Twitter";
static NSString * TWITTER_MENTIONS_COUNT = @"twitterMentionsCount";
static NSString * TWITTER_FOLLOWER_COUNT = @"followerCount";
static NSString * TWITTER_RETWEET_COUNT = @"retweetCount";
static NSString * TWITTER_UPVOTED = @"upVoted";
static NSString * TWITTER_TAG_URL = @"http://twitter.com/";
static NSString * TWITTER_HASHTAG_URL = @"http://twitter.com/search?q=%23";
static NSString * GOOGLE_PROVIDER_NAME = @"Reputation.com - Google+";
static NSString * GOOGLE_COMMENT_COUNT = @"googlePlusCommentCount";
static NSString * GOOGLE_PLUS_ONE_COUNT = @"plusOneCount";
static NSString * GOOGLE_CIRCLED_BY_COUNT = @"circledByCount";
static NSString * GOOGLE_RESHARE_COUNT = @"reshareCount";
static NSString * GOOGLE_TAG_URL = @"http://plus.google.com/";
static NSString * GOOGLE_HASHTAG_URL = @"http://plus.google.com/s/%23";
static NSString * YOUTUBE_DISLIKE_COUNT = @"youtubeDislikeCount";
static NSString * YOUTUBE_VIEW_COUNT = @"youtubeViewCount";
static NSString * YOUTUBE_LIKE_COUNT = @"youtubeLikeCount";
static NSString * YOUTUBE_FAVORITE_COUNT = @"youtubeFavoriteCount";
static NSString * IMAGE_FORMAT = @"image.format";
static NSString * IMAGE_FILENAME = @"image.filename";
static NSString * IMAGE_DATE_TIME = @"image.datetime";
static NSString * IMAGE_LAT_LNG = @"image.latlng";
static NSString * FEED_TYPE = @"feed.type";
static NSString * FEED_ID = @"id";
static NSString * FEED_TYPE_REVIEWS = @"reviews";
static NSString * FEED_TYPE_DASHBOARD = @"dashboard";
static NSString * FEED_TYPE_TODO = @"todo";
static NSString * TODO_APPROVED = @"This post has been approved";
static NSString * TODO_REJECTED = @"This post has been rejected";
...
+ (int32_t) ERROR_SOURCES_SVC{
  return ERROR_SOURCES_SVC;
}
+ (int32_t) ERROR_SOCIAL_SVC{
  return ERROR_SOCIAL_SVC;
}
+ (int32_t) ERROR_RATING_SVC{
  return ERROR_RATING_SVC;
}
+ (int32_t) ERROR_GETRATING_SVC{
  return ERROR_GETRATING_SVC;
}
+ (int32_t) ERROR_PUBLISH_SVC{
  return ERROR_PUBLISH_SVC;
}
+ (int32_t) ERROR_SAVE_DISTRIBUTION_SVC{
  return ERROR_SAVE_DISTRIBUTION_SVC;
}
+ (int32_t) ERROR_DELETE_SVC{
  return ERROR_DELETE_SVC;
}
+ (int32_t) ERROR_SAVE_REQREV_SVC{
  return ERROR_SAVE_REQREV_SVC;
}
+ (int32_t) ERROR_REVIEW_RESPONSE_SVC{
  return ERROR_REVIEW_RESPONSE_SVC;
}
+ (int32_t) ERROR_SOCIAL_REPLY_SVC{
  return ERROR_SOCIAL_REPLY_SVC;
}
+ (int32_t) ERROR_SOCIAL_POST_SVC{
  return ERROR_SOCIAL_POST_SVC;
}
+ (int32_t) ERROR_SOCIAL_S3_SVC{
  return ERROR_SOCIAL_S3_SVC;
}
+ (int32_t) ERROR_DISTRIBUTION_SVC{
  return ERROR_DISTRIBUTION_SVC;
}
...
+ (NSString *) SUMMARY_NOREVIEWS_THIRDPARTY_SOURCES{
  return SUMMARY_NOREVIEWS_THIRDPARTY_SOURCES;
}
+ (NSString *) SUMMARY_NOREVIEWS_THIRDPARTY_TOTALCOUNT{
  return SUMMARY_NOREVIEWS_THIRDPARTY_TOTALCOUNT;
}
+ (NSString *) SUMMARY_OVERALL_SCORE_MINUS_90_DAYS{
  return SUMMARY_OVERALL_SCORE_MINUS_90_DAYS;
}
+ (NSString *) SUMMARY_KIOSK_TRACKING{
  return SUMMARY_KIOSK_TRACKING;
}
+ (NSString *) SUMMARY_THIRD_PARTY_SOURCE_TRACKING{
  return SUMMARY_THIRD_PARTY_SOURCE_TRACKING;
}
+ (NSString *) SUMMARY_THIRD_PARTY_SOURCE_TRACKING_NO_KIOSK{
  return SUMMARY_THIRD_PARTY_SOURCE_TRACKING_NO_KIOSK;
}
+ (NSString *) SUMMARY_THIRD_PARTY_SOURCE_ALL_TIME{
  return SUMMARY_THIRD_PARTY_SOURCE_ALL_TIME;
}
...
+ (NSString *) SUMMARY_ALL_SOURCE_TRACKING{
  return SUMMARY_ALL_SOURCE_TRACKING;
}
+ (NSString *) SUMMARY_INDUSTRY_DATA{
  return SUMMARY_INDUSTRY_DATA;
}
...
+ (NSString *) SUMMARY_OVERALL_SCORE_FIRSTIMPRESSIONS{
  return SUMMARY_OVERALL_SCORE_FIRSTIMPRESSIONS;
}
...
+ (NSString *) SUMMARY_OVERALL_SCORE_FIRSTIMPRESSIONS_FILLCOLOR{
  return SUMMARY_OVERALL_SCORE_FIRSTIMPRESSIONS_FILLCOLOR;
}
...
+ (NSString *) SUMMARY_SOURCE_THIRD_PARTY{
  return SUMMARY_SOURCE_THIRD_PARTY;
}
+ (NSString *) SUMMARY_WEEK_TRACKING_DATE{
  return SUMMARY_WEEK_TRACKING_DATE;
}
+ (NSString *) SUMMARY_MONTH_TRACKING_DATE{
  return SUMMARY_MONTH_TRACKING_DATE;
}
+ (NSString *) SUMMARY_SENTIMENT_POSITIVE{
  return SUMMARY_SENTIMENT_POSITIVE;
}
+ (NSString *) SUMMARY_SENTIMENT_NEUTRAL{
  return SUMMARY_SENTIMENT_NEUTRAL;
}
+ (NSString *) SUMMARY_SENTIMENT_NEGATIVE{
  return SUMMARY_SENTIMENT_NEGATIVE;
}
+ (NSString *) SUMMARY_GRAPH_FILLCOLOR{
  return SUMMARY_GRAPH_FILLCOLOR;
}
+ (NSString *) SUMMARY_INDUSTRY_AVERAGE{
  return SUMMARY_INDUSTRY_AVERAGE;
}
+ (NSString *) SUMMARY_INDUSTRY_AVERAGE_FILLCOLOR{
  return SUMMARY_INDUSTRY_AVERAGE_FILLCOLOR;
}
+ (NSString *) SUMMARY_INDUSTRY_TOP_5_PERCENT{
  return SUMMARY_INDUSTRY_TOP_5_PERCENT;
}
+ (NSString *) SUMMARY_INDUSTRY_TOP_5_PERCENT_FILLCOLOR{
  return SUMMARY_INDUSTRY_TOP_5_PERCENT_FILLCOLOR;
}
+ (NSString *) FACEBOOK_PROVIDER_NAME{
  return FACEBOOK_PROVIDER_NAME;
}
+ (NSString *) FACEBOOK_COMMENT_COUNT{
  return FACEBOOK_COMMENT_COUNT;
}
+ (NSString *) FACEBOOK_LIKE_COUNT{
  return FACEBOOK_LIKE_COUNT;
}
+ (NSString *) FACEBOOK_SHARE_COUNT{
  return FACEBOOK_SHARE_COUNT;
}
+ (NSString *) FACEBOOK_TAG_URL{
  return FACEBOOK_TAG_URL;
}
+ (NSString *) FACEBOOK_HASHTAG_URL{
  return FACEBOOK_HASHTAG_URL;
}
+ (NSString *) TWITTER_PROVIDER_NAME{
  return TWITTER_PROVIDER_NAME;
}
+ (NSString *) TWITTER_MENTIONS_COUNT{
  return TWITTER_MENTIONS_COUNT;
}
+ (NSString *) TWITTER_FOLLOWER_COUNT{
  return TWITTER_FOLLOWER_COUNT;
}
+ (NSString *) TWITTER_RETWEET_COUNT{
  return TWITTER_RETWEET_COUNT;
}
+ (NSString *) TWITTER_UPVOTED{
  return TWITTER_UPVOTED;
}
+ (NSString *) TWITTER_TAG_URL{
  return TWITTER_TAG_URL;
}
+ (NSString *) TWITTER_HASHTAG_URL{
  return TWITTER_HASHTAG_URL;
}
+ (NSString *) GOOGLE_PROVIDER_NAME{
  return GOOGLE_PROVIDER_NAME;
}
+ (NSString *) GOOGLE_COMMENT_COUNT{
  return GOOGLE_COMMENT_COUNT;
}
+ (NSString *) GOOGLE_PLUS_ONE_COUNT{
  return GOOGLE_PLUS_ONE_COUNT;
}
+ (NSString *) GOOGLE_CIRCLED_BY_COUNT{
  return GOOGLE_CIRCLED_BY_COUNT;
}
+ (NSString *) GOOGLE_RESHARE_COUNT{
  return GOOGLE_RESHARE_COUNT;
}
+ (NSString *) GOOGLE_TAG_URL{
  return GOOGLE_TAG_URL;
}
+ (NSString *) GOOGLE_HASHTAG_URL{
  return GOOGLE_HASHTAG_URL;
}
+ (NSString *) YOUTUBE_DISLIKE_COUNT{
  return YOUTUBE_DISLIKE_COUNT;
}
+ (NSString *) YOUTUBE_VIEW_COUNT{
  return YOUTUBE_VIEW_COUNT;
}
+ (NSString *) YOUTUBE_LIKE_COUNT{
  return YOUTUBE_LIKE_COUNT;
}
+ (NSString *) YOUTUBE_FAVORITE_COUNT{
  return YOUTUBE_FAVORITE_COUNT;
}
...
+ (NSString *) FEED_TYPE_REVIEWS{
  return FEED_TYPE_REVIEWS;
}
+ (NSString *) FEED_TYPE_DASHBOARD{
  return FEED_TYPE_DASHBOARD;
}
+ (NSString *) FEED_TYPE_TODO{
  return FEED_TYPE_TODO;
}
+ (NSString *) TODO_APPROVED{
  return TODO_APPROVED;
}
+ (NSString *) TODO_REJECTED{
  return TODO_REJECTED;
}
@end

@interface getReviewsFeed_args : NSObject <TBase, NSCoding> {
  int64_t __uptoTime;
  int32_t __start;
  int32_t __pageCount;
...
@interface GetReviewsFeed_result : NSObject <TBase, NSCoding> {
...
@interface getSocialFeed_args : NSObject <TBase, NSCoding> {
  int64_t __uptoTime;
  int32_t __start;
  int32_t __pageCount;
  SearchFilter * __searchCriteria;
...
@interface GetSocialFeed_result : NSObject <TBase, NSCoding> {
...
@interface getTODOFeed_args : NSObject <TBase, NSCoding> {
  int32_t __start;
  int32_t __pageCount;
  SearchFilter * __searchCriteria;
...
- (id) init;
- (id) initWithStart: (int32_t) start pageCount: (int32_t) pageCount searchCriteria: (SearchFilter *) searchCriteria;
...
@implementation getTODOFeed_args
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"getTODOFeed_args"];
  if (__start_isset) {
    [outProtocol writeFieldBeginWithName: @"start" type: TType_I32 fieldID: 1];
    [outProtocol writeI32: __start];
    [outProtocol writeFieldEnd];
  }
  if (__pageCount_isset) {
    [outProtocol writeFieldBeginWithName: @"pageCount" type: TType_I32 fieldID: 2];
    [outProtocol writeI32: __pageCount];
    [outProtocol writeFieldEnd];
  }
  if (__searchCriteria_isset) {
    if (__searchCriteria != nil) {
      [outProtocol writeFieldBeginWithName: @"searchCriteria" type: TType_STRUCT fieldID: 3];
      [__searchCriteria write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"getTODOFeed_args("];
  [ms appendString: @"start:"];
  [ms appendFormat: @"%i", __start];
  [ms appendString: @",pageCount:"];
  [ms appendFormat: @"%i", __pageCount];
...
@interface GetTODOFeed_result : NSObject <TBase, NSCoding> {
  TODOFeedResponse * __success;

  BOOL __success_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=success, setter=setSuccess:) TODOFeedResponse * success;
#endif

- (id) init;
- (id) initWithSuccess: (TODOFeedResponse *) success;
...
#if !__has_feature(objc_arc)
- (TODOFeedResponse *) success;
- (void) setSuccess: (TODOFeedResponse *) success;
#endif
- (BOOL) successIsSet;

@end

@implementation GetTODOFeed_result
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_STRUCT) {
          TODOFeedResponse *fieldValue = [[TODOFeedResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setSuccess: fieldValue];
          [fieldValue release_stub];
        } else { 
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetTODOFeed_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetTODOFeed_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface getSocialReplies_args : NSObject <TBase, NSCoding> {
  NSString * __parentId;
  int32_t __start;
...
- (id) init;
- (id) initWithParentId: (NSString *) parentId start: (int32_t) start;
...
@implementation getSocialReplies_args
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"getSocialReplies_args"];
  if (__parentId_isset) {
    if (__parentId != nil) {
      [outProtocol writeFieldBeginWithName: @"parentId" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __parentId];
      [outProtocol writeFieldEnd];
    }
  }
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"getSocialReplies_args("];
  [ms appendString: @"parentId:"];
  [ms appendFormat: @"\"%@\"", __parentId];
  [ms appendString: @",start:"];
  [ms appendFormat: @"%i", __start];
...
@interface GetSocialReplies_result : NSObject <TBase, NSCoding> {
  SocialPostRepliesResponse * __success;

  BOOL __success_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=success, setter=setSuccess:) SocialPostRepliesResponse * success;
#endif

- (id) init;
- (id) initWithSuccess: (SocialPostRepliesResponse *) success;
...
#if !__has_feature(objc_arc)
- (SocialPostRepliesResponse *) success;
- (void) setSuccess: (SocialPostRepliesResponse *) success;
#endif
- (BOOL) successIsSet;

@end

@implementation GetSocialReplies_result
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_STRUCT) {
          SocialPostRepliesResponse *fieldValue = [[SocialPostRepliesResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setSuccess: fieldValue];
          [fieldValue release_stub];
        } else { 
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetSocialReplies_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetSocialReplies_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface getRating_args : NSObject <TBase, NSCoding> {
  NSString * __ratingId;
...
@interface GetRating_result : NSObject <TBase, NSCoding> {
  GetRatingResponse * __success;

  BOOL __success_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=success, setter=setSuccess:) GetRatingResponse * success;
#endif

- (id) init;
- (id) initWithSuccess: (GetRatingResponse *) success;
...
#if !__has_feature(objc_arc)
- (GetRatingResponse *) success;
- (void) setSuccess: (GetRatingResponse *) success;
#endif
- (BOOL) successIsSet;
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_STRUCT) {
          GetRatingResponse *fieldValue = [[GetRatingResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setSuccess: fieldValue];
          [fieldValue release_stub];
        } else { 
...
@interface getSocialPost_args : NSObject <TBase, NSCoding> {
  NSString * __socialPostId;

  BOOL __socialPostId_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=socialPostId, setter=setSocialPostId:) NSString * socialPostId;
#endif

- (id) init;
- (id) initWithSocialPostId: (NSString *) socialPostId;
...
#if !__has_feature(objc_arc)
- (NSString *) socialPostId;
- (void) setSocialPostId: (NSString *) socialPostId;
#endif
- (BOOL) socialPostIdIsSet;

@end

@implementation getSocialPost_args
...
{
  self = [super init];
  __socialPostId = [socialPostId retain_stub];
  __socialPostId_isset = YES;
  return self;
}
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"socialPostId"])
  {
    __socialPostId = [[decoder decodeObjectForKey: @"socialPostId"] retain_stub];
    __socialPostId_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__socialPostId_isset)
  {
    [encoder encodeObject: __socialPostId forKey: @"socialPostId"];
  }
}

- (void) dealloc
{
  [__socialPostId release_stub];
  [super dealloc_stub];
}

- (NSString *) socialPostId {
  return [[__socialPostId retain_stub] autorelease_stub];
}

- (void) setSocialPostId: (NSString *) socialPostId {
  [socialPostId retain_stub];
  [__socialPostId release_stub];
  __socialPostId = socialPostId;
  __socialPostId_isset = YES;
}

- (BOOL) socialPostIdIsSet {
  return __socialPostId_isset;
}

- (void) unsetSocialPostId {
  [__socialPostId release_stub];
  __socialPostId = nil;
  __socialPostId_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setSocialPostId: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"getSocialPost_args"];
  if (__socialPostId_isset) {
    if (__socialPostId != nil) {
      [outProtocol writeFieldBeginWithName: @"socialPostId" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __socialPostId];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"getSocialPost_args("];
  [ms appendString: @"socialPostId:"];
  [ms appendFormat: @"\"%@\"", __socialPostId];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@interface GetSocialPost_result : NSObject <TBase, NSCoding> {
  SocialPostResponse * __success;

  BOOL __success_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=success, setter=setSuccess:) SocialPostResponse * success;
#endif

- (id) init;
- (id) initWithSuccess: (SocialPostResponse *) success;
...
#if !__has_feature(objc_arc)
- (SocialPostResponse *) success;
- (void) setSuccess: (SocialPostResponse *) success;
#endif
- (BOOL) successIsSet;

@end

@implementation GetSocialPost_result
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_STRUCT) {
          SocialPostResponse *fieldValue = [[SocialPostResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setSuccess: fieldValue];
          [fieldValue release_stub];
        } else { 
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetSocialPost_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetSocialPost_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface getUserConfig_args : NSObject <TBase, NSCoding> {
}
...
@interface GetUserConfig_result : NSObject <TBase, NSCoding> {
...
@interface saveUserSettings_args : NSObject <TBase, NSCoding> {
...
@implementation saveUserSettings_args
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"saveUserSettings_args"];
  if (__userSettings_isset) {
    if (__userSettings != nil) {
      [outProtocol writeFieldBeginWithName: @"userSettings" type: TType_LIST fieldID: 1];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__userSettings count]];
        int idx208;
        for (idx208 = 0; idx208 < [__userSettings count]; idx208++)
        {
          [[__userSettings objectAtIndex: idx208] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"saveUserSettings_args("];
  [ms appendString: @"userSettings:"];
  [ms appendFormat: @"%@", __userSettings];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface SaveUserSettings_result : NSObject <TBase, NSCoding> {
  SaveSettingsResponse * __success;

  BOOL __success_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=success, setter=setSuccess:) SaveSettingsResponse * success;
#endif

- (id) init;
- (id) initWithSuccess: (SaveSettingsResponse *) success;
...
#if !__has_feature(objc_arc)
- (SaveSettingsResponse *) success;
- (void) setSuccess: (SaveSettingsResponse *) success;
#endif
- (BOOL) successIsSet;

@end

@implementation SaveUserSettings_result
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_STRUCT) {
          SaveSettingsResponse *fieldValue = [[SaveSettingsResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setSuccess: fieldValue];
          [fieldValue release_stub];
        } else { 
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"SaveUserSettings_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"SaveUserSettings_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface publishRating_args : NSObject <TBase, NSCoding> {
  NSString * __ratingID;
  BOOL __isUnpublish;
...
@interface PublishRating_result : NSObject <TBase, NSCoding> {
...
@interface deleteRating_args : NSObject <TBase, NSCoding> {
  NSString * __ratingID;
  BOOL __isSocial;

  BOOL __ratingID_isset;
  BOOL __isSocial_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=ratingID, setter=setRatingID:) NSString * ratingID;
@property (nonatomic, getter=isSocial, setter=setIsSocial:) BOOL isSocial;
#endif

- (id) init;
- (id) initWithRatingID: (NSString *) ratingID isSocial: (BOOL) isSocial;
...
#if !__has_feature(objc_arc)
- (BOOL) isSocial;
- (void) setIsSocial: (BOOL) isSocial;
#endif
- (BOOL) isSocialIsSet;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"isSocial"])
  {
    __isSocial = [decoder decodeBoolForKey: @"isSocial"];
    __isSocial_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__isSocial_isset)
  {
    [encoder encodeBool: __isSocial forKey: @"isSocial"];
  }
}
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__isSocial_isset) {
    [outProtocol writeFieldBeginWithName: @"isSocial" type: TType_BOOL fieldID: 2];
    [outProtocol writeBool: __isSocial];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @"ratingID:"];
  [ms appendFormat: @"\"%@\"", __ratingID];
  [ms appendString: @",isSocial:"];
  [ms appendFormat: @"%i", __isSocial];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@interface DeleteRating_result : NSObject <TBase, NSCoding> {
  RatingResponse * __success;
...
@interface deleteSocialReply_args : NSObject <TBase, NSCoding> {
  NSString * __postReplyId;

  BOOL __postReplyId_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=postReplyId, setter=setPostReplyId:) NSString * postReplyId;
#endif

- (id) init;
- (id) initWithPostReplyId: (NSString *) postReplyId;
...
#if !__has_feature(objc_arc)
- (NSString *) postReplyId;
- (void) setPostReplyId: (NSString *) postReplyId;
#endif
- (BOOL) postReplyIdIsSet;

@end

@implementation deleteSocialReply_args
...
{
  self = [super init];
  __postReplyId = [postReplyId retain_stub];
  __postReplyId_isset = YES;
  return self;
}
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"postReplyId"])
  {
    __postReplyId = [[decoder decodeObjectForKey: @"postReplyId"] retain_stub];
    __postReplyId_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__postReplyId_isset)
  {
    [encoder encodeObject: __postReplyId forKey: @"postReplyId"];
  }
}

- (void) dealloc
{
  [__postReplyId release_stub];
  [super dealloc_stub];
}

- (NSString *) postReplyId {
  return [[__postReplyId retain_stub] autorelease_stub];
}

- (void) setPostReplyId: (NSString *) postReplyId {
  [postReplyId retain_stub];
  [__postReplyId release_stub];
  __postReplyId = postReplyId;
  __postReplyId_isset = YES;
}

- (BOOL) postReplyIdIsSet {
  return __postReplyId_isset;
}

- (void) unsetPostReplyId {
  [__postReplyId release_stub];
  __postReplyId = nil;
  __postReplyId_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setPostReplyId: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"deleteSocialReply_args"];
  if (__postReplyId_isset) {
    if (__postReplyId != nil) {
      [outProtocol writeFieldBeginWithName: @"postReplyId" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __postReplyId];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"deleteSocialReply_args("];
  [ms appendString: @"postReplyId:"];
  [ms appendFormat: @"\"%@\"", __postReplyId];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@interface DeleteSocialReply_result : NSObject <TBase, NSCoding> {
  RatingResponse * __success;
...
@implementation DeleteSocialReply_result
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"DeleteSocialReply_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"DeleteSocialReply_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface flagSocialPost_args : NSObject <TBase, NSCoding> {
  NSString * __postId;
...
#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=postId, setter=setPostId:) NSString * postId;
#endif
...
@implementation flagSocialPost_args
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __postId = [[decoder decodeObjectForKey: @"postId"] retain_stub];
    __postId_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__postId_isset)
  {
    [encoder encodeObject: __postId forKey: @"postId"];
  }
}

- (void) dealloc
{
  [__postId release_stub];
  [super dealloc_stub];
}

- (NSString *) postId {
  return [[__postId retain_stub] autorelease_stub];
}
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"flagSocialPost_args"];
  if (__postId_isset) {
    if (__postId != nil) {
      [outProtocol writeFieldBeginWithName: @"postId" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __postId];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"flagSocialPost_args("];
  [ms appendString: @"postId:"];
  [ms appendFormat: @"\"%@\"", __postId];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@interface FlagSocialPost_result : NSObject <TBase, NSCoding> {
  RatingResponse * __success;
...
@implementation FlagSocialPost_result
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"FlagSocialPost_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"FlagSocialPost_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface createSocialPost_args : NSObject <TBase, NSCoding> {
  SocialPostRequest * __createPostRequest;

  BOOL __createPostRequest_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=createPostRequest, setter=setCreatePostRequest:) SocialPostRequest * createPostRequest;
#endif

- (id) init;
- (id) initWithCreatePostRequest: (SocialPostRequest *) createPostRequest;
...
#if !__has_feature(objc_arc)
- (SocialPostRequest *) createPostRequest;
- (void) setCreatePostRequest: (SocialPostRequest *) createPostRequest;
#endif
- (BOOL) createPostRequestIsSet;

@end

@implementation createSocialPost_args
...
{
  self = [super init];
  __createPostRequest = [createPostRequest retain_stub];
  __createPostRequest_isset = YES;
  return self;
}
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"createPostRequest"])
  {
    __createPostRequest = [[decoder decodeObjectForKey: @"createPostRequest"] retain_stub];
    __createPostRequest_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__createPostRequest_isset)
  {
    [encoder encodeObject: __createPostRequest forKey: @"createPostRequest"];
  }
}

- (void) dealloc
{
  [__createPostRequest release_stub];
  [super dealloc_stub];
}

- (SocialPostRequest *) createPostRequest {
  return [[__createPostRequest retain_stub] autorelease_stub];
}

- (void) setCreatePostRequest: (SocialPostRequest *) createPostRequest {
  [createPostRequest retain_stub];
  [__createPostRequest release_stub];
  __createPostRequest = createPostRequest;
  __createPostRequest_isset = YES;
}

- (BOOL) createPostRequestIsSet {
  return __createPostRequest_isset;
}

- (void) unsetCreatePostRequest {
  [__createPostRequest release_stub];
  __createPostRequest = nil;
  __createPostRequest_isset = NO;
}
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_STRUCT) {
          SocialPostRequest *fieldValue = [[SocialPostRequest alloc] init];
          [fieldValue read: inProtocol];
          [self setCreatePostRequest: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"createSocialPost_args"];
  if (__createPostRequest_isset) {
    if (__createPostRequest != nil) {
      [outProtocol writeFieldBeginWithName: @"createPostRequest" type: TType_STRUCT fieldID: 1];
      [__createPostRequest write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"createSocialPost_args("];
  [ms appendString: @"createPostRequest:"];
  [ms appendFormat: @"%@", __createPostRequest];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@interface CreateSocialPost_result : NSObject <TBase, NSCoding> {
  Response * __success;
...
@implementation CreateSocialPost_result
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"CreateSocialPost_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"CreateSocialPost_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface replyToRating_args : NSObject <TBase, NSCoding> {
  NSString * __ratingID;
...
- (id) init;
- (id) initWithRatingID: (NSString *) ratingID recepientEmail: (NSString *) recepientEmail message: (NSString *) message isForward: (BOOL) isForward isSocial: (BOOL) isSocial;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__isSocial_isset) {
    [outProtocol writeFieldBeginWithName: @"isSocial" type: TType_BOOL fieldID: 5];
    [outProtocol writeBool: __isSocial];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
...
@interface ReplyToRating_result : NSObject <TBase, NSCoding> {
  RatingResponse * __success;
...
@interface updateTODOPost_args : NSObject <TBase, NSCoding> {
  UpdateTODOPostRequest * __request;

  BOOL __request_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=request, setter=setRequest:) UpdateTODOPostRequest * request;
#endif

- (id) init;
- (id) initWithRequest: (UpdateTODOPostRequest *) request;
...
#if !__has_feature(objc_arc)
- (UpdateTODOPostRequest *) request;
- (void) setRequest: (UpdateTODOPostRequest *) request;
#endif
- (BOOL) requestIsSet;

@end

@implementation updateTODOPost_args
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_STRUCT) {
          UpdateTODOPostRequest *fieldValue = [[UpdateTODOPostRequest alloc] init];
          [fieldValue read: inProtocol];
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"updateTODOPost_args"];
  if (__request_isset) {
    if (__request != nil) {
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"updateTODOPost_args("];
...
@interface UpdateTODOPost_result : NSObject <TBase, NSCoding> {
  TODOFeedResponse * __success;
...
@implementation UpdateTODOPost_result
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"UpdateTODOPost_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"UpdateTODOPost_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface getScheduledPost_args : NSObject <TBase, NSCoding> {
  NSString * __scheduledPostId;

  BOOL __scheduledPostId_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=scheduledPostId, setter=setScheduledPostId:) NSString * scheduledPostId;
#endif

- (id) init;
- (id) initWithScheduledPostId: (NSString *) scheduledPostId;
...
#if !__has_feature(objc_arc)
- (NSString *) scheduledPostId;
- (void) setScheduledPostId: (NSString *) scheduledPostId;
#endif
- (BOOL) scheduledPostIdIsSet;

@end

@implementation getScheduledPost_args
...
{
  self = [super init];
  __scheduledPostId = [scheduledPostId retain_stub];
  __scheduledPostId_isset = YES;
  return self;
}
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"scheduledPostId"])
  {
    __scheduledPostId = [[decoder decodeObjectForKey: @"scheduledPostId"] retain_stub];
    __scheduledPostId_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__scheduledPostId_isset)
  {
    [encoder encodeObject: __scheduledPostId forKey: @"scheduledPostId"];
  }
}

- (void) dealloc
{
  [__scheduledPostId release_stub];
  [super dealloc_stub];
}

- (NSString *) scheduledPostId {
  return [[__scheduledPostId retain_stub] autorelease_stub];
}

- (void) setScheduledPostId: (NSString *) scheduledPostId {
  [scheduledPostId retain_stub];
  [__scheduledPostId release_stub];
  __scheduledPostId = scheduledPostId;
  __scheduledPostId_isset = YES;
}

- (BOOL) scheduledPostIdIsSet {
  return __scheduledPostId_isset;
}

- (void) unsetScheduledPostId {
  [__scheduledPostId release_stub];
  __scheduledPostId = nil;
  __scheduledPostId_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setScheduledPostId: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"getScheduledPost_args"];
  if (__scheduledPostId_isset) {
    if (__scheduledPostId != nil) {
      [outProtocol writeFieldBeginWithName: @"scheduledPostId" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __scheduledPostId];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"getScheduledPost_args("];
  [ms appendString: @"scheduledPostId:"];
  [ms appendFormat: @"\"%@\"", __scheduledPostId];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@interface GetScheduledPost_result : NSObject <TBase, NSCoding> {
  GetScheduledPostResponse * __success;

  BOOL __success_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=success, setter=setSuccess:) GetScheduledPostResponse * success;
#endif

- (id) init;
- (id) initWithSuccess: (GetScheduledPostResponse *) success;
...
#if !__has_feature(objc_arc)
- (GetScheduledPostResponse *) success;
- (void) setSuccess: (GetScheduledPostResponse *) success;
#endif
- (BOOL) successIsSet;

@end

@implementation GetScheduledPost_result
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_STRUCT) {
          GetScheduledPostResponse *fieldValue = [[GetScheduledPostResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setSuccess: fieldValue];
          [fieldValue release_stub];
        } else { 
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetScheduledPost_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetScheduledPost_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface getPostLocations_args : NSObject <TBase, NSCoding> {
...
- (id) init;
- (id) initWithSchedulePostId: (NSString *) schedulePostId;
...
@implementation getPostLocations_args
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"getPostLocations_args"];
  if (__schedulePostId_isset) {
    if (__schedulePostId != nil) {
      [outProtocol writeFieldBeginWithName: @"schedulePostId" type: TType_STRING fieldID: 1];
      [outProtocol writeString: __schedulePostId];
      [outProtocol writeFieldEnd];
    }
  }
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"getPostLocations_args("];
  [ms appendString: @"schedulePostId:"];
  [ms appendFormat: @"\"%@\"", __schedulePostId];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface GetPostLocations_result : NSObject <TBase, NSCoding> {
  PostLocationResponse * __success;

  BOOL __success_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=success, setter=setSuccess:) PostLocationResponse * success;
#endif

- (id) init;
- (id) initWithSuccess: (PostLocationResponse *) success;
...
#if !__has_feature(objc_arc)
- (PostLocationResponse *) success;
- (void) setSuccess: (PostLocationResponse *) success;
#endif
- (BOOL) successIsSet;

@end

@implementation GetPostLocations_result
...
- (void) read: (id <TProtocol>) inProtocol
{
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_STRUCT) {
          PostLocationResponse *fieldValue = [[PostLocationResponse alloc] init];
          [fieldValue read: inProtocol];
          [self setSuccess: fieldValue];
          [fieldValue release_stub];
        } else { 
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetPostLocations_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetPostLocations_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface getSummaryIds_args : NSObject <TBase, NSCoding> {
  NSMutableArray * __summaryCells;

  BOOL __summaryCells_isset;
}

#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, retain, getter=summaryCells, setter=setSummaryCells:) NSMutableArray * summaryCells;
#endif

- (id) init;
- (id) initWithSummaryCells: (NSMutableArray *) summaryCells;
...
#if !__has_feature(objc_arc)
- (NSMutableArray *) summaryCells;
- (void) setSummaryCells: (NSMutableArray *) summaryCells;
#endif
- (BOOL) summaryCellsIsSet;

@end

@implementation getSummaryIds_args
...
{
  self = [super init];
  __summaryCells = [summaryCells retain_stub];
  __summaryCells_isset = YES;
  return self;
}
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"summaryCells"])
  {
    __summaryCells = [[decoder decodeObjectForKey: @"summaryCells"] retain_stub];
    __summaryCells_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__summaryCells_isset)
  {
    [encoder encodeObject: __summaryCells forKey: @"summaryCells"];
  }
}

- (void) dealloc
{
  [__summaryCells release_stub];
  [super dealloc_stub];
}

- (NSMutableArray *) summaryCells {
  return [[__summaryCells retain_stub] autorelease_stub];
}

- (void) setSummaryCells: (NSMutableArray *) summaryCells {
  [summaryCells retain_stub];
  [__summaryCells release_stub];
  __summaryCells = summaryCells;
  __summaryCells_isset = YES;
}

- (BOOL) summaryCellsIsSet {
  return __summaryCells_isset;
}

- (void) unsetSummaryCells {
  [__summaryCells release_stub];
  __summaryCells = nil;
  __summaryCells_isset = NO;
}
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"getSummaryIds_args"];
  if (__summaryCells_isset) {
    if (__summaryCells != nil) {
      [outProtocol writeFieldBeginWithName: @"summaryCells" type: TType_LIST fieldID: 1];
      {
        ...
        int idx213;
        for (idx213 = 0; idx213 < [__summaryCells count]; idx213++)
        {
          [outProtocol writeString: [__summaryCells objectAtIndex: idx213]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"getSummaryIds_args("];
  [ms appendString: @"summaryCells:"];
  [ms appendFormat: @"%@", __summaryCells];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
@interface GetSummaryIds_result : NSObject <TBase, NSCoding> {
...
@implementation GetSummaryIds_result
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"GetSummaryIds_result"];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"GetSummaryIds_result("];
  [ms appendString: @"success:"];
  [ms appendFormat: @"%@", __success];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
...
@interface getSummary_args : NSObject <TBase, NSCoding> {
}
...
@interface GetSummary_result : NSObject <TBase, NSCoding> {
  SummaryResponse * __success;
...
- (void) send_getTODOFeed: (int32_t) start pageCount: (int32_t) pageCount searchCriteria: (SearchFilter *) searchCriteria
{
  [outProtocol writeMessageBeginWithName: @"getTODOFeed" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"getTODOFeed_args"];
  [outProtocol writeFieldBeginWithName: @"start" type: TType_I32 fieldID: 1];
  [outProtocol writeI32: start];
  [outProtocol writeFieldEnd];
...
- (TODOFeedResponse *) recv_getTODOFeed
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  GetTODOFeed_result * result = [[[GetTODOFeed_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"getTODOFeed failed: unknown result"];
}

- (TODOFeedResponse *) getTODOFeed: (int32_t) start pageCount: (int32_t) pageCount searchCriteria: (SearchFilter *) searchCriteria
{
  [self send_getTODOFeed : start pageCount: pageCount searchCriteria: searchCriteria];
  return [self recv_getTODOFeed];
}

- (void) send_getSocialReplies: (NSString *) parentId start: (int32_t) start
{
  [outProtocol writeMessageBeginWithName: @"getSocialReplies" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"getSocialReplies_args"];
  if (parentId != nil)  {
    [outProtocol writeFieldBeginWithName: @"parentId" type: TType_STRING fieldID: 1];
    [outProtocol writeString: parentId];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldBeginWithName: @"start" type: TType_I32 fieldID: 2];
  [outProtocol writeI32: start];
...
- (SocialPostRepliesResponse *) recv_getSocialReplies
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  GetSocialReplies_result * result = [[[GetSocialReplies_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"getSocialReplies failed: unknown result"];
}

- (SocialPostRepliesResponse *) getSocialReplies: (NSString *) parentId start: (int32_t) start
{
  [self send_getSocialReplies : parentId start: start];
  return [self recv_getSocialReplies];
}

- (void) send_getRating: (NSString *) ratingId
{
...
- (GetRatingResponse *) recv_getRating
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  GetRating_result * result = [[[GetRating_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
...
- (GetRatingResponse *) getRating: (NSString *) ratingId
{
  [self send_getRating : ratingId];
  return [self recv_getRating];
}

- (void) send_getSocialPost: (NSString *) socialPostId
{
  [outProtocol writeMessageBeginWithName: @"getSocialPost" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"getSocialPost_args"];
  if (socialPostId != nil)  {
    [outProtocol writeFieldBeginWithName: @"socialPostId" type: TType_STRING fieldID: 1];
    [outProtocol writeString: socialPostId];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (SocialPostResponse *) recv_getSocialPost
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  GetSocialPost_result * result = [[[GetSocialPost_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"getSocialPost failed: unknown result"];
}

- (SocialPostResponse *) getSocialPost: (NSString *) socialPostId
{
  [self send_getSocialPost : socialPostId];
  return [self recv_getSocialPost];
}
...
- (void) send_saveUserSettings: (NSMutableArray *) userSettings
{
  [outProtocol writeMessageBeginWithName: @"saveUserSettings" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"saveUserSettings_args"];
  if (userSettings != nil)  {
    [outProtocol writeFieldBeginWithName: @"userSettings" type: TType_LIST fieldID: 1];
    {
      ...
      int idx215;
      for (idx215 = 0; idx215 < [userSettings count]; idx215++)
      {
        [[userSettings objectAtIndex: idx215] write: outProtocol];
      }
      [outProtocol writeListEnd];
    }
    [outProtocol writeFieldEnd];
...
- (SaveSettingsResponse *) recv_saveUserSettings
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  SaveUserSettings_result * result = [[[SaveUserSettings_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"saveUserSettings failed: unknown result"];
}

- (SaveSettingsResponse *) saveUserSettings: (NSMutableArray *) userSettings
{
  [self send_saveUserSettings : userSettings];
  return [self recv_saveUserSettings];
}
...
- (void) send_deleteRating: (NSString *) ratingID isSocial: (BOOL) isSocial
{
  ...
  [outProtocol writeFieldBeginWithName: @"isSocial" type: TType_BOOL fieldID: 2];
  [outProtocol writeBool: isSocial];
  [outProtocol writeFieldEnd];
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
  [outProtocol writeMessageEnd];
...
- (RatingResponse *) deleteRating: (NSString *) ratingID isSocial: (BOOL) isSocial
{
  [self send_deleteRating : ratingID isSocial: isSocial];
  return [self recv_deleteRating];
}

- (void) send_deleteSocialReply: (NSString *) postReplyId
{
  [outProtocol writeMessageBeginWithName: @"deleteSocialReply" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"deleteSocialReply_args"];
  if (postReplyId != nil)  {
    [outProtocol writeFieldBeginWithName: @"postReplyId" type: TType_STRING fieldID: 1];
    [outProtocol writeString: postReplyId];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (RatingResponse *) recv_deleteSocialReply
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  DeleteSocialReply_result * result = [[[DeleteSocialReply_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"deleteSocialReply failed: unknown result"];
}

- (RatingResponse *) deleteSocialReply: (NSString *) postReplyId
{
  [self send_deleteSocialReply : postReplyId];
  return [self recv_deleteSocialReply];
}

- (void) send_flagSocialPost: (NSString *) postId
{
  [outProtocol writeMessageBeginWithName: @"flagSocialPost" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"flagSocialPost_args"];
  if (postId != nil)  {
    [outProtocol writeFieldBeginWithName: @"postId" type: TType_STRING fieldID: 1];
    [outProtocol writeString: postId];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (RatingResponse *) recv_flagSocialPost
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  FlagSocialPost_result * result = [[[FlagSocialPost_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"flagSocialPost failed: unknown result"];
}

- (RatingResponse *) flagSocialPost: (NSString *) postId
{
  [self send_flagSocialPost : postId];
  return [self recv_flagSocialPost];
}

- (void) send_createSocialPost: (SocialPostRequest *) createPostRequest
{
  [outProtocol writeMessageBeginWithName: @"createSocialPost" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"createSocialPost_args"];
  if (createPostRequest != nil)  {
    [outProtocol writeFieldBeginWithName: @"createPostRequest" type: TType_STRUCT fieldID: 1];
    [createPostRequest write: outProtocol];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (Response *) recv_createSocialPost
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  CreateSocialPost_result * result = [[[CreateSocialPost_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"createSocialPost failed: unknown result"];
}

- (Response *) createSocialPost: (SocialPostRequest *) createPostRequest
{
  [self send_createSocialPost : createPostRequest];
  return [self recv_createSocialPost];
}

- (void) send_replyToRating: (NSString *) ratingID recepientEmail: (NSString *) recepientEmail message: (NSString *) message isForward: (BOOL) isForward isSocial: (BOOL) isSocial
{
...
- (RatingResponse *) replyToRating: (NSString *) ratingID recepientEmail: (NSString *) recepientEmail message: (NSString *) message isForward: (BOOL) isForward isSocial: (BOOL) isSocial
{
  [self send_replyToRating : ratingID recepientEmail: recepientEmail message: message isForward: isForward isSocial: isSocial];
  return [self recv_replyToRating];
}

- (void) send_updateTODOPost: (UpdateTODOPostRequest *) request
{
  [outProtocol writeMessageBeginWithName: @"updateTODOPost" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"updateTODOPost_args"];
  if (request != nil)  {
    [outProtocol writeFieldBeginWithName: @"request" type: TType_STRUCT fieldID: 1];
...
- (TODOFeedResponse *) recv_updateTODOPost
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  UpdateTODOPost_result * result = [[[UpdateTODOPost_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"updateTODOPost failed: unknown result"];
}

- (TODOFeedResponse *) updateTODOPost: (UpdateTODOPostRequest *) request
{
  [self send_updateTODOPost : request];
  return [self recv_updateTODOPost];
}

- (void) send_getScheduledPost: (NSString *) scheduledPostId
{
  [outProtocol writeMessageBeginWithName: @"getScheduledPost" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"getScheduledPost_args"];
  if (scheduledPostId != nil)  {
    [outProtocol writeFieldBeginWithName: @"scheduledPostId" type: TType_STRING fieldID: 1];
    [outProtocol writeString: scheduledPostId];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (GetScheduledPostResponse *) recv_getScheduledPost
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  GetScheduledPost_result * result = [[[GetScheduledPost_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"getScheduledPost failed: unknown result"];
}

- (GetScheduledPostResponse *) getScheduledPost: (NSString *) scheduledPostId
{
  [self send_getScheduledPost : scheduledPostId];
  return [self recv_getScheduledPost];
}

- (void) send_getPostLocations: (NSString *) schedulePostId
{
  [outProtocol writeMessageBeginWithName: @"getPostLocations" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"getPostLocations_args"];
  if (schedulePostId != nil)  {
    [outProtocol writeFieldBeginWithName: @"schedulePostId" type: TType_STRING fieldID: 1];
    [outProtocol writeString: schedulePostId];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (PostLocationResponse *) recv_getPostLocations
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  GetPostLocations_result * result = [[[GetPostLocations_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"getPostLocations failed: unknown result"];
}

- (PostLocationResponse *) getPostLocations: (NSString *) schedulePostId
{
  [self send_getPostLocations : schedulePostId];
  return [self recv_getPostLocations];
}

- (void) send_getSummaryIds: (NSMutableArray *) summaryCells
{
  [outProtocol writeMessageBeginWithName: @"getSummaryIds" type: TMessageType_CALL sequenceID: 0];
  [outProtocol writeStructBeginWithName: @"getSummaryIds_args"];
  if (summaryCells != nil)  {
    [outProtocol writeFieldBeginWithName: @"summaryCells" type: TType_LIST fieldID: 1];
    {
      ...
      int idx217;
      for (idx217 = 0; idx217 < [summaryCells count]; idx217++)
      {
        [outProtocol writeString: [summaryCells objectAtIndex: idx217]];
      }
      [outProtocol writeListEnd];
    }
    [outProtocol writeFieldEnd];
...
- (SummaryResponse *) recv_getSummaryIds
{
  int msgType = 0;
  [inProtocol readMessageBeginReturningName: nil type: &msgType sequenceID: NULL];
  if (msgType == TMessageType_EXCEPTION) {
  ...
  GetSummaryIds_result * result = [[[GetSummaryIds_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  if ([result successIsSet]) {
    return [result success];
  ...
  @throw [TApplicationException exceptionWithType: TApplicationException_MISSING_RESULT
                                           reason: @"getSummaryIds failed: unknown result"];
}

- (SummaryResponse *) getSummaryIds: (NSMutableArray *) summaryCells
{
  [self send_getSummaryIds : summaryCells];
  return [self recv_getSummaryIds];
}
...
- (id) initWithMobile: (id <Mobile>) service
{
  ...
  {
    SEL s = @selector(process_getTODOFeed_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"getTODOFeed"];
  }
  {
    SEL s = @selector(process_getSocialReplies_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"getSocialReplies"];
  }
  {
  ...
  {
    SEL s = @selector(process_getSocialPost_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"getSocialPost"];
  }
  {
  ...
  {
    SEL s = @selector(process_saveUserSettings_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"saveUserSettings"];
  }
  {
  ...
  {
    SEL s = @selector(process_deleteSocialReply_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"deleteSocialReply"];
  }
  {
    SEL s = @selector(process_flagSocialPost_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"flagSocialPost"];
  }
  {
    SEL s = @selector(process_createSocialPost_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"createSocialPost"];
  }
  {
  ...
  {
    SEL s = @selector(process_updateTODOPost_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"updateTODOPost"];
  }
  {
    SEL s = @selector(process_getScheduledPost_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"getScheduledPost"];
  }
  {
    SEL s = @selector(process_getPostLocations_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"getPostLocations"];
  }
  {
    SEL s = @selector(process_getSummaryIds_withSequenceID:inProtocol:outProtocol:);
    NSMethodSignature * sig = [self methodSignatureForSelector: s];
    NSInvocation * invocation = [NSInvocation invocationWithMethodSignature: sig];
    [invocation setSelector: s];
    [invocation retainArguments];
    [mMethodMap setValue: invocation forKey: @"getSummaryIds"];
  }
  {
...
- (void) process_getTODOFeed_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  getTODOFeed_args * args = [[getTODOFeed_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  GetTODOFeed_result * result = [[GetTODOFeed_result alloc] init];
  [result setSuccess: [mService getTODOFeed: [args start] pageCount: [args pageCount] searchCriteria: [args searchCriteria]]];
  [outProtocol writeMessageBeginWithName: @"getTODOFeed"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_getSocialReplies_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  getSocialReplies_args * args = [[getSocialReplies_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  GetSocialReplies_result * result = [[GetSocialReplies_result alloc] init];
  [result setSuccess: [mService getSocialReplies: [args parentId] start: [args start]]];
  [outProtocol writeMessageBeginWithName: @"getSocialReplies"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_getRating_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  ...
  [result setSuccess: [mService getRating: [args ratingId]]];
...
- (void) process_getSocialPost_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  getSocialPost_args * args = [[getSocialPost_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  GetSocialPost_result * result = [[GetSocialPost_result alloc] init];
  [result setSuccess: [mService getSocialPost: [args socialPostId]]];
  [outProtocol writeMessageBeginWithName: @"getSocialPost"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_saveUserSettings_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  saveUserSettings_args * args = [[saveUserSettings_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  SaveUserSettings_result * result = [[SaveUserSettings_result alloc] init];
  [result setSuccess: [mService saveUserSettings: [args userSettings]]];
  [outProtocol writeMessageBeginWithName: @"saveUserSettings"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_deleteRating_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  ...
  [result setSuccess: [mService deleteRating: [args ratingID] isSocial: [args isSocial]]];
...
- (void) process_deleteSocialReply_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  deleteSocialReply_args * args = [[deleteSocialReply_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  DeleteSocialReply_result * result = [[DeleteSocialReply_result alloc] init];
  [result setSuccess: [mService deleteSocialReply: [args postReplyId]]];
  [outProtocol writeMessageBeginWithName: @"deleteSocialReply"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_flagSocialPost_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  flagSocialPost_args * args = [[flagSocialPost_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  FlagSocialPost_result * result = [[FlagSocialPost_result alloc] init];
  [result setSuccess: [mService flagSocialPost: [args postId]]];
  [outProtocol writeMessageBeginWithName: @"flagSocialPost"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_createSocialPost_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  createSocialPost_args * args = [[createSocialPost_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  CreateSocialPost_result * result = [[CreateSocialPost_result alloc] init];
  [result setSuccess: [mService createSocialPost: [args createPostRequest]]];
  [outProtocol writeMessageBeginWithName: @"createSocialPost"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_replyToRating_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  ...
  [result setSuccess: [mService replyToRating: [args ratingID] recepientEmail: [args recepientEmail] message: [args message] isForward: [args isForward] isSocial: [args isSocial]]];
...
- (void) process_updateTODOPost_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  updateTODOPost_args * args = [[updateTODOPost_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  UpdateTODOPost_result * result = [[UpdateTODOPost_result alloc] init];
  [result setSuccess: [mService updateTODOPost: [args request]]];
  [outProtocol writeMessageBeginWithName: @"updateTODOPost"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_getScheduledPost_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  getScheduledPost_args * args = [[getScheduledPost_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  GetScheduledPost_result * result = [[GetScheduledPost_result alloc] init];
  [result setSuccess: [mService getScheduledPost: [args scheduledPostId]]];
  [outProtocol writeMessageBeginWithName: @"getScheduledPost"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_getPostLocations_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  getPostLocations_args * args = [[getPostLocations_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  GetPostLocations_result * result = [[GetPostLocations_result alloc] init];
  [result setSuccess: [mService getPostLocations: [args schedulePostId]]];
  [outProtocol writeMessageBeginWithName: @"getPostLocations"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
...
- (void) process_getSummaryIds_withSequenceID: (int32_t) seqID inProtocol: (id<TProtocol>) inProtocol outProtocol: (id<TProtocol>) outProtocol
{
  getSummaryIds_args * args = [[getSummaryIds_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  GetSummaryIds_result * result = [[GetSummaryIds_result alloc] init];
  [result setSuccess: [mService getSummaryIds: [args summaryCells]]];
  [outProtocol writeMessageBeginWithName: @"getSummaryIds"
                                    type: TMessageType_REPLY
                              sequenceID: seqID];
  [result write: outProtocol];
  [outProtocol writeMessageEnd];
