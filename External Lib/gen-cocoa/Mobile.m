  ...
  if (__tags_isset) {
    if (__tags != nil) {
      [outProtocol writeFieldBeginWithName: @"tags" type: TType_LIST fieldID: 16];
      {
        ...
        int i29;
        for (i29 = 0; i29 < [__tags count]; i29++)
        {
          [[__tags objectAtIndex: i29] write: outProtocol];
        }
  ...
  if (__properties_isset) {
    if (__properties != nil) {
      [outProtocol writeFieldBeginWithName: @"properties" type: TType_LIST fieldID: 29];
      {
        ...
        int i33;
        for (i33 = 0; i33 < [__properties count]; i33++)
        {
          [[__properties objectAtIndex: i33] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__rresponses_isset) {
    if (__rresponses != nil) {
      [outProtocol writeFieldBeginWithName: @"rresponses" type: TType_LIST fieldID: 37];
      {
        ...
        int i35;
        for (i35 = 0; i35 < [__rresponses count]; i35++)
        {
          [[__rresponses objectAtIndex: i35] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 41];
      {
        ...
        int i37;
        for (i37 = 0; i37 < [__allowedActions count]; i37++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: i37]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__subRatings_isset) {
    if (__subRatings != nil) {
      [outProtocol writeFieldBeginWithName: @"subRatings" type: TType_LIST fieldID: 44];
      {
        ...
        int i39;
        for (i39 = 0; i39 < [__subRatings count]; i39++)
        {
          [[__subRatings objectAtIndex: i39] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__notes_isset) {
    if (__notes != nil) {
      [outProtocol writeFieldBeginWithName: @"notes" type: TType_LIST fieldID: 46];
      {
        ...
        int i41;
        for (i41 = 0; i41 < [__notes count]; i41++)
        {
          [outProtocol writeString: [__notes objectAtIndex: i41]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__values_isset) {
    if (__values != nil) {
      [outProtocol writeFieldBeginWithName: @"values" type: TType_LIST fieldID: 2];
      {
        ...
        int i46;
        for (i46 = 0; i46 < [__values count]; i46++)
        {
          [[__values objectAtIndex: i46] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__authLocations_isset) {
    if (__authLocations != nil) {
      [outProtocol writeFieldBeginWithName: @"authLocations" type: TType_LIST fieldID: 1];
      {
        ...
        int i54;
        for (i54 = 0; i54 < [__authLocations count]; i54++)
        {
          [[__authLocations objectAtIndex: i54] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allSources_isset) {
    if (__allSources != nil) {
      [outProtocol writeFieldBeginWithName: @"allSources" type: TType_LIST fieldID: 2];
      {
        ...
        int i56;
        for (i56 = 0; i56 < [__allSources count]; i56++)
        {
          [[__allSources objectAtIndex: i56] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 14];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__allowedActions count]];
        int i67;
        for (i67 = 0; i67 < [__allowedActions count]; i67++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: i67]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__links_isset) {
    if (__links != nil) {
      [outProtocol writeFieldBeginWithName: @"links" type: TType_LIST fieldID: 7];
      {
        ...
        int i97;
        for (i97 = 0; i97 < [__links count]; i97++)
        {
          [[__links objectAtIndex: i97] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__medias_isset) {
    if (__medias != nil) {
      [outProtocol writeFieldBeginWithName: @"medias" type: TType_LIST fieldID: 8];
      {
        ...
        int i99;
        for (i99 = 0; i99 < [__medias count]; i99++)
        {
          [[__medias objectAtIndex: i99] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__tags_isset) {
    if (__tags != nil) {
      [outProtocol writeFieldBeginWithName: @"tags" type: TType_LIST fieldID: 9];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__tags count]];
        int i101;
        for (i101 = 0; i101 < [__tags count]; i101++)
        {
          [[__tags objectAtIndex: i101] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__hashtags_isset) {
    if (__hashtags != nil) {
      [outProtocol writeFieldBeginWithName: @"hashtags" type: TType_LIST fieldID: 10];
      {
        ...
        int i103;
        for (i103 = 0; i103 < [__hashtags count]; i103++)
        {
          [[__hashtags objectAtIndex: i103] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__replies_isset) {
    if (__replies != nil) {
      [outProtocol writeFieldBeginWithName: @"replies" type: TType_LIST fieldID: 24];
      {
        ...
        int i107;
        for (i107 = 0; i107 < [__replies count]; i107++)
        {
          [[__replies objectAtIndex: i107] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 25];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__allowedActions count]];
        int i109;
        for (i109 = 0; i109 < [__allowedActions count]; i109++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: i109]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__allowedActions_isset) {
    if (__allowedActions != nil) {
      [outProtocol writeFieldBeginWithName: @"allowedActions" type: TType_LIST fieldID: 12];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__allowedActions count]];
        int i132;
        for (i132 = 0; i132 < [__allowedActions count]; i132++)
        {
          [outProtocol writeString: [__allowedActions objectAtIndex: i132]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__socialSources_isset) {
    if (__socialSources != nil) {
      [outProtocol writeFieldBeginWithName: @"socialSources" type: TType_LIST fieldID: 1];
      {
        ...
        int i143;
        for (i143 = 0; i143 < [__socialSources count]; i143++)
        {
          [outProtocol writeString: [__socialSources objectAtIndex: i143]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__images_isset) {
    if (__images != nil) {
      [outProtocol writeFieldBeginWithName: @"images" type: TType_LIST fieldID: 3];
      {
        ...
        int i145;
        for (i145 = 0; i145 < [__images count]; i145++)
        {
          [[__images objectAtIndex: i145] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__locations_isset) {
    if (__locations != nil) {
      [outProtocol writeFieldBeginWithName: @"locations" type: TType_LIST fieldID: 4];
      {
        ...
        int i147;
        for (i147 = 0; i147 < [__locations count]; i147++)
        {
          [outProtocol writeString: [__locations objectAtIndex: i147]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__items_isset) {
    if (__items != nil) {
      [outProtocol writeFieldBeginWithName: @"items" type: TType_LIST fieldID: 3];
      {
        ...
        int i152;
        for (i152 = 0; i152 < [__items count]; i152++)
        {
          [[__items objectAtIndex: i152] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__userSettings_isset) {
    if (__userSettings != nil) {
      [outProtocol writeFieldBeginWithName: @"userSettings" type: TType_LIST fieldID: 2];
      {
        ...
        int i157;
        for (i157 = 0; i157 < [__userSettings count]; i157++)
        {
          [[__userSettings objectAtIndex: i157] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__aggregates_isset) {
    if (__aggregates != nil) {
      [outProtocol writeFieldBeginWithName: @"aggregates" type: TType_LIST fieldID: 2];
      {
        ...
        int i162;
        for (i162 = 0; i162 < [__aggregates count]; i162++)
        {
          [[__aggregates objectAtIndex: i162] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__socialPosts_isset) {
    if (__socialPosts != nil) {
      [outProtocol writeFieldBeginWithName: @"socialPosts" type: TType_LIST fieldID: 2];
      {
        ...
        int i167;
        for (i167 = 0; i167 < [__socialPosts count]; i167++)
        {
          [[__socialPosts objectAtIndex: i167] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__postReplies_isset) {
    if (__postReplies != nil) {
      [outProtocol writeFieldBeginWithName: @"postReplies" type: TType_LIST fieldID: 2];
      {
        ...
        int i172;
        for (i172 = 0; i172 < [__postReplies count]; i172++)
        {
          [[__postReplies objectAtIndex: i172] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__todoItems_isset) {
    if (__todoItems != nil) {
      [outProtocol writeFieldBeginWithName: @"todoItems" type: TType_LIST fieldID: 2];
      {
        ...
        int i177;
        for (i177 = 0; i177 < [__todoItems count]; i177++)
        {
          [[__todoItems objectAtIndex: i177] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__locations_isset) {
    if (__locations != nil) {
      [outProtocol writeFieldBeginWithName: @"locations" type: TType_LIST fieldID: 3];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__locations count]];
        int i182;
        for (i182 = 0; i182 < [__locations count]; i182++)
        {
          [outProtocol writeString: [__locations objectAtIndex: i182]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
