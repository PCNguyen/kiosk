  ...
  if (__timeRanges_isset) {
    if (__timeRanges != nil) {
      [outProtocol writeFieldBeginWithName: @"timeRanges" type: TType_LIST fieldID: 2];
      {
        ...
        int idx4;
        for (idx4 = 0; idx4 < [__timeRanges count]; idx4++)
        {
          [[__timeRanges objectAtIndex: idx4] write: outProtocol];
        }
  ...
  if (__dailyHours_isset) {
    if (__dailyHours != nil) {
      [outProtocol writeFieldBeginWithName: @"dailyHours" type: TType_LIST fieldID: 1];
      {
        ...
        int idx9;
        for (idx9 = 0; idx9 < [__dailyHours count]; idx9++)
        {
          [[__dailyHours objectAtIndex: idx9] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__photos_isset) {
    if (__photos != nil) {
      [outProtocol writeFieldBeginWithName: @"photos" type: TType_LIST fieldID: 2];
      {
        ...
        int idx14;
        for (idx14 = 0; idx14 < [__photos count]; idx14++)
        {
          [outProtocol writeString: [__photos objectAtIndex: idx14]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__categories_isset) {
    if (__categories != nil) {
      [outProtocol writeFieldBeginWithName: @"categories" type: TType_LIST fieldID: 2];
      {
        ...
        int idx19;
        for (idx19 = 0; idx19 < [__categories count]; idx19++)
        {
          [outProtocol writeString: [__categories objectAtIndex: idx19]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__businessHours_isset) {
    if (__businessHours != nil) {
      [outProtocol writeFieldBeginWithName: @"businessHours" type: TType_LIST fieldID: 2];
      {
        ...
        int idx24;
        for (idx24 = 0; idx24 < [__businessHours count]; idx24++)
        {
          [[__businessHours objectAtIndex: idx24] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sourceListings_isset) {
    if (__sourceListings != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceListings" type: TType_LIST fieldID: 4];
      {
        ...
        int idx29;
        for (idx29 = 0; idx29 < [__sourceListings count]; idx29++)
        {
          [[__sourceListings objectAtIndex: idx29] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
