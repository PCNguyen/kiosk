  ...
  if (__validationErrors_isset) {
    if (__validationErrors != nil) {
      [outProtocol writeFieldBeginWithName: @"validationErrors" type: TType_LIST fieldID: 3];
      {
        ...
        int idx4;
        for (idx4 = 0; idx4 < [__validationErrors count]; idx4++)
        {
          [[__validationErrors objectAtIndex: idx4] write: outProtocol];
        }
  ...
  if (__labels_isset) {
    if (__labels != nil) {
      [outProtocol writeFieldBeginWithName: @"labels" type: TType_LIST fieldID: 4];
      {
        ...
        int idx9;
        for (idx9 = 0; idx9 < [__labels count]; idx9++)
        {
          [outProtocol writeString: [__labels objectAtIndex: idx9]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__searches_isset) {
    if (__searches != nil) {
      [outProtocol writeFieldBeginWithName: @"searches" type: TType_LIST fieldID: 3];
      {
        ...
        int idx14;
        for (idx14 = 0; idx14 < [__searches count]; idx14++)
        {
          [[__searches objectAtIndex: idx14] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__photos_isset) {
    if (__photos != nil) {
      [outProtocol writeFieldBeginWithName: @"photos" type: TType_LIST fieldID: 3];
      {
        ...
        int idx22;
        for (idx22 = 0; idx22 < [__photos count]; idx22++)
        {
          [[__photos objectAtIndex: idx22] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__links_isset) {
    if (__links != nil) {
      [outProtocol writeFieldBeginWithName: @"links" type: TType_LIST fieldID: 4];
      {
        ...
        int idx24;
        for (idx24 = 0; idx24 < [__links count]; idx24++)
        {
          [[__links objectAtIndex: idx24] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__questions_isset) {
    if (__questions != nil) {
      [outProtocol writeFieldBeginWithName: @"questions" type: TType_LIST fieldID: 1];
      {
        ...
        int idx29;
        for (idx29 = 0; idx29 < [__questions count]; idx29++)
        {
          [[__questions objectAtIndex: idx29] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__names_isset) {
    if (__names != nil) {
      [outProtocol writeFieldBeginWithName: @"names" type: TType_LIST fieldID: 1];
      {
        ...
        int idx43;
        for (idx43 = 0; idx43 < [__names count]; idx43++)
        {
          [outProtocol writeString: [__names objectAtIndex: idx43]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__addresses_isset) {
    if (__addresses != nil) {
      [outProtocol writeFieldBeginWithName: @"addresses" type: TType_LIST fieldID: 2];
      {
        ...
        int idx45;
        for (idx45 = 0; idx45 < [__addresses count]; idx45++)
        {
          [[__addresses objectAtIndex: idx45] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__phones_isset) {
    if (__phones != nil) {
      [outProtocol writeFieldBeginWithName: @"phones" type: TType_LIST fieldID: 3];
      {
        ...
        int idx47;
        for (idx47 = 0; idx47 < [__phones count]; idx47++)
        {
          [outProtocol writeString: [__phones objectAtIndex: idx47]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__webUrls_isset) {
    if (__webUrls != nil) {
      [outProtocol writeFieldBeginWithName: @"webUrls" type: TType_LIST fieldID: 4];
      {
        ...
        int idx49;
        for (idx49 = 0; idx49 < [__webUrls count]; idx49++)
        {
          [outProtocol writeString: [__webUrls objectAtIndex: idx49]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__emails_isset) {
    if (__emails != nil) {
      [outProtocol writeFieldBeginWithName: @"emails" type: TType_LIST fieldID: 11];
      {
        ...
        int idx67;
        for (idx67 = 0; idx67 < [__emails count]; idx67++)
        {
          [outProtocol writeString: [__emails objectAtIndex: idx67]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__attributes_isset) {
    if (__attributes != nil) {
      [outProtocol writeFieldBeginWithName: @"attributes" type: TType_LIST fieldID: 12];
      {
        ...
        int idx69;
        for (idx69 = 0; idx69 < [__attributes count]; idx69++)
        {
          [[__attributes objectAtIndex: idx69] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sourceUrls_isset) {
    if (__sourceUrls != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceUrls" type: TType_LIST fieldID: 13];
      {
        ...
        int idx71;
        for (idx71 = 0; idx71 < [__sourceUrls count]; idx71++)
        {
          [[__sourceUrls objectAtIndex: idx71] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__socialSitesPostEnabled_isset) {
    if (__socialSitesPostEnabled != nil) {
      [outProtocol writeFieldBeginWithName: @"socialSitesPostEnabled" type: TType_LIST fieldID: 25];
      {
        ...
        int idx75;
        for (idx75 = 0; idx75 < [__socialSitesPostEnabled count]; idx75++)
        {
          [outProtocol writeString: [__socialSitesPostEnabled objectAtIndex: idx75]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__urls_isset) {
    if (__urls != nil) {
      [outProtocol writeFieldBeginWithName: @"urls" type: TType_LIST fieldID: 3];
      {
        ...
        int idx100;
        for (idx100 = 0; idx100 < [__urls count]; idx100++)
        {
          [outProtocol writeString: [__urls objectAtIndex: idx100]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__attributes_isset) {
    if (__attributes != nil) {
      [outProtocol writeFieldBeginWithName: @"attributes" type: TType_LIST fieldID: 26];
      {
        ...
        int idx106;
        for (idx106 = 0; idx106 < [__attributes count]; idx106++)
        {
          [outProtocol writeString: [__attributes objectAtIndex: idx106]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__idFields_isset) {
    if (__idFields != nil) {
      [outProtocol writeFieldBeginWithName: @"idFields" type: TType_LIST fieldID: 27];
      {
        ...
        int idx108;
        for (idx108 = 0; idx108 < [__idFields count]; idx108++)
        {
          [outProtocol writeString: [__idFields objectAtIndex: idx108]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__values_isset) {
    if (__values != nil) {
      [outProtocol writeFieldBeginWithName: @"values" type: TType_LIST fieldID: 2];
      {
        ...
        int idx113;
        for (idx113 = 0; idx113 < [__values count]; idx113++)
        {
          [outProtocol writeString: [__values objectAtIndex: idx113]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sentimentFilters_isset) {
    if (__sentimentFilters != nil) {
      [outProtocol writeFieldBeginWithName: @"sentimentFilters" type: TType_LIST fieldID: 2];
      {
        ...
        int idx127;
        for (idx127 = 0; idx127 < [__sentimentFilters count]; idx127++)
        {
          [outProtocol writeString: [__sentimentFilters objectAtIndex: idx127]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sourceSiteFilter_isset) {
    if (__sourceSiteFilter != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceSiteFilter" type: TType_LIST fieldID: 3];
      {
        ...
        int idx129;
        for (idx129 = 0; idx129 < [__sourceSiteFilter count]; idx129++)
        {
          [outProtocol writeString: [__sourceSiteFilter objectAtIndex: idx129]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__socialSitesFilter_isset) {
    if (__socialSitesFilter != nil) {
      [outProtocol writeFieldBeginWithName: @"socialSitesFilter" type: TType_LIST fieldID: 6];
      {
        ...
        int idx131;
        for (idx131 = 0; idx131 < [__socialSitesFilter count]; idx131++)
        {
          [outProtocol writeString: [__socialSitesFilter objectAtIndex: idx131]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__locationFilter_isset) {
    if (__locationFilter != nil) {
      [outProtocol writeFieldBeginWithName: @"locationFilter" type: TType_LIST fieldID: 8];
      {
        ...
        int idx133;
        for (idx133 = 0; idx133 < [__locationFilter count]; idx133++)
        {
          [outProtocol writeString: [__locationFilter objectAtIndex: idx133]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__categories_isset) {
    if (__categories != nil) {
      [outProtocol writeFieldBeginWithName: @"categories" type: TType_LIST fieldID: 2];
      {
        ...
        int idx138;
        for (idx138 = 0; idx138 < [__categories count]; idx138++)
        {
          [outProtocol writeString: [__categories objectAtIndex: idx138]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__values_isset) {
    if (__values != nil) {
      [outProtocol writeFieldBeginWithName: @"values" type: TType_LIST fieldID: 2];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__values count]];
        int idx143;
        for (idx143 = 0; idx143 < [__values count]; idx143++)
        {
          [outProtocol writeString: [__values objectAtIndex: idx143]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__selectedValues_isset) {
    if (__selectedValues != nil) {
      [outProtocol writeFieldBeginWithName: @"selectedValues" type: TType_LIST fieldID: 4];
      {
        ...
        int idx148;
        for (idx148 = 0; idx148 < [__selectedValues count]; idx148++)
        {
          [outProtocol writeString: [__selectedValues objectAtIndex: idx148]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__facetOptions_isset) {
    if (__facetOptions != nil) {
      [outProtocol writeFieldBeginWithName: @"facetOptions" type: TType_LIST fieldID: 5];
      {
        ...
        int idx159;
        for (idx159 = 0; idx159 < [__facetOptions count]; idx159++)
        {
          [[__facetOptions objectAtIndex: idx159] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__featuresEnabled_isset) {
    if (__featuresEnabled != nil) {
      [outProtocol writeFieldBeginWithName: @"featuresEnabled" type: TType_LIST fieldID: 1];
      {
        ...
        int idx173;
        for (idx173 = 0; idx173 < [__featuresEnabled count]; idx173++)
        {
          [outProtocol writeString: [__featuresEnabled objectAtIndex: idx173]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__authLocations_isset) {
    if (__authLocations != nil) {
      [outProtocol writeFieldBeginWithName: @"authLocations" type: TType_LIST fieldID: 6];
      {
        ...
        int idx175;
        for (idx175 = 0; idx175 < [__authLocations count]; idx175++)
        {
          [[__authLocations objectAtIndex: idx175] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__userSettings_isset) {
    if (__userSettings != nil) {
      [outProtocol writeFieldBeginWithName: @"userSettings" type: TType_LIST fieldID: 10];
      {
        ...
        int idx177;
        for (idx177 = 0; idx177 < [__userSettings count]; idx177++)
        {
          [[__userSettings objectAtIndex: idx177] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__pushNotificationsPref_isset) {
    if (__pushNotificationsPref != nil) {
      [outProtocol writeFieldBeginWithName: @"pushNotificationsPref" type: TType_LIST fieldID: 14];
      {
        ...
        int idx179;
        for (idx179 = 0; idx179 < [__pushNotificationsPref count]; idx179++)
        {
          [[__pushNotificationsPref objectAtIndex: idx179] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__filters_isset) {
    if (__filters != nil) {
      [outProtocol writeFieldBeginWithName: @"filters" type: TType_LIST fieldID: 10];
      {
        ...
        int idx184;
        for (idx184 = 0; idx184 < [__filters count]; idx184++)
        {
          [[__filters objectAtIndex: idx184] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
