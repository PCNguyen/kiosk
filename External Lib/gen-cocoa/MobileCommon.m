...
- (id) initWithSourceUrl: (NSString *) sourceUrl source: (NSString *) source isCompetitor: (BOOL) isCompetitor twitterConfig: (TwitterConfig *) twitterConfig isKioskReviewable: (BOOL) isKioskReviewable kioskUrl: (NSString *) kioskUrl
{
  ...
  __kioskUrl = [kioskUrl retain_stub];
  __kioskUrl_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"kioskUrl"])
  {
    __kioskUrl = [[decoder decodeObjectForKey: @"kioskUrl"] retain_stub];
    __kioskUrl_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__kioskUrl_isset)
  {
    [encoder encodeObject: __kioskUrl forKey: @"kioskUrl"];
  }
}
...
- (NSString *) kioskUrl {
  return [[__kioskUrl retain_stub] autorelease_stub];
}

- (void) setKioskUrl: (NSString *) kioskUrl {
  [kioskUrl retain_stub];
  [__kioskUrl release_stub];
  __kioskUrl = kioskUrl;
  __kioskUrl_isset = YES;
}
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__kioskUrl_isset) {
    if (__kioskUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"kioskUrl" type: TType_STRING fieldID: 6];
      [outProtocol writeString: __kioskUrl];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  ...
  [ms appendString: @",kioskUrl:"];
  [ms appendFormat: @"\"%@\"", __kioskUrl];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
- (id) initWithId: (NSString *) id code: (NSString *) code name: (NSString *) name longName: (NSString *) longName tenantID: (TenantID) tenantID address: (Address *) address phone: (NSString *) phone web: (NSString *) web manager: (NSString *) manager managerEmail: (NSString *) managerEmail emails: (NSMutableArray *) emails attributes: (NSMutableArray *) attributes sourceUrls: (NSMutableArray *) sourceUrls nextExpressions: (NSMutableDictionary *) nextExpressions latlng: (LatLng *) latlng kiosk: (Kiosk *) kiosk locationKey: (NSString *) locationKey publishUrl: (NSString *) publishUrl publish: (Publish *) publish reviewTemplate: (ReviewTemplate *) reviewTemplate emailFrom: (EmailUser *) emailFrom alternatives: (Alternatives *) alternatives kioskUrl: (NSString *) kioskUrl largeLogoPath: (NSString *) largeLogoPath socialSitesPostEnabled: (NSMutableArray *) socialSitesPostEnabled
{
  ...
  __kioskUrl = [kioskUrl retain_stub];
  __kioskUrl_isset = YES;
  __largeLogoPath = [largeLogoPath retain_stub];
  __largeLogoPath_isset = YES;
  __socialSitesPostEnabled = [socialSitesPostEnabled retain_stub];
  __socialSitesPostEnabled_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"largeLogoPath"])
  {
    __largeLogoPath = [[decoder decodeObjectForKey: @"largeLogoPath"] retain_stub];
    __largeLogoPath_isset = YES;
  }
  if ([decoder containsValueForKey: @"socialSitesPostEnabled"])
  {
    __socialSitesPostEnabled = [[decoder decodeObjectForKey: @"socialSitesPostEnabled"] retain_stub];
    __socialSitesPostEnabled_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__largeLogoPath_isset)
  {
    [encoder encodeObject: __largeLogoPath forKey: @"largeLogoPath"];
  }
  if (__socialSitesPostEnabled_isset)
  {
    [encoder encodeObject: __socialSitesPostEnabled forKey: @"socialSitesPostEnabled"];
  }
}
...
- (void) dealloc
{
  ...
  [__kioskUrl release_stub];
  [__largeLogoPath release_stub];
  [__socialSitesPostEnabled release_stub];
  [super dealloc_stub];
}
...
- (NSString *) largeLogoPath {
  return [[__largeLogoPath retain_stub] autorelease_stub];
}

- (void) setLargeLogoPath: (NSString *) largeLogoPath {
  [largeLogoPath retain_stub];
  [__largeLogoPath release_stub];
  __largeLogoPath = largeLogoPath;
  __largeLogoPath_isset = YES;
}

- (BOOL) largeLogoPathIsSet {
  return __largeLogoPath_isset;
}

- (void) unsetLargeLogoPath {
  [__largeLogoPath release_stub];
  __largeLogoPath = nil;
  __largeLogoPath_isset = NO;
}

- (NSMutableArray *) socialSitesPostEnabled {
  return [[__socialSitesPostEnabled retain_stub] autorelease_stub];
}

- (void) setSocialSitesPostEnabled: (NSMutableArray *) socialSitesPostEnabled {
  [socialSitesPostEnabled retain_stub];
  [__socialSitesPostEnabled release_stub];
  __socialSitesPostEnabled = socialSitesPostEnabled;
  __socialSitesPostEnabled_isset = YES;
}

- (BOOL) socialSitesPostEnabledIsSet {
  return __socialSitesPostEnabled_isset;
}

- (void) unsetSocialSitesPostEnabled {
  [__socialSitesPostEnabled release_stub];
  __socialSitesPostEnabled = nil;
  __socialSitesPostEnabled_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 24:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setLargeLogoPath: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 25:
        if (fieldType == TType_LIST) {
          ...
          [inProtocol readListEnd];
          [self setSocialSitesPostEnabled: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__emails_isset) {
    if (__emails != nil) {
      [outProtocol writeFieldBeginWithName: @"emails" type: TType_LIST fieldID: 11];
      {
        ...
        int i67;
        for (i67 = 0; i67 < [__emails count]; i67++)
        {
          [outProtocol writeString: [__emails objectAtIndex: i67]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__attributes_isset) {
    if (__attributes != nil) {
      [outProtocol writeFieldBeginWithName: @"attributes" type: TType_LIST fieldID: 12];
      {
        ...
        int i69;
        for (i69 = 0; i69 < [__attributes count]; i69++)
        {
          [[__attributes objectAtIndex: i69] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sourceUrls_isset) {
    if (__sourceUrls != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceUrls" type: TType_LIST fieldID: 13];
      {
        ...
        int i71;
        for (i71 = 0; i71 < [__sourceUrls count]; i71++)
        {
          [[__sourceUrls objectAtIndex: i71] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__nextExpressions_isset) {
    if (__nextExpressions != nil) {
      [outProtocol writeFieldBeginWithName: @"nextExpressions" type: TType_MAP fieldID: 14];
      {
        ...
        NSEnumerator * _iter72 = [__nextExpressions keyEnumerator];
        id key73;
        while ((key73 = [_iter72 nextObject]))
        {
          [outProtocol writeString: key73];
          [outProtocol writeString: [__nextExpressions objectForKey: key73]];
        }
  ...
  if (__kioskUrl_isset) {
    if (__kioskUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"kioskUrl" type: TType_STRING fieldID: 23];
      [outProtocol writeString: __kioskUrl];
      [outProtocol writeFieldEnd];
    }
  }
  if (__largeLogoPath_isset) {
    if (__largeLogoPath != nil) {
      [outProtocol writeFieldBeginWithName: @"largeLogoPath" type: TType_STRING fieldID: 24];
      [outProtocol writeString: __largeLogoPath];
      [outProtocol writeFieldEnd];
    }
  }
  if (__socialSitesPostEnabled_isset) {
    if (__socialSitesPostEnabled != nil) {
      [outProtocol writeFieldBeginWithName: @"socialSitesPostEnabled" type: TType_LIST fieldID: 25];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__socialSitesPostEnabled count]];
        int i75;
        for (i75 = 0; i75 < [__socialSitesPostEnabled count]; i75++)
        {
          [outProtocol writeString: [__socialSitesPostEnabled objectAtIndex: i75]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @",kioskUrl:"];
  [ms appendFormat: @"\"%@\"", __kioskUrl];
  [ms appendString: @",largeLogoPath:"];
  [ms appendFormat: @"\"%@\"", __largeLogoPath];
  [ms appendString: @",socialSitesPostEnabled:"];
  [ms appendFormat: @"%@", __socialSitesPostEnabled];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 5:
        if (fieldType == TType_MAP) {
          int _size76;
          [inProtocol readMapBeginReturningKeyType: NULL valueType: NULL size: &_size76];
          NSMutableDictionary * fieldValue = [[NSMutableDictionary alloc] initWithCapacity: _size76];
          int _i77;
          for (_i77 = 0; _i77 < _size76; ++_i77)
          {
            int _key78 = [inProtocol readI32];
            double _val79 = [inProtocol readDouble];
            [fieldValue setObject: [NSNumber numberWithDouble: _val79] forKey: [NSNumber numberWithInt: _key78]];
          }
          [inProtocol readMapEnd];
  ...
  if (__bucketUpperBounds_isset) {
    if (__bucketUpperBounds != nil) {
      [outProtocol writeFieldBeginWithName: @"bucketUpperBounds" type: TType_MAP fieldID: 5];
      {
        ...
        NSEnumerator * _iter80 = [__bucketUpperBounds keyEnumerator];
        id key81;
        while ((key81 = [_iter80 nextObject]))
        {
          [outProtocol writeI32: [key81 intValue]];
          [outProtocol writeDouble: [[__bucketUpperBounds objectForKey: key81] doubleValue]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      ...
      case 7:
        if (fieldType == TType_MAP) {
          ...
          {
            int _key88 = [inProtocol readI32];
            RatingScale *_val89 = [[RatingScale alloc] init];
            [_val89 read: inProtocol];
            [fieldValue setObject: _val89 forKey: [NSNumber numberWithInt: _key88]];
            [_val89 release_stub];
          }
          [inProtocol readMapEnd];
      ...
      case 22:
        if (fieldType == TType_MAP) {
          ...
          {
            NSString * _key92 = [inProtocol readString];
            double _val93 = [inProtocol readDouble];
            [fieldValue setObject: [NSNumber numberWithDouble: _val93] forKey: _key92];
          }
          [inProtocol readMapEnd];
      ...
      case 26:
        if (fieldType == TType_LIST) {
          ...
          {
            NSString * _elem96 = [inProtocol readString];
      ...
      case 27:
        if (fieldType == TType_LIST) {
          ...
          {
            NSString * _elem99 = [inProtocol readString];
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__urls_isset) {
    if (__urls != nil) {
      [outProtocol writeFieldBeginWithName: @"urls" type: TType_MAP fieldID: 3];
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_STRING size: [__urls count]];
        NSEnumerator * _iter100 = [__urls keyEnumerator];
        id key101;
        while ((key101 = [_iter100 nextObject]))
        {
          [outProtocol writeString: key101];
          [outProtocol writeString: [__urls objectForKey: key101]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__subRatingRS_isset) {
    if (__subRatingRS != nil) {
      [outProtocol writeFieldBeginWithName: @"subRatingRS" type: TType_MAP fieldID: 7];
      {
        ...
        NSEnumerator * _iter102 = [__subRatingRS keyEnumerator];
        id key103;
        while ((key103 = [_iter102 nextObject]))
        {
          [outProtocol writeI32: [key103 intValue]];
          [[__subRatingRS objectForKey: key103] write: outProtocol];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__hasItemizedRatings_isset) {
    [outProtocol writeFieldBeginWithName: @"hasItemizedRatings" type: TType_BOOL fieldID: 8];
    [outProtocol writeBool: __hasItemizedRatings];
    [outProtocol writeFieldEnd];
  }
  if (__allowsComments_isset) {
    [outProtocol writeFieldBeginWithName: @"allowsComments" type: TType_BOOL fieldID: 9];
  ...
  if (__sourceGroup_isset) {
    if (__sourceGroup != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceGroup" type: TType_STRING fieldID: 11];
  ...
  if (__collectorDefaults_isset) {
    if (__collectorDefaults != nil) {
      [outProtocol writeFieldBeginWithName: @"collectorDefaults" type: TType_STRUCT fieldID: 12];
  ...
  if (__urlRegexp_isset) {
    if (__urlRegexp != nil) {
      [outProtocol writeFieldBeginWithName: @"urlRegexp" type: TType_STRING fieldID: 13];
      [outProtocol writeString: __urlRegexp];
      [outProtocol writeFieldEnd];
    }
  }
  if (__sendAlerts_isset) {
    [outProtocol writeFieldBeginWithName: @"sendAlerts" type: TType_BOOL fieldID: 14];
    [outProtocol writeBool: __sendAlerts];
    [outProtocol writeFieldEnd];
  }
  if (__hasRating_isset) {
    [outProtocol writeFieldBeginWithName: @"hasRating" type: TType_BOOL fieldID: 15];
    [outProtocol writeBool: __hasRating];
    [outProtocol writeFieldEnd];
  }
  if (__scoreable_isset) {
    [outProtocol writeFieldBeginWithName: @"scoreable" type: TType_BOOL fieldID: 16];
    [outProtocol writeBool: __scoreable];
    [outProtocol writeFieldEnd];
  }
  if (__publishable_isset) {
    [outProtocol writeFieldBeginWithName: @"publishable" type: TType_BOOL fieldID: 17];
    [outProtocol writeBool: __publishable];
    [outProtocol writeFieldEnd];
  }
  if (__schedulable_isset) {
    [outProtocol writeFieldBeginWithName: @"schedulable" type: TType_BOOL fieldID: 18];
    [outProtocol writeBool: __schedulable];
    [outProtocol writeFieldEnd];
  }
  if (__autofindable_isset) {
    [outProtocol writeFieldBeginWithName: @"autofindable" type: TType_BOOL fieldID: 19];
    [outProtocol writeBool: __autofindable];
    [outProtocol writeFieldEnd];
  }
  if (__viewable_isset) {
    [outProtocol writeFieldBeginWithName: @"viewable" type: TType_BOOL fieldID: 20];
    [outProtocol writeBool: __viewable];
    [outProtocol writeFieldEnd];
  }
  if (__requestReviewable_isset) {
    [outProtocol writeFieldBeginWithName: @"requestReviewable" type: TType_BOOL fieldID: 21];
    [outProtocol writeBool: __requestReviewable];
    [outProtocol writeFieldEnd];
  }
  if (__industryWeights_isset) {
    if (__industryWeights != nil) {
      [outProtocol writeFieldBeginWithName: @"industryWeights" type: TType_MAP fieldID: 22];
      {
        [outProtocol writeMapBeginWithKeyType: TType_STRING valueType: TType_DOUBLE size: [__industryWeights count]];
        NSEnumerator * _iter104 = [__industryWeights keyEnumerator];
        id key105;
        while ((key105 = [_iter104 nextObject]))
        {
          [outProtocol writeString: key105];
          [outProtocol writeDouble: [[__industryWeights objectForKey: key105] doubleValue]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__domain_isset) {
    if (__domain != nil) {
      [outProtocol writeFieldBeginWithName: @"domain" type: TType_STRING fieldID: 23];
  ...
  if (__colors_isset) {
    if (__colors != nil) {
      [outProtocol writeFieldBeginWithName: @"colors" type: TType_STRUCT fieldID: 24];
  ...
  if (__listingUrl_isset) {
    if (__listingUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"listingUrl" type: TType_STRING fieldID: 25];
  ...
  if (__attributes_isset) {
    if (__attributes != nil) {
      [outProtocol writeFieldBeginWithName: @"attributes" type: TType_LIST fieldID: 26];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__attributes count]];
        int i107;
        for (i107 = 0; i107 < [__attributes count]; i107++)
        {
          [outProtocol writeString: [__attributes objectAtIndex: i107]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__idFields_isset) {
    if (__idFields != nil) {
      [outProtocol writeFieldBeginWithName: @"idFields" type: TType_LIST fieldID: 27];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__idFields count]];
        int i109;
        for (i109 = 0; i109 < [__idFields count]; i109++)
        {
          [outProtocol writeString: [__idFields objectAtIndex: i109]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__createUrl_isset) {
    if (__createUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"createUrl" type: TType_STRING fieldID: 28];
  ...
  if (__claimUrl_isset) {
    if (__claimUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"claimUrl" type: TType_STRING fieldID: 29];
      [outProtocol writeString: __claimUrl];
      [outProtocol writeFieldEnd];
    }
  }
  if (__isListing_isset) {
    [outProtocol writeFieldBeginWithName: @"isListing" type: TType_BOOL fieldID: 30];
    [outProtocol writeBool: __isListing];
    [outProtocol writeFieldEnd];
  }
  if (__preserveDate_isset) {
    [outProtocol writeFieldBeginWithName: @"preserveDate" type: TType_BOOL fieldID: 31];
  ...
  if (__values_isset) {
    if (__values != nil) {
      [outProtocol writeFieldBeginWithName: @"values" type: TType_LIST fieldID: 2];
      {
        ...
        int i114;
        for (i114 = 0; i114 < [__values count]; i114++)
        {
          [outProtocol writeString: [__values objectAtIndex: i114]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (id) initWithDateRangeFilterId: (NSString *) dateRangeFilterId sentimentFilters: (NSMutableArray *) sentimentFilters sourceSiteFilter: (NSMutableArray *) sourceSiteFilter startDate: (NSString *) startDate endDate: (NSString *) endDate socialSitesFilter: (NSMutableArray *) socialSitesFilter postState: (NSString *) postState locationFilter: (NSMutableArray *) locationFilter
{
  ...
  __endDate_isset = YES;
  __socialSitesFilter = [socialSitesFilter retain_stub];
  __socialSitesFilter_isset = YES;
  __postState = [postState retain_stub];
  __postState_isset = YES;
  __locationFilter = [locationFilter retain_stub];
  __locationFilter_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"socialSitesFilter"])
  {
    __socialSitesFilter = [[decoder decodeObjectForKey: @"socialSitesFilter"] retain_stub];
    __socialSitesFilter_isset = YES;
  }
  if ([decoder containsValueForKey: @"postState"])
  {
    __postState = [[decoder decodeObjectForKey: @"postState"] retain_stub];
    __postState_isset = YES;
  }
  if ([decoder containsValueForKey: @"locationFilter"])
  {
    __locationFilter = [[decoder decodeObjectForKey: @"locationFilter"] retain_stub];
    __locationFilter_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__socialSitesFilter_isset)
  {
    [encoder encodeObject: __socialSitesFilter forKey: @"socialSitesFilter"];
  }
  if (__postState_isset)
  {
    [encoder encodeObject: __postState forKey: @"postState"];
  }
  if (__locationFilter_isset)
  {
    [encoder encodeObject: __locationFilter forKey: @"locationFilter"];
  }
}
...
- (void) dealloc
{
  ...
  [__socialSitesFilter release_stub];
  [__postState release_stub];
  [__locationFilter release_stub];
  [super dealloc_stub];
}
...
- (NSMutableArray *) socialSitesFilter {
  return [[__socialSitesFilter retain_stub] autorelease_stub];
}

- (void) setSocialSitesFilter: (NSMutableArray *) socialSitesFilter {
  [socialSitesFilter retain_stub];
  [__socialSitesFilter release_stub];
  __socialSitesFilter = socialSitesFilter;
  __socialSitesFilter_isset = YES;
}

- (BOOL) socialSitesFilterIsSet {
  return __socialSitesFilter_isset;
}

- (void) unsetSocialSitesFilter {
  [__socialSitesFilter release_stub];
  __socialSitesFilter = nil;
  __socialSitesFilter_isset = NO;
}

- (NSString *) postState {
  return [[__postState retain_stub] autorelease_stub];
}

- (void) setPostState: (NSString *) postState {
  [postState retain_stub];
  [__postState release_stub];
...
- (NSMutableArray *) locationFilter {
  return [[__locationFilter retain_stub] autorelease_stub];
}

- (void) setLocationFilter: (NSMutableArray *) locationFilter {
  [locationFilter retain_stub];
  [__locationFilter release_stub];
  __locationFilter = locationFilter;
  __locationFilter_isset = YES;
}

- (BOOL) locationFilterIsSet {
  return __locationFilter_isset;
}

- (void) unsetLocationFilter {
  [__locationFilter release_stub];
  __locationFilter = nil;
  __locationFilter_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          int _size115;
          [inProtocol readListBeginReturningElementType: NULL size: &_size115];
          NSMutableArray * fieldValue = [[NSMutableArray alloc] initWithCapacity: _size115];
          int _i116;
          for (_i116 = 0; _i116 < _size115; ++_i116)
          {
            NSString * _elem117 = [inProtocol readString];
            [fieldValue addObject: _elem117];
          }
          [inProtocol readListEnd];
      ...
      case 6:
        if (fieldType == TType_LIST) {
          ...
          [inProtocol readListEnd];
          [self setSocialSitesFilter: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
      ...
      case 8:
        if (fieldType == TType_LIST) {
          ...
          [inProtocol readListEnd];
          [self setLocationFilter: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__sentimentFilters_isset) {
    if (__sentimentFilters != nil) {
      [outProtocol writeFieldBeginWithName: @"sentimentFilters" type: TType_LIST fieldID: 2];
      {
        ...
        int i128;
        for (i128 = 0; i128 < [__sentimentFilters count]; i128++)
        {
          [outProtocol writeString: [__sentimentFilters objectAtIndex: i128]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__sourceSiteFilter_isset) {
    if (__sourceSiteFilter != nil) {
      [outProtocol writeFieldBeginWithName: @"sourceSiteFilter" type: TType_LIST fieldID: 3];
      {
        ...
        int i130;
        for (i130 = 0; i130 < [__sourceSiteFilter count]; i130++)
        {
          [outProtocol writeString: [__sourceSiteFilter objectAtIndex: i130]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__socialSitesFilter_isset) {
    if (__socialSitesFilter != nil) {
      [outProtocol writeFieldBeginWithName: @"socialSitesFilter" type: TType_LIST fieldID: 6];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__socialSitesFilter count]];
        int i132;
        for (i132 = 0; i132 < [__socialSitesFilter count]; i132++)
        {
          [outProtocol writeString: [__socialSitesFilter objectAtIndex: i132]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__postState_isset) {
    if (__postState != nil) {
      [outProtocol writeFieldBeginWithName: @"postState" type: TType_STRING fieldID: 7];
      [outProtocol writeString: __postState];
      [outProtocol writeFieldEnd];
    }
  }
  if (__locationFilter_isset) {
    if (__locationFilter != nil) {
      [outProtocol writeFieldBeginWithName: @"locationFilter" type: TType_LIST fieldID: 8];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__locationFilter count]];
        int i134;
        for (i134 = 0; i134 < [__locationFilter count]; i134++)
        {
          [outProtocol writeString: [__locationFilter objectAtIndex: i134]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @",socialSitesFilter:"];
  [ms appendFormat: @"%@", __socialSitesFilter];
  [ms appendString: @",postState:"];
  [ms appendFormat: @"\"%@\"", __postState];
  [ms appendString: @",locationFilter:"];
  [ms appendFormat: @"%@", __locationFilter];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__email_isset) {
    if (__email != nil) {
      [outProtocol writeFieldBeginWithName: @"email" type: TType_STRING fieldID: 9];
      [outProtocol writeString: __email];
      [outProtocol writeFieldEnd];
    }
  }
  if (__phone_isset) {
    if (__phone != nil) {
      [outProtocol writeFieldBeginWithName: @"phone" type: TType_STRING fieldID: 10];
      [outProtocol writeString: __phone];
      [outProtocol writeFieldEnd];
    }
  }
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            NSString * _elem137 = [inProtocol readString];
  ...
  if (__categories_isset) {
    if (__categories != nil) {
      [outProtocol writeFieldBeginWithName: @"categories" type: TType_LIST fieldID: 2];
      {
        ...
        int i139;
        for (i139 = 0; i139 < [__categories count]; i139++)
        {
          [outProtocol writeString: [__categories objectAtIndex: i139]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      ...
      case 2:
        if (fieldType == TType_LIST) {
          ...
          {
            NSString * _elem142 = [inProtocol readString];
  ...
  if (__values_isset) {
    if (__values != nil) {
      [outProtocol writeFieldBeginWithName: @"values" type: TType_LIST fieldID: 2];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__values count]];
        int i144;
        for (i144 = 0; i144 < [__values count]; i144++)
        {
          [outProtocol writeString: [__values objectAtIndex: i144]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (id) initWithPreferenceId: (NSString *) preferenceId category: (int) category enabled: (BOOL) enabled selectedValues: (NSMutableArray *) selectedValues
{
  ...
  __enabled = enabled;
  __enabled_isset = YES;
  __selectedValues = [selectedValues retain_stub];
  __selectedValues_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"selectedValues"])
  {
    __selectedValues = [[decoder decodeObjectForKey: @"selectedValues"] retain_stub];
    __selectedValues_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__selectedValues_isset)
  {
    [encoder encodeObject: __selectedValues forKey: @"selectedValues"];
  }
}
...
- (NSMutableArray *) selectedValues {
  return [[__selectedValues retain_stub] autorelease_stub];
}

- (void) setSelectedValues: (NSMutableArray *) selectedValues {
  [selectedValues retain_stub];
  [__selectedValues release_stub];
  __selectedValues = selectedValues;
  __selectedValues_isset = YES;
}

- (BOOL) selectedValuesIsSet {
  return __selectedValues_isset;
}

- (void) unsetSelectedValues {
  [__selectedValues release_stub];
  __selectedValues = nil;
  __selectedValues_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 4:
        if (fieldType == TType_LIST) {
          int _size145;
          [inProtocol readListBeginReturningElementType: NULL size: &_size145];
          NSMutableArray * fieldValue = [[NSMutableArray alloc] initWithCapacity: _size145];
          int _i146;
          for (_i146 = 0; _i146 < _size145; ++_i146)
          {
            NSString * _elem147 = [inProtocol readString];
            [fieldValue addObject: _elem147];
          }
          [inProtocol readListEnd];
          [self setSelectedValues: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__selectedValues_isset) {
    if (__selectedValues != nil) {
      [outProtocol writeFieldBeginWithName: @"selectedValues" type: TType_LIST fieldID: 4];
      {
        [outProtocol writeListBeginWithElementType: TType_STRING size: [__selectedValues count]];
        int i149;
        for (i149 = 0; i149 < [__selectedValues count]; i149++)
        {
          [outProtocol writeString: [__selectedValues objectAtIndex: i149]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @",enabled:"];
  [ms appendFormat: @"%i", __enabled];
  [ms appendString: @",selectedValues:"];
  [ms appendFormat: @"%@", __selectedValues];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 3:
        if (fieldType == TType_MAP) {
          int _size150;
          [inProtocol readMapBeginReturningKeyType: NULL valueType: NULL size: &_size150];
          NSMutableDictionary * fieldValue = [[NSMutableDictionary alloc] initWithCapacity: _size150];
          int _i151;
          for (_i151 = 0; _i151 < _size150; ++_i151)
          {
            NSString * _key152 = [inProtocol readString];
            NSString * _val153 = [inProtocol readString];
            [fieldValue setObject: _val153 forKey: _key152];
          }
          [inProtocol readMapEnd];
  ...
  if (__addlProps_isset) {
    if (__addlProps != nil) {
      [outProtocol writeFieldBeginWithName: @"addlProps" type: TType_MAP fieldID: 3];
      {
        ...
        NSEnumerator * _iter154 = [__addlProps keyEnumerator];
        id key155;
        while ((key155 = [_iter154 nextObject]))
        {
          [outProtocol writeString: key155];
          [outProtocol writeString: [__addlProps objectForKey: key155]];
        }
        [outProtocol writeMapEnd];
      }
      [outProtocol writeFieldEnd];
    ...
    switch (fieldID)
    {
      ...
      case 5:
        if (fieldType == TType_LIST) {
          ...
          {
            FacetOption *_elem158 = [[FacetOption alloc] init];
  ...
  if (__facetOptions_isset) {
    if (__facetOptions != nil) {
      [outProtocol writeFieldBeginWithName: @"facetOptions" type: TType_LIST fieldID: 5];
      {
        ...
        int i160;
        for (i160 = 0; i160 < [__facetOptions count]; i160++)
        {
          [[__facetOptions objectAtIndex: i160] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (id) initWithFeaturesEnabled: (NSMutableArray *) featuresEnabled reviewSources: (Facet *) reviewSources kioskSources: (Facet *) kioskSources surveySources: (Facet *) surveySources socialSources: (Facet *) socialSources authLocations: (NSMutableArray *) authLocations dateRanges: (Facet *) dateRanges socialStates: (Facet *) socialStates sentimentValues: (Facet *) sentimentValues userSettings: (NSMutableArray *) userSettings isDefaultSettings: (BOOL) isDefaultSettings tenantLogoUrl: (NSString *) tenantLogoUrl industrySources: (Facet *) industrySources pushNotificationsPref: (NSMutableArray *) pushNotificationsPref menus: (Facet *) menus tenantProgramID: (NSString *) tenantProgramID tenantType: (int) tenantType
{
  ...
  __socialStates = [socialStates retain_stub];
  __socialStates_isset = YES;
  __sentimentValues = [sentimentValues retain_stub];
  __sentimentValues_isset = YES;
  ...
  __tenantLogoUrl = [tenantLogoUrl retain_stub];
  __tenantLogoUrl_isset = YES;
  __industrySources = [industrySources retain_stub];
  __industrySources_isset = YES;
  __pushNotificationsPref = [pushNotificationsPref retain_stub];
  ...
  __tenantType = tenantType;
  __tenantType_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"socialStates"])
  {
    __socialStates = [[decoder decodeObjectForKey: @"socialStates"] retain_stub];
    __socialStates_isset = YES;
  }
  if ([decoder containsValueForKey: @"sentimentValues"])
  {
    __sentimentValues = [[decoder decodeObjectForKey: @"sentimentValues"] retain_stub];
    __sentimentValues_isset = YES;
  }
  ...
  if ([decoder containsValueForKey: @"tenantLogoUrl"])
  {
    __tenantLogoUrl = [[decoder decodeObjectForKey: @"tenantLogoUrl"] retain_stub];
    __tenantLogoUrl_isset = YES;
  }
  if ([decoder containsValueForKey: @"industrySources"])
  {
    __industrySources = [[decoder decodeObjectForKey: @"industrySources"] retain_stub];
    __industrySources_isset = YES;
  }
  if ([decoder containsValueForKey: @"pushNotificationsPref"])
  {
    __pushNotificationsPref = [[decoder decodeObjectForKey: @"pushNotificationsPref"] retain_stub];
    __pushNotificationsPref_isset = YES;
  }
  if ([decoder containsValueForKey: @"menus"])
  {
  ...
  if ([decoder containsValueForKey: @"tenantType"])
  {
    __tenantType = [decoder decodeIntForKey: @"tenantType"];
    __tenantType_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__socialStates_isset)
  {
    [encoder encodeObject: __socialStates forKey: @"socialStates"];
  }
  if (__sentimentValues_isset)
  {
    [encoder encodeObject: __sentimentValues forKey: @"sentimentValues"];
  }
  ...
  if (__tenantLogoUrl_isset)
  {
    [encoder encodeObject: __tenantLogoUrl forKey: @"tenantLogoUrl"];
  }
  if (__industrySources_isset)
  {
    [encoder encodeObject: __industrySources forKey: @"industrySources"];
  }
  if (__pushNotificationsPref_isset)
  {
    [encoder encodeObject: __pushNotificationsPref forKey: @"pushNotificationsPref"];
  }
  if (__menus_isset)
  {
  ...
  if (__tenantType_isset)
  {
    [encoder encodeInt: __tenantType forKey: @"tenantType"];
  }
}
...
- (void) dealloc
{
  ...
  [__socialStates release_stub];
  [__sentimentValues release_stub];
  [__userSettings release_stub];
  [__tenantLogoUrl release_stub];
...
- (Facet *) socialStates {
  return [[__socialStates retain_stub] autorelease_stub];
}

- (void) setSocialStates: (Facet *) socialStates {
  [socialStates retain_stub];
  [__socialStates release_stub];
  __socialStates = socialStates;
  __socialStates_isset = YES;
}

- (BOOL) socialStatesIsSet {
  return __socialStates_isset;
}

- (void) unsetSocialStates {
  [__socialStates release_stub];
  __socialStates = nil;
  __socialStates_isset = NO;
}

- (Facet *) sentimentValues {
  return [[__sentimentValues retain_stub] autorelease_stub];
}

- (void) setSentimentValues: (Facet *) sentimentValues {
  [sentimentValues retain_stub];
  [__sentimentValues release_stub];
  __sentimentValues = sentimentValues;
  __sentimentValues_isset = YES;
}

- (BOOL) sentimentValuesIsSet {
  return __sentimentValues_isset;
}

- (void) unsetSentimentValues {
  [__sentimentValues release_stub];
  __sentimentValues = nil;
  __sentimentValues_isset = NO;
}
...
- (NSString *) tenantLogoUrl {
  return [[__tenantLogoUrl retain_stub] autorelease_stub];
}

- (void) setTenantLogoUrl: (NSString *) tenantLogoUrl {
  [tenantLogoUrl retain_stub];
  [__tenantLogoUrl release_stub];
  __tenantLogoUrl = tenantLogoUrl;
  __tenantLogoUrl_isset = YES;
}

- (BOOL) tenantLogoUrlIsSet {
  return __tenantLogoUrl_isset;
}

- (void) unsetTenantLogoUrl {
  [__tenantLogoUrl release_stub];
  __tenantLogoUrl = nil;
  __tenantLogoUrl_isset = NO;
}

- (Facet *) industrySources {
  return [[__industrySources retain_stub] autorelease_stub];
}

- (void) setIndustrySources: (Facet *) industrySources {
  [industrySources retain_stub];
  [__industrySources release_stub];
  __industrySources = industrySources;
  __industrySources_isset = YES;
}

- (BOOL) industrySourcesIsSet {
  return __industrySources_isset;
}

- (void) unsetIndustrySources {
  [__industrySources release_stub];
  __industrySources = nil;
  __industrySources_isset = NO;
}

- (NSMutableArray *) pushNotificationsPref {
  return [[__pushNotificationsPref retain_stub] autorelease_stub];
}

- (void) setPushNotificationsPref: (NSMutableArray *) pushNotificationsPref {
  [pushNotificationsPref retain_stub];
  [__pushNotificationsPref release_stub];
  __pushNotificationsPref = pushNotificationsPref;
  __pushNotificationsPref_isset = YES;
}

- (BOOL) pushNotificationsPrefIsSet {
  return __pushNotificationsPref_isset;
}

- (void) unsetPushNotificationsPref {
  [__pushNotificationsPref release_stub];
  __pushNotificationsPref = nil;
  __pushNotificationsPref_isset = NO;
}

- (Facet *) menus {
  return [[__menus retain_stub] autorelease_stub];
}
...
- (BOOL) tenantTypeIsSet {
  return __tenantType_isset;
}

- (void) unsetTenantType {
  __tenantType_isset = NO;
}
    ...
    switch (fieldID)
    {
      case 1:
        if (fieldType == TType_LIST) {
          ...
          {
            NSString * _elem163 = [inProtocol readString];
      ...
      case 6:
        if (fieldType == TType_LIST) {
          ...
          {
            Location *_elem166 = [[Location alloc] init];
      ...
      case 8:
        if (fieldType == TType_STRUCT) {
          Facet *fieldValue = [[Facet alloc] init];
          [fieldValue read: inProtocol];
          [self setSocialStates: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
      ...
      case 9:
        if (fieldType == TType_STRUCT) {
          Facet *fieldValue = [[Facet alloc] init];
          [fieldValue read: inProtocol];
          [self setSentimentValues: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
      ...
      case 10:
        if (fieldType == TType_LIST) {
          ...
          {
            UserPreference *_elem169 = [[UserPreference alloc] init];
      ...
      case 12:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setTenantLogoUrl: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 13:
        if (fieldType == TType_STRUCT) {
          Facet *fieldValue = [[Facet alloc] init];
          [fieldValue read: inProtocol];
          [self setIndustrySources: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
      ...
      case 14:
        if (fieldType == TType_LIST) {
          int _size170;
          [inProtocol readListBeginReturningElementType: NULL size: &_size170];
          NSMutableArray * fieldValue = [[NSMutableArray alloc] initWithCapacity: _size170];
          int _i171;
          for (_i171 = 0; _i171 < _size170; ++_i171)
          {
            Facet *_elem172 = [[Facet alloc] init];
            [_elem172 read: inProtocol];
            [fieldValue addObject: _elem172];
            [_elem172 release_stub];
          }
          [inProtocol readListEnd];
          [self setPushNotificationsPref: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__featuresEnabled_isset) {
    if (__featuresEnabled != nil) {
      [outProtocol writeFieldBeginWithName: @"featuresEnabled" type: TType_LIST fieldID: 1];
      {
        ...
        int i174;
        for (i174 = 0; i174 < [__featuresEnabled count]; i174++)
        {
          [outProtocol writeString: [__featuresEnabled objectAtIndex: i174]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__authLocations_isset) {
    if (__authLocations != nil) {
      [outProtocol writeFieldBeginWithName: @"authLocations" type: TType_LIST fieldID: 6];
      {
        ...
        int i176;
        for (i176 = 0; i176 < [__authLocations count]; i176++)
        {
          [[__authLocations objectAtIndex: i176] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__socialStates_isset) {
    if (__socialStates != nil) {
      [outProtocol writeFieldBeginWithName: @"socialStates" type: TType_STRUCT fieldID: 8];
      [__socialStates write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  if (__sentimentValues_isset) {
    if (__sentimentValues != nil) {
      [outProtocol writeFieldBeginWithName: @"sentimentValues" type: TType_STRUCT fieldID: 9];
      [__sentimentValues write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  if (__userSettings_isset) {
    if (__userSettings != nil) {
      [outProtocol writeFieldBeginWithName: @"userSettings" type: TType_LIST fieldID: 10];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__userSettings count]];
        int i178;
        for (i178 = 0; i178 < [__userSettings count]; i178++)
        {
          [[__userSettings objectAtIndex: i178] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__isDefaultSettings_isset) {
    [outProtocol writeFieldBeginWithName: @"isDefaultSettings" type: TType_BOOL fieldID: 11];
    [outProtocol writeBool: __isDefaultSettings];
    [outProtocol writeFieldEnd];
  }
  if (__tenantLogoUrl_isset) {
    if (__tenantLogoUrl != nil) {
      [outProtocol writeFieldBeginWithName: @"tenantLogoUrl" type: TType_STRING fieldID: 12];
      [outProtocol writeString: __tenantLogoUrl];
      [outProtocol writeFieldEnd];
    }
  }
  if (__industrySources_isset) {
    if (__industrySources != nil) {
      [outProtocol writeFieldBeginWithName: @"industrySources" type: TType_STRUCT fieldID: 13];
      [__industrySources write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  if (__pushNotificationsPref_isset) {
    if (__pushNotificationsPref != nil) {
      [outProtocol writeFieldBeginWithName: @"pushNotificationsPref" type: TType_LIST fieldID: 14];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__pushNotificationsPref count]];
        int i180;
        for (i180 = 0; i180 < [__pushNotificationsPref count]; i180++)
        {
          [[__pushNotificationsPref objectAtIndex: i180] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__menus_isset) {
    if (__menus != nil) {
      [outProtocol writeFieldBeginWithName: @"menus" type: TType_STRUCT fieldID: 15];
      [__menus write: outProtocol];
      [outProtocol writeFieldEnd];
    }
  }
  if (__tenantProgramID_isset) {
  ...
  if (__tenantType_isset) {
    [outProtocol writeFieldBeginWithName: @"tenantType" type: TType_I32 fieldID: 17];
    [outProtocol writeI32: __tenantType];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @",socialStates:"];
  [ms appendFormat: @"%@", __socialStates];
  [ms appendString: @",sentimentValues:"];
  [ms appendFormat: @"%@", __sentimentValues];
  ...
  [ms appendString: @",tenantLogoUrl:"];
  [ms appendFormat: @"\"%@\"", __tenantLogoUrl];
  [ms appendString: @",industrySources:"];
  [ms appendFormat: @"%@", __industrySources];
  [ms appendString: @",pushNotificationsPref:"];
  ...
  [ms appendString: @",tenantType:"];
  [ms appendFormat: @"%i", __tenantType];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
- (id) initWithId: (int32_t) id tenantID: (int64_t) tenantID roleID: (NSString *) roleID firstName: (NSString *) firstName middleName: (NSString *) middleName lastName: (NSString *) lastName email: (NSString *) email password: (NSString *) password removed: (BOOL) removed filters: (NSMutableArray *) filters externalID: (NSString *) externalID active: (BOOL) active notified: (BOOL) notified userKey: (NSString *) userKey tenantName: (NSString *) tenantName keySwapDate: (NSString *) keySwapDate
{
  ...
  __keySwapDate = [keySwapDate retain_stub];
  __keySwapDate_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"keySwapDate"])
  {
    __keySwapDate = [[decoder decodeObjectForKey: @"keySwapDate"] retain_stub];
    __keySwapDate_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__keySwapDate_isset)
  {
    [encoder encodeObject: __keySwapDate forKey: @"keySwapDate"];
  }
}
...
- (NSString *) keySwapDate {
  return [[__keySwapDate retain_stub] autorelease_stub];
}

- (void) setKeySwapDate: (NSString *) keySwapDate {
  [keySwapDate retain_stub];
  [__keySwapDate release_stub];
  __keySwapDate = keySwapDate;
  __keySwapDate_isset = YES;
}

- (BOOL) keySwapDateIsSet {
  return __keySwapDate_isset;
}

- (void) unsetKeySwapDate {
  [__keySwapDate release_stub];
  __keySwapDate = nil;
  __keySwapDate_isset = NO;
}
    ...
    switch (fieldID)
    {
      ...
      case 10:
        if (fieldType == TType_LIST) {
          ...
          {
            Filter *_elem183 = [[Filter alloc] init];
      ...
      case 16:
        if (fieldType == TType_STRING) {
          NSString * fieldValue = [inProtocol readString];
          [self setKeySwapDate: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__filters_isset) {
    if (__filters != nil) {
      [outProtocol writeFieldBeginWithName: @"filters" type: TType_LIST fieldID: 10];
      {
        ...
        int i185;
        for (i185 = 0; i185 < [__filters count]; i185++)
        {
          [[__filters objectAtIndex: i185] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__tenantName_isset) {
    if (__tenantName != nil) {
      [outProtocol writeFieldBeginWithName: @"tenantName" type: TType_STRING fieldID: 15];
      [outProtocol writeString: __tenantName];
      [outProtocol writeFieldEnd];
    }
  }
  if (__keySwapDate_isset) {
    if (__keySwapDate != nil) {
      [outProtocol writeFieldBeginWithName: @"keySwapDate" type: TType_STRING fieldID: 16];
      [outProtocol writeString: __keySwapDate];
      [outProtocol writeFieldEnd];
    }
  }
  [outProtocol writeFieldStop];
...
- (NSString *) description {
  ...
  [ms appendString: @",keySwapDate:"];
  [ms appendFormat: @"\"%@\"", __keySwapDate];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
static NSString * ACTION_FLAG = @"social.actions.flag";
static NSString * ACTION_REPLY_DELETE = @"social.actions.reply.delete";
...
static NSString * ACTION_POST_APPROVE = @"social.actions.approve";
static NSString * ACTION_POST_REJECT = @"social.actions.reject";
static NSString * SCORE_ENABLED = @"score.enabled";
static NSString * SCORE_POST_ENABLED = @"score.post.enabled";
...
static NSString * REQUEST_REVIEW_ENABLED = @"request.review.enabled";
...
static NSString * PREFERENCE_PUSHNOTIF_SOCIAL_APPROVAL = @"pn.socialpost.approval";
static NSString * PREFERENCE_GENERAL_LOCATION = @"location.locationcd";
...
static NSString * FILTER_ON = @"f_on";
static NSString * FILTER_OFF = @"f_off";
static NSString * FILTER_POST_STATE_UNREAD = @"social.poststate.unread";
static NSString * FILTER_POST_STATE_FLAGGED = @"social.poststate.flagged";
static NSString * FILTER_POST_STATE_ALL = @"";
static NSString * FILTER_POST_STATE_FAILED = @"social.poststate.failed";
static NSString * FILTER_POST_STATE_REJECTED = @"social.poststate.rejected";
static NSString * FILTER_POST_STATE_CANCELLED = @"social.poststate.cancelled";
static NSString * FILTER_POST_STATE_PENDING_APPROVAL = @"social.poststate.pendapproval";
static NSString * FILTER_POST_STATE_APPROVED = @"social.poststate.approved";
static NSString * FILTER_POST_STATE_POST_SUCCEEDED = @"social.poststate.postsuccessed";
static NSString * SOURCE_ID_FACEBOOK = @"FACEBOOK";
static NSString * SOURCE_ID_GOOGLE = @"GOOGLE_PLUS";
static NSString * SOURCE_ID_TWITTER = @"TWITTER";
static NSString * SOURCE_ID_YOUTUBE = @"YOUTUBE";
static NSString * SOURCE_ID_INSTAGRAM = @"INSTAGRAM";
static NSString * SOURCE_ID_SURVEY = @"SURVEY";
static NSString * SOURCE_NAME_SURVEY = @"Survey";
static NSString * SOURCE_ID_KIOSK = @"KIOSK";
static NSString * SOURCE_NAME_KIOSK = @"Kiosk";
static NSString * SOURCE_NAME_THIRD_PARTY = @"Other Sources";
...
static NSString * PREFERENCE_REVIEW_FILTER_DTRANGE = @"review.filter.dtrange";
static NSString * PREFERENCE_REVIEW_FILTER_SENTIMENT = @"review.filter.sentiment";
static NSString * PREFERENCE_SOCIAL_FILTER_SOURCE = @"social.filter.source";
static NSString * PREFERENCE_SOCIAL_FILTER_DTRANGE = @"social.filter.dtrange";
static NSString * PREFERENCE_SOCIAL_FILTER_POSTSTATES = @"social.filter.pstates";
static NSString * EVENT_APP_LAUNCH = @"App Launch";
static NSString * EVENT_PAGE_HIT = @"Page Hit";
static NSString * EVENT_LOGIN = @"Login";
static NSString * EVENT_LOGIN_FAIL = @"Login Fail";
static NSString * EVENT_LOGOUT = @"Logout";
static NSString * EVENT_WALKTHROUGH_SKIP = @"Walkthrough Skip";
static NSString * EVENT_DASH_SCORE_TAP = @"Dash Score Tap";
static NSString * EVENT_DASH_CHART_SWIPE = @"Dash Chart Swipe";
static NSString * EVENT_DASH_TILE_SELECT = @"Dash Tile Selection";
static NSString * EVENT_SETTINGS_DASH_TILE_CUSTOMIZE = @"Settings Dash Tile Customize";
static NSString * EVENT_REVIEW_FILTER_CUSTOMIZE = @"Reviews Filter Customize";
static NSString * EVENT_REVIEW_DETAIL_ACTION = @"Reviews Detail Action";
static NSString * EVENT_REVIEW_ACTION_SUBMIT = @"Reviews Action Submit";
static NSString * EVENT_SOCIAL_FILTER_CUSTOMIZE = @"Social Filter Customize";
static NSString * EVENT_SOCIAL_DETAIL_ACTION = @"Social Detail Action";
static NSString * EVENT_SOCIAL_ACTION_SUBMIT = @"Social Action Submit";
static NSString * EVENT_SOCIAL_POST_SUBMITTED = @"Social Post Submitted";
static NSString * EVENT_SOCIAL_POST_ANOTHER = @"Social Post Another";
static NSString * EVENT_TASKS_LOCATIONS_VIEW = @"Tasks Locations View";
static NSString * EVENT_TASK_ACTION = @"Task Action";
static NSString * EVENT_TASK_REJECT_CONFIRM = @"Task Reject Confirm";
static NSString * EVENT_PUSH_NOTIF_SENT = @"Push Notification Sent";
static NSString * EVENT_PUSH_NOTIF_OPENED = @"Push Notification Opened";
static NSString * EVENT_API_FAILURE = @"API Failure";
static NSString * EVENT_CONNECTION_TIMING = @"Connection Timing";
static NSString * EVENT_START_POST_ACTION = @"Start Post Action";
static NSString * EVENT_PHOTO_REQUEST_REVIEW_SUBMITTED = @"Photo Request Review Submitted";
static NSString * EVENT_EMAIL_ACTION_SUBMIT = @"Email Action Submit";
static NSString * SUPER_PROP_USER = @"user";
static NSString * SUPER_PROP_TENANT = @"tenant";
static NSString * SUPER_PROP_PLATFORM = @"platform";
static NSString * SUPER_PROP_VERSION = @"version";
static NSString * SUPER_PROP_APP_NAME = @"app name";
static NSString * SUPER_PROP_TENANT_TYPE = @"tenantType";
static NSString * PROP_ERROR_CODE = @"error code";
static NSString * PROP_EMAIL = @"email";
static NSString * PROP_CHART_TITLE = @"chart title";
static NSString * PROP_SOURCEID = @"sourceID";
static NSString * PROP_POSITION = @"position";
static NSString * PROP_SENTIMENT = @"sentiment";
static NSString * PROP_SITES = @"sites";
static NSString * PROP_TIME = @"time filter";
static NSString * PROP_REVIEWID = @"reviewID";
static NSString * PROP_POSTS = @"posts";
static NSString * PROP_ACTION = @"action";
static NSString * PROP_MONITOR_POSTID = @"monitor postID";
static NSString * PROP_SCHEDULED_POSTID = @"scheduled postID";
static NSString * PROP_LOCATIONS = @"locations";
static NSString * PROP_IMAGE = @"image";
static NSString * PROP_IMAGE_SOURCE = @"image source";
static NSString * PROP_CHAR_COUNT = @"character count";
static NSString * PROP_SOURCE_PAGE = @"source page";
static NSString * PROP_TYPE = @"type";
static NSString * PROP_PAGE = @"page";
static NSString * PROP_API_NAME = @"api name";
static NSString * PROP_SERVER_ERROR_TEXT = @"server error text";
static NSString * PROP_USER_ERROR_TEXT = @"user error text";
static NSString * PROP_CONNECTION_TIME = @"connection time";
static NSString * PROP_CORRELATION_ID = @"correlation id";
static NSString * PROP_CONNECTION_SUCCESS = @"connection success";
static NSString * PROP_REFERER = @"referer";
static NSString * PROP_CUSTOMER_EMAIL = @"customerEmail";
static NSString * PROP_CUSTOMER_PHONE = @"customerPhone";
static NSString * PROP_CUSTOMER_NOTE = @"customerNote";
static NSString * PROP_REQUEST_REVIEW_ID = @"requestReviewID";
static NSString * PROP_LOCATION_ID = @"locationID";
static NSString * VALUE_APP_NAME_REP = @"Reputation";
static NSString * VALUE_APP_NAME_FORD = @"Ford";
static NSString * VALUE_TENANT_TYPE_SMB = @"SMB";
static NSString * VALUE_TENANT_TYPE_ENTERPRISE = @"Enterprise";
static NSString * VALUE_PAGE_DASHBOARD_TAB = @"DashboardTab";
static NSString * VALUE_PAGE_REVIEWS_TAB = @"ReviewsTab";
static NSString * VALUE_PAGE_SOCIAL_TAB = @"SocialTab";
static NSString * VALUE_PAGE_SCORE_TAB = @"ScoreTab";
static NSString * VALUE_PAGE_TASKS_TAB = @"TasksTab";
static NSString * VALUE_PAGE_REVIEW_DETAIL = @"ReviewDetail";
static NSString * VALUE_PAGE_SOCIAL_DETAIL = @"SocialDetail";
static NSString * VALUE_PAGE_TASK_DETAIL = @"TaskDetail";
static NSString * VALUE_PAGE_HELP = @"HelpScreen";
static NSString * VALUE_PAGE_DASHBOARD_SETTINGS = @"DashboardSettings";
static NSString * VALUE_PAGE_SETTINGS = @"Settings";
static NSString * VALUE_PAGE_LOGIN = @"LoginScreen";
static NSString * VALUE_PAGE_REVIEW_OVERVIEW = @"ReviewOverview";
static NSString * VALUE_PAGE_SOCIAL_OVERVIEW = @"SocialOverview";
static NSString * VALUE_PAGE_SOCIAL_POST = @"SocialPost";
static NSString * VALUE_PAGE_SOCIAL_POST_SENT = @"SocialPostSent";
static NSString * VALUE_PAGE_SOCIAL_POST_LOCATION = @"SocialPostLocation";
static NSString * VALUE_PAGE_SOCIAL_FILTER = @"SocialFilter";
static NSString * VALUE_PAGE_REVIEW_FILTER = @"ReviewFilter";
static NSString * VALUE_PAGE_SOCIAL_REPLY = @"SocialReply";
static NSString * VALUE_PAGE_REVIEW_REPLY = @"ReviewReply";
static NSString * VALUE_PAGE_REVIEW_FORWARD = @"ReviewForward";
static NSString * VALUE_PAGE_MEDIA_FULL_VIEW = @"MediaFullView";
static NSString * VALUE_PAGE_TASK_LOCATION = @"TaskLocationView";
static NSString * VALUE_SOCIAL_POST_APPROVAL_REJECT = @"todo-socialpost-approval";
static NSString * VALUE_TRUE = @"true";
static NSString * VALUE_FALSE = @"false";
static NSString * VALUE_POSITIVE = @"pos";
static NSString * VALUE_NEGATIVE = @"neg";
static NSString * VALUE_NEUTRAL = @"neu";
static NSString * VALUE_REPLY = @"reply";
static NSString * VALUE_FORWARD = @"forward";
static NSString * VALUE_DELETE = @"delete";
static NSString * VALUE_PUBLISH = @"publish";
static NSString * VALUE_UNPUBLISH = @"unpublish";
static NSString * VALUE_CANCEL = @"cancel";
static NSString * VALUE_CAMERA = @"camera";
static NSString * VALUE_GALLERY = @"gallery";
static NSString * VALUE_REVIEW_TYPE = @"reviews";
static NSString * VALUE_LOGOUT_USER_SOURCE = @"user";
static NSString * VALUE_LOGOUT_403_SOURCE = @"403";
static NSString * HTTP_HEADER_VERSION_CD = @"Version-Code";
static NSString * HTTP_HEADER_VERSION_NM = @"Version-Name";
static NSString * HTTP_HEADER_PLATFORM = @"Platform";
static NSString * HTTP_HEADER_USER_ID = @"User-ID";
static NSString * HTTP_HEADER_TENANT_ID = @"Tenant-ID";
static NSString * HTTP_HEADER_KEY_SWAP_DT = @"Key-Swap-Date";
static NSString * HTTP_HEADER_CORRELATION_ID = @"Correlation-ID";
static NSString * HTTP_HEADER_EMULATE_RESP = @"Emulate-Response";
static NSString * HTTP_HEADER_HMAC = @"hmac";
static NSString * HTTP_HEADER_DATE = @"Date";
static NSString * HTTP_HEADER_CONTENT_MD5 = @"Content-Md5";
...
+ (NSString *) REQUEST_REVIEW_ENABLED{
  return REQUEST_REVIEW_ENABLED;
}
...
+ (NSString *) PREFERENCE_PUSHNOTIF_SENTIMENT_KIOSK{
  return PREFERENCE_PUSHNOTIF_SENTIMENT_KIOSK;
}
+ (NSString *) PREFERENCE_PUSHNOTIF_SENTIMENT_SURVEY{
  return PREFERENCE_PUSHNOTIF_SENTIMENT_SURVEY;
}
+ (NSString *) PREFERENCE_PUSHNOTIF_SOCIAL_APPROVAL{
  return PREFERENCE_PUSHNOTIF_SOCIAL_APPROVAL;
}
+ (NSString *) PREFERENCE_GENERAL_LOCATION{
  return PREFERENCE_GENERAL_LOCATION;
}
...
+ (NSString *) EVENT_WALKTHROUGH_SKIP{
  return EVENT_WALKTHROUGH_SKIP;
}
+ (NSString *) EVENT_DASH_SCORE_TAP{
  return EVENT_DASH_SCORE_TAP;
}
+ (NSString *) EVENT_DASH_CHART_SWIPE{
  return EVENT_DASH_CHART_SWIPE;
}
+ (NSString *) EVENT_DASH_TILE_SELECT{
  return EVENT_DASH_TILE_SELECT;
}
+ (NSString *) EVENT_SETTINGS_DASH_TILE_CUSTOMIZE{
  return EVENT_SETTINGS_DASH_TILE_CUSTOMIZE;
}
+ (NSString *) EVENT_REVIEW_FILTER_CUSTOMIZE{
  return EVENT_REVIEW_FILTER_CUSTOMIZE;
}
+ (NSString *) EVENT_REVIEW_DETAIL_ACTION{
  return EVENT_REVIEW_DETAIL_ACTION;
}
+ (NSString *) EVENT_REVIEW_ACTION_SUBMIT{
  return EVENT_REVIEW_ACTION_SUBMIT;
}
+ (NSString *) EVENT_SOCIAL_FILTER_CUSTOMIZE{
  return EVENT_SOCIAL_FILTER_CUSTOMIZE;
}
+ (NSString *) EVENT_SOCIAL_DETAIL_ACTION{
  return EVENT_SOCIAL_DETAIL_ACTION;
}
+ (NSString *) EVENT_SOCIAL_ACTION_SUBMIT{
  return EVENT_SOCIAL_ACTION_SUBMIT;
}
+ (NSString *) EVENT_SOCIAL_POST_SUBMITTED{
  return EVENT_SOCIAL_POST_SUBMITTED;
}
+ (NSString *) EVENT_SOCIAL_POST_ANOTHER{
  return EVENT_SOCIAL_POST_ANOTHER;
}
+ (NSString *) EVENT_TASKS_LOCATIONS_VIEW{
  return EVENT_TASKS_LOCATIONS_VIEW;
}
+ (NSString *) EVENT_TASK_ACTION{
  return EVENT_TASK_ACTION;
}
+ (NSString *) EVENT_TASK_REJECT_CONFIRM{
  return EVENT_TASK_REJECT_CONFIRM;
}
+ (NSString *) EVENT_PUSH_NOTIF_SENT{
  return EVENT_PUSH_NOTIF_SENT;
}
+ (NSString *) EVENT_PUSH_NOTIF_OPENED{
  return EVENT_PUSH_NOTIF_OPENED;
}
+ (NSString *) EVENT_API_FAILURE{
  return EVENT_API_FAILURE;
}
+ (NSString *) EVENT_CONNECTION_TIMING{
  return EVENT_CONNECTION_TIMING;
}
+ (NSString *) EVENT_START_POST_ACTION{
  return EVENT_START_POST_ACTION;
}
+ (NSString *) EVENT_PHOTO_REQUEST_REVIEW_SUBMITTED{
  return EVENT_PHOTO_REQUEST_REVIEW_SUBMITTED;
}
+ (NSString *) EVENT_EMAIL_ACTION_SUBMIT{
  return EVENT_EMAIL_ACTION_SUBMIT;
}
+ (NSString *) SUPER_PROP_USER{
  return SUPER_PROP_USER;
}
+ (NSString *) SUPER_PROP_TENANT{
  return SUPER_PROP_TENANT;
}
+ (NSString *) SUPER_PROP_PLATFORM{
  return SUPER_PROP_PLATFORM;
}
+ (NSString *) SUPER_PROP_VERSION{
  return SUPER_PROP_VERSION;
}
+ (NSString *) SUPER_PROP_APP_NAME{
  return SUPER_PROP_APP_NAME;
}
+ (NSString *) SUPER_PROP_TENANT_TYPE{
  return SUPER_PROP_TENANT_TYPE;
}
...
+ (NSString *) PROP_MONITOR_POSTID{
  return PROP_MONITOR_POSTID;
}
+ (NSString *) PROP_SCHEDULED_POSTID{
  return PROP_SCHEDULED_POSTID;
}
+ (NSString *) PROP_LOCATIONS{
  return PROP_LOCATIONS;
}
+ (NSString *) PROP_IMAGE{
  return PROP_IMAGE;
}
+ (NSString *) PROP_IMAGE_SOURCE{
  return PROP_IMAGE_SOURCE;
}
+ (NSString *) PROP_CHAR_COUNT{
  return PROP_CHAR_COUNT;
}
+ (NSString *) PROP_SOURCE_PAGE{
  return PROP_SOURCE_PAGE;
}
+ (NSString *) PROP_TYPE{
  return PROP_TYPE;
}
...
+ (NSString *) PROP_API_NAME{
  return PROP_API_NAME;
}
+ (NSString *) PROP_SERVER_ERROR_TEXT{
  return PROP_SERVER_ERROR_TEXT;
}
+ (NSString *) PROP_USER_ERROR_TEXT{
  return PROP_USER_ERROR_TEXT;
}
+ (NSString *) PROP_CONNECTION_TIME{
  return PROP_CONNECTION_TIME;
}
+ (NSString *) PROP_CORRELATION_ID{
  return PROP_CORRELATION_ID;
}
+ (NSString *) PROP_CONNECTION_SUCCESS{
  return PROP_CONNECTION_SUCCESS;
}
+ (NSString *) PROP_REFERER{
  return PROP_REFERER;
}
+ (NSString *) PROP_CUSTOMER_EMAIL{
  return PROP_CUSTOMER_EMAIL;
}
+ (NSString *) PROP_CUSTOMER_PHONE{
  return PROP_CUSTOMER_PHONE;
}
+ (NSString *) PROP_CUSTOMER_NOTE{
  return PROP_CUSTOMER_NOTE;
}
+ (NSString *) PROP_REQUEST_REVIEW_ID{
  return PROP_REQUEST_REVIEW_ID;
}
+ (NSString *) PROP_LOCATION_ID{
  return PROP_LOCATION_ID;
}
+ (NSString *) VALUE_APP_NAME_REP{
  return VALUE_APP_NAME_REP;
}
+ (NSString *) VALUE_APP_NAME_FORD{
  return VALUE_APP_NAME_FORD;
}
+ (NSString *) VALUE_TENANT_TYPE_SMB{
  return VALUE_TENANT_TYPE_SMB;
}
+ (NSString *) VALUE_TENANT_TYPE_ENTERPRISE{
  return VALUE_TENANT_TYPE_ENTERPRISE;
}
+ (NSString *) VALUE_PAGE_DASHBOARD_TAB{
  return VALUE_PAGE_DASHBOARD_TAB;
}
+ (NSString *) VALUE_PAGE_REVIEWS_TAB{
  return VALUE_PAGE_REVIEWS_TAB;
}
+ (NSString *) VALUE_PAGE_SOCIAL_TAB{
  return VALUE_PAGE_SOCIAL_TAB;
}
+ (NSString *) VALUE_PAGE_SCORE_TAB{
  return VALUE_PAGE_SCORE_TAB;
}
+ (NSString *) VALUE_PAGE_TASKS_TAB{
  return VALUE_PAGE_TASKS_TAB;
}
+ (NSString *) VALUE_PAGE_REVIEW_DETAIL{
  return VALUE_PAGE_REVIEW_DETAIL;
}
+ (NSString *) VALUE_PAGE_SOCIAL_DETAIL{
  return VALUE_PAGE_SOCIAL_DETAIL;
}
+ (NSString *) VALUE_PAGE_TASK_DETAIL{
  return VALUE_PAGE_TASK_DETAIL;
}
+ (NSString *) VALUE_PAGE_HELP{
  return VALUE_PAGE_HELP;
}
+ (NSString *) VALUE_PAGE_DASHBOARD_SETTINGS{
  return VALUE_PAGE_DASHBOARD_SETTINGS;
}
+ (NSString *) VALUE_PAGE_SETTINGS{
  return VALUE_PAGE_SETTINGS;
}
+ (NSString *) VALUE_PAGE_LOGIN{
  return VALUE_PAGE_LOGIN;
}
+ (NSString *) VALUE_PAGE_REVIEW_OVERVIEW{
  return VALUE_PAGE_REVIEW_OVERVIEW;
}
+ (NSString *) VALUE_PAGE_SOCIAL_OVERVIEW{
  return VALUE_PAGE_SOCIAL_OVERVIEW;
}
+ (NSString *) VALUE_PAGE_SOCIAL_POST{
  return VALUE_PAGE_SOCIAL_POST;
}
+ (NSString *) VALUE_PAGE_SOCIAL_POST_SENT{
  return VALUE_PAGE_SOCIAL_POST_SENT;
}
+ (NSString *) VALUE_PAGE_SOCIAL_POST_LOCATION{
  return VALUE_PAGE_SOCIAL_POST_LOCATION;
}
+ (NSString *) VALUE_PAGE_SOCIAL_FILTER{
  return VALUE_PAGE_SOCIAL_FILTER;
}
+ (NSString *) VALUE_PAGE_REVIEW_FILTER{
  return VALUE_PAGE_REVIEW_FILTER;
}
+ (NSString *) VALUE_PAGE_SOCIAL_REPLY{
  return VALUE_PAGE_SOCIAL_REPLY;
}
+ (NSString *) VALUE_PAGE_REVIEW_REPLY{
  return VALUE_PAGE_REVIEW_REPLY;
}
+ (NSString *) VALUE_PAGE_REVIEW_FORWARD{
  return VALUE_PAGE_REVIEW_FORWARD;
}
+ (NSString *) VALUE_PAGE_MEDIA_FULL_VIEW{
  return VALUE_PAGE_MEDIA_FULL_VIEW;
}
+ (NSString *) VALUE_PAGE_TASK_LOCATION{
  return VALUE_PAGE_TASK_LOCATION;
}
+ (NSString *) VALUE_SOCIAL_POST_APPROVAL_REJECT{
  return VALUE_SOCIAL_POST_APPROVAL_REJECT;
}
+ (NSString *) VALUE_TRUE{
  return VALUE_TRUE;
}
...
+ (NSString *) VALUE_REVIEW_TYPE{
  return VALUE_REVIEW_TYPE;
}
+ (NSString *) VALUE_LOGOUT_USER_SOURCE{
  return VALUE_LOGOUT_USER_SOURCE;
}
+ (NSString *) VALUE_LOGOUT_403_SOURCE{
  return VALUE_LOGOUT_403_SOURCE;
}
+ (NSString *) HTTP_HEADER_VERSION_CD{
  return HTTP_HEADER_VERSION_CD;
}
+ (NSString *) HTTP_HEADER_VERSION_NM{
  return HTTP_HEADER_VERSION_NM;
}
+ (NSString *) HTTP_HEADER_PLATFORM{
  return HTTP_HEADER_PLATFORM;
}
+ (NSString *) HTTP_HEADER_USER_ID{
  return HTTP_HEADER_USER_ID;
}
+ (NSString *) HTTP_HEADER_TENANT_ID{
  return HTTP_HEADER_TENANT_ID;
}
+ (NSString *) HTTP_HEADER_KEY_SWAP_DT{
  return HTTP_HEADER_KEY_SWAP_DT;
}
+ (NSString *) HTTP_HEADER_CORRELATION_ID{
  return HTTP_HEADER_CORRELATION_ID;
}
+ (NSString *) HTTP_HEADER_EMULATE_RESP{
  return HTTP_HEADER_EMULATE_RESP;
}
+ (NSString *) HTTP_HEADER_HMAC{
  return HTTP_HEADER_HMAC;
}
